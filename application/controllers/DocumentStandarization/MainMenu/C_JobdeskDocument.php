...
class C_JobdeskDocument extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['Title'] = 'Dokumen Job Desk';
		$data['Menu'] = 'Job Desk';
		$data['SubMenuOne'] = 'Dokumen Job Desk';
		$data['SubMenuTwo'] = '';
		...
		$this->load->view('DocumentStandarization/JobdeskDocument/V_index', $data);
	...
	public function create()
	{
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('V_Header',$data);
			$this->load->view('V_Sidemenu',$data);
			$this->load->view('DocumentStandarization/JobdeskDocument/V_create', $data);
			$this->load->view('V_Footer',$data);	
		} else {
			$data = array(
			...
			redirect(site_url('OTHERS/JobdeskDocument'));
		}
	}
	...
	public function update($id)
	{
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('V_Header',$data);
			$this->load->view('V_Sidemenu',$data);
			$this->load->view('DocumentStandarization/JobdeskDocument/V_update', $data);
			$this->load->view('V_Footer',$data);	
		} else {
			$data = array(
	...
	public function read($id)
	{
		...
		$this->load->view('V_Header',$data);
		$this->load->view('V_Sidemenu',$data);
		$this->load->view('DocumentStandarization/JobdeskDocument/V_read', $data);
		$this->load->view('V_Footer',$data);
	}
