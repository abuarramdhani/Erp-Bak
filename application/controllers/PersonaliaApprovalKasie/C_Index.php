...
class C_index extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('PersonaliaApprovalKasie/M_personaliaapprovekasie');
	...
	public function index(){
		...
		$data['Title']			=	'Approval Atasan (Kasie)';
		$data['Menu'] 			= 	'Lain-lain';
		...
		$data['dashboard'][] = array(
			'ket' 		=> 'Laporan Lembur',
			'link'		=> 'Responsibility/2592',
			'jumlah' 	=> $this->M_personaliaapprovekasie->getSPLOpenCountByNoind($user)
		);
		...
		$this->load->view('PersonaliaApprovalKasie/V_index',$data);
