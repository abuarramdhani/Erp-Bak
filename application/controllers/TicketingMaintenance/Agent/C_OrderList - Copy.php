...
//
	...
	public function selectRekapOPPM()
	{
		...
		// echo "<pre>";print_r($key);
			...
			// echo "<pre>";print_r($newarr[$j]['total_minutes']);
			// echo "<pre>";print_r($newarr[$j]['total_machine']);
			
			// $newarr[$j]['total_minutes'] = $total_minutes[$j];
			// echo "<pre>";print_r($newarr);
			// echo "<pre>";print_r($total_minutes);
			// die;
			// $newarr[$i]['sum'] = number_format(($newarr[$i]['total_duration'] / count($realArray[$i])/60),2);
			// $newarr[$j]['end_result'] = $newarr[$j]['total_minutes']/$newarr[$j]['total_machine']; 
			// $newarr[$j]['end_result'] = number_format(($newarr[$j]['total_minutes']/$newarr[$j]['total_machine']/60),2); 
