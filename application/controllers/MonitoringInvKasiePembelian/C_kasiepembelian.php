...
class C_kasiepembelian extends CI_Controller
{
	...
	public function ListSubkont()
	{
		...
		$status = 'data';
		$status2 = 'row';
		$getStatusSatu = $this->M_kasiepembelian->listInvBermasalahbyFilter($vendor, $status2);
		$bermasalah = $this->M_kasiepembelian->listInvBermasalahbyFilter($vendor, $status);
		$listBuyer = $this->M_kasiepembelian->getBuyer();
		...
		// print_r($bermasalah);
		// print_r($listBuyer);
		// print_r($getStatusSatu);
		// exit();

		$this->load->view('V_Header', $data);
		$this->load->view('V_Sidemenu', $data);
		$this->load->view('MonitoringInvKasiePembelian/V_listInvBermasalahbyFilter', $data);
		$this->load->view('V_Footer', $data);
	}
	public function ambilAlertbyFilter()
	{
		$vendor = $_POST['vendor'];
		$status2 = 'row';
		$getStatusSatu = $this->M_kasiepembelian->listInvBermasalahbyFilter($vendor, $status2);
