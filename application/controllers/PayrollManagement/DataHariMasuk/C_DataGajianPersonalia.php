...
class C_DataGajianPersonalia extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('PayrollManagement/DataHariMasuk/M_datagajianpersonalia');
	...
	public function read($id)
    {
        ...
        if ($row) {
            ...
            $this->load->view('V_Header',$data);
            $this->load->view('V_Sidemenu',$data);
            $this->load->view('PayrollManagement/DataGajianPersonalia/V_read', $data);
            $this->load->view('V_Footer',$data);
        }
        else {
    ...
    public function create()
    {
        ...
        $data = array(
            ...
            'UserSubMenuOne' => $this->M_user->getMenuLv2($user_id,$this->session->responsibility_id),
            'UserSubMenuTwo' => $this->M_user->getMenuLv3($user_id,$this->session->responsibility_id),
            'action' => site_url('PayrollManagement/DataGajianPersonalia/save'),
        ...
        $this->load->view('V_Header',$data);
        $this->load->view('V_Sidemenu',$data);
        $this->load->view('PayrollManagement/DataGajianPersonalia/V_form', $data);
        $this->load->view('V_Footer',$data);
    }
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                ...
                'UserSubMenuOne' => $this->M_user->getMenuLv2($user_id,$this->session->responsibility_id),
                'UserSubMenuTwo' => $this->M_user->getMenuLv3($user_id,$this->session->responsibility_id),
                'action' => site_url('PayrollManagement/DataGajianPersonalia/saveUpdate'),
    ...
    public function import() {
        ...
        if (!$this->upload->do_upload('importfile')) { echo $this->upload->display_errors();}
                ...
                $file_path  = 'assets/upload/importPR/datagajianpersonalia/'.$file_data['file_name'];
