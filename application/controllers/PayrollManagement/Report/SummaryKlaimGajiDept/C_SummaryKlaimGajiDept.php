...
class C_SummaryKlaimGajiDept extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('PayrollManagement/Report/SummaryGajiStaff/M_summaryklaimgajidept');
    ...
    public function index()
    {
        ...
        $data['SubMenuOne'] = 'Lap. Summary Klaim Gaji Staff';
        $data['SubMenuTwo'] = '';
