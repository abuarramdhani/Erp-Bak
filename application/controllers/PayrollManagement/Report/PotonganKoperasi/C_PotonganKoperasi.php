...
class C_PotonganKoperasi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('PayrollManagement/Report/PotonganKoperasi/V_index', $data);
	...
	public function generatePDF() {
        ...
        $html = $this->load->view('PayrollManagement/Report/PotonganKoperasi/V_report', $data, true);
