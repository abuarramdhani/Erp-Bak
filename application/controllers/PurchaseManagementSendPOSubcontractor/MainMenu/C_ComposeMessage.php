...
class C_ComposeMessage extends CI_Controller {
	...
	public function index()
	{
        ...
        $this->load->view('PurchaseManagementSendPOSubcontractor/MainMenu/V_ComposeMessage',$data);
    ...
    public function SendEmail()
	{
		...
		// FTP //
			...
			ftp_cdup($conn);
			ftp_chdir($conn, '/mnt/NASB/SUBCONT_ADMIN/');
			// echo ftp_pwd($conn);
		...
		$mail->setFrom('subcontractor.khs@gmail.com', 'Admin PO CV. KHS');
	...
	{
		$this->load->model('PurchaseManagementSendPOSubcontractor/MainMenu/M_composemessage');
	...
	public function PurchaseManagementDocument($id)
	{
		...
		$content 	= $this->load->view('PurchaseManagementSendPOSubcontractor/Report/V_Content', $data,true);
