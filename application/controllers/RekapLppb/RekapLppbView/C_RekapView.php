...
class C_RekapView extends CI_Controller
{
	...
	function __construct()
		{
			...
			$this->load->model('RekapLppb/RekapLppbView/M_rekapview');
	...
	public function index()
		{
			...
			$this->load->view('RekapLppb/RekapLppbView/V_Dashboard',$data);
		...
		public function Rekap(){
			...
			for ($i=0; $i <count($navbulan) ; $i++) { 
				...
				$hasil = $this->M_rekapview->getSelisih($prmbulan);
				if ($hasil != null) {
			...
			$data['data'] = $this->M_rekapview->getDataRekap($prmmonth);
			$this->load->view('V_Header',$data);
			$this->load->view('V_Sidemenu',$data);
			$this->load->view('RekapLppb/RekapLppbView/V_RekapView',$data);
			$this->load->view('V_Footer',$data);
		...
		public function SearchData(){
			...
			$data['data'] = $this->M_rekapview->getDataRekap($bulan);
			$this->load->view('RekapLppb/RekapLppbView/V_Result', $data);
		}
