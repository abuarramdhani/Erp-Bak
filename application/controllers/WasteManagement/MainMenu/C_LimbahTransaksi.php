...
class C_LimbahTransaksi extends CI_Controller
{
	...
	public function create()
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			redirect(site_url('WasteManagement/LimbahTransaksi/sendMail/create'));
		}
	}
	...
	public function update($id)
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			redirect(site_url('WasteManagement/LimbahTransaksi/sendMail/edit'));
		}
	}
    ...
    public function delete($id)
    {
		...
		redirect(site_url('WasteManagement/LimbahTransaksi/sendMail/delete'));
	...
	function sendMail($action){ 
		...
		$message 	= '	<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://wwwhtml4/loose.dtd">
				...
				<body>
					...
					<p> Admin WM telah <b>'.$keterangan.'</b> data <b>Limbah Masuk</b>
					</p>
					<hr/>
					<p>
					Salam,
