                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <input class="form-control" value="<?= $tukar['min'].' - '.$tukar['max']; ?>" disabled />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 pss_formPekerja" style="margin-top: 50px;">
                                            <div class="col-md-6 pss_data_pkj" style="" id="pss_data_pkj_1">
                                                ...
                                                <div class="col-md-12" style="margin-top: 10px;">
                                                    ...
                                                    <div style="padding-right: 0px;" class="col-md-3">
                                                        <input class="form-control pss_tgl" placeholder="Tanggal" readonly="" value="<?= $tukar['tgl_arr'][$i]?>"/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <input class="form-control pss_shift" readonly="" value="<?= $tukar['shift1'][$i] ?>"/>
                                                    </div>
                                                </div>
                                                <?php } ?>
                                                ...
                                                <?php else: ?>
                                                    <?php /*sengaja di buat salah*/ if (1==2): ?>
                                                        <button class="btn btn-success pss_app_now" level="1" isduo="<?php echo empty(rtrim($tukar['noind2'])) ? 'y':'n'; ?>"><i class="fa fa-check"></i> Approve</button>
                                            ...
                                            <div class="col-md-6 pss_data_pkj" style="" id="pss_data_pkj_2">
                                                ...
                                                <div class="col-md-12" style="margin-top: 10px;">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="form-control" disabled="" value="<?= $tukar['noind2']?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-12" style="margin-top: 10px;">
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="form-control pss_nama" placeholder="Nama" readonly="" value="<?= $tukar['nama2']?>" />
                                                    </div>
                                                </div>
                                                <?php for ($i=0; $i < $tukar['jumlah']; $i++) { ?>
                                                <div class="col-md-12" style="margin-top: 10px;">
                                                    ...
                                                    <div class="col-md-6">
                                                    <input class="form-control pss_shift" readonly="" value="<?= $tukar['shift2'][$i] ?>"/>
                                                    </div>
                                                </div>
                                                <?php } ?>
                                                <div class="col-md-12 text-center" style="margin-top: 10px; margin-bottom: 10px;">
                                        ...
                                        <div class="col-md-12 text-center" style="margin-top: 10px; margin-bottom: 10px;">
                                            <?php if (!empty($tukar['alasan']) && $tukar['status'] == '03'): ?>
