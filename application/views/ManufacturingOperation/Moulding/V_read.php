                                            ...
                                            <div class="col-lg-12">
                                                <div class="table-responsive">
                                                    ...
                                                    <?php foreach ($Moulding as $headerRow): ?>
														...
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Moulding Quantity</strong></td>
                                                            <td style="border: 0">: <?php echo $headerRow['moulding_quantity']; ?></td>
                                                        </tr>
														<tr>
														...
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Scrap Type</strong></td>
                                                            <td style="border: 0">: <?php echo $headerRow['scrap_type']; ?></td>
                                                        </tr>
													<?php endforeach; ?>
                                                    </table>
                                                </div>
