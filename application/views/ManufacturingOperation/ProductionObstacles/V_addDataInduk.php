                                ...
                                <div id="1" class="tab-pane fade in active">
                                    <form method="post" enctype="multipart/form-data" class="form-horizontal" action="<?php echo base_url('ManufacturingOperation/ProductionObstacles/master/submitInduk'); ?>">
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" name="txt_typeInduk" value="logam">
                                        ...
                                        <div class="col-md-6">
                                            <div id="input-containerInti" style="padding-bottom: 10px">
                                                <div id="containerInti" class="input-group">
                                                    <input type="text" name="txt_induk[]" class="form-control" placeholder="Input Induk" required>
                                                    <div class="input-group-btn">
                                                        <a class="btn btn-default" id="addNewInduk1">
                                                            <i class="fa fa-plus"></i>
                                                        </a>
                                                        <a class="btn btn-default" id="removeNewInduk1" style="display: none">
                                                            <i class="fa fa-minus"></i>
                                                        </a>
                                                    </div>  
                                                </div>
                                            </div>
                                            <input type="hidden" name="txt_typeInduk" value="inti">
                                            <button type="submit" class="btn btn-success">Submit</button>
                                        </div>
                                    </form>
                                </div>
