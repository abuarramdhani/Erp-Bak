                    ...
                    <div class="col-lg-12">
                        <div class="box box-primary box-solid">
                            ...
                            <div class="panel-body">
                                <form method="post" action="<?php echo base_url('ManufacturingOperation/ProductionObstacles/Hambatan/mesin/submitUpdateHU') ?>">
                                <?php foreach ($edtHam as $h) { ?>
                                    ...
                                    <a class="btn btn-warning" href="<?php echo base_url('ManufacturingOperation/ProductionObstacles/Hambatan/mesin/PerMesin') ?>">Cancel</a>
                                    <?php }?>
                                </form>
                            </div>
                        </div>
