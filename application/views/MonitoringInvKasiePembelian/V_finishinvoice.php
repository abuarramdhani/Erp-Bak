				...
				<div class="row">
					<div class="col-lg-12">
							...
							<form id="filInvoice" >
								<table id="finishInvoiceTable" >
									...
									<tr>
										...
										<td>
											<input class="form-control" size="40" type="text" value="<?php echo 'Rp. '. number_format($invoice[0]['INVOICE_AMOUNT'],0,'.','.').',00-';?>" readonly>
										</td>
									</tr>
									<tr>
										<td>
									...
									<tr>
										...
										<td>
											<input  class="form-control" size="40" type="text" value="<?php echo $invoice[0]['INVOICE_CATEGORY']?>" readonly>
										</td>
										<td>
											<span><label>Jenis Jasa</label></span>
										</td>
										<td>
											<input  class="form-control" size="40" type="text" value="<?php echo $invoice[0]['JENIS_JASA']?>" readonly>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<input  class="form-control" size="40" type="text" value="<?php echo $invoice[0]['NOMINAL_DPP']?>" readonly>
										</td>
									</tr>
									<tr>
										<td>
						...
						<div class="col-md-4 pull-left">
							<label>Po Amount: <span><?php echo 'Rp. '. number_format(round($po_amount),0,'.','.').',00-';?></span>
							</label>
						</div>
