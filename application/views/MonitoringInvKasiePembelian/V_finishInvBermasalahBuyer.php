		...
		<div class="row">
			<div class="col-lg-12">
				<div class="row">
					<div class="col-lg-12">
						<div class="text-left ">
							<span><b>Finish Invoice Bermasalah Buyer</b></span>
						</div>
					</div>
				</div>
				<br />
								...
								<table id="unprocessTabel" class="table table-striped table-bordered table-hover text-center tblMI">
									...
									<tbody>
										...
										<tr>
											...
											<td> 
												<a title="History..." style="width:100px;margin-bottom: 5px" onclick="KonfirmasiBuyer(<?php echo $u['INVOICE_ID'];?>)" data-target="MdlBuyer" data-toggle="modal" class="btn btn-default btn-sm"><i class="fa fa-file-text-o"></i> History
												</a>
