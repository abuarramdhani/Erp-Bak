			...
			<div class="col-lg-12">
				...
				<div class="row">
					<div class="col-lg-12">
							...
							<form id="filInvoice" >
								<table id="tbInvoiceKasie" >
									<tr>
										...
										<td><input  class="form-control" size="40" type="text" value="<?php echo $invoice_detail[0]['INVOICE_NUMBER']?>" readonly>
									...
									<tr>
										...
										<td>
											<input  class="form-control" size="40" type="text" value="<?php echo date('d-M-Y',strtotime($invoice_detail[0]['INVOICE_DATE']))?>" readonly>
										</td>
									</tr>
									<tr>
										<td>
						...
						<table id="invoiceKasiePembelian" class="table table-bordered table-hover table-striped text-center tblMI" style="width: 200%">
							<thead>
								<tr class="bg-primary">
