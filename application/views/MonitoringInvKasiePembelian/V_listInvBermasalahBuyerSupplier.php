		...
		<div class="row">
			<div class="col-lg-12">
				<div class="row">
					<div class="col-lg-12">
						<div class="text-left ">
							<span><b>List Invoice Bermasalah Buyer (Supplier)</b></span>
						</div>
					</div>
				</div>
				<br />
									...
									<table id="unprocessTabel" class="table table-striped table-bordered table-hover text-center tblMI">
										...
										<tbody>
											...
											<tr>
												...
												<td> 
													<a disabled title="Konfirmasi..." style="width:100px;margin-bottom: 5px" onclick="KonfirmasiBuyer(<?php echo $u['INVOICE_ID'];?>)" data-target="MdlBuyer" data-toggle="modal" class="btn btn-info btn-sm"><i class="fa fa-file-text-o"></i> Konfirmasi
													</a>

													<a disabled title="Feedback..." style="width:100px;" onclick="FeedbackBuyer(<?php echo $u['INVOICE_ID'];?>)" data-target="MdlBuyer" data-toggle="modal" class="btn btn-success btn-sm"><i class="fa fa-check"></i> Feedback
													</a>
												...
												<td><b><?php echo $u['NO_INDUK_BUYER']?></b></td>
											</tr>
											<?php $no++; } ?>
										</tbody>
									</table>
