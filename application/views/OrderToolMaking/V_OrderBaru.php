                        ...
                        <form method="post" id="orderbaru_otm" enctype="multipart/form-data" action="<?php echo base_url('OrderToolMaking/MonitoringOrder/saveorder')?>">
                            <div class="box-body">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-7">
                                        <span id="view_gamker" style="display:none"><img id="previewgamker" style="width:100%;max-width: 350px;max-height: 350px"></span>
                                ...
                                <div class="panel-body baru">
                                    ...
                                    <div class="col-md-7">
                                        <input name="mesin" class="form-control baru2" placeholder="mesin yang digunakan" autocomplete="off">
                                    </div>
                                </div>
                                <div class="panel-body modifrekon" style="display:none">
                                    <div class="col-md-2"></div>
                                ...
                                <div class="panel-body">
                                    <div class="col-md-2"></div>
                                    <div class="col-md-2">
                                        <label>Poin Yang Diproses</label>
                                    </div>
                                    <div class="col-md-7">
                                        <input name="poin" class="form-control" placeholder="poin yang diproses" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <div class="col-md-2"></div>
                                ...
                                <div class="panel-body baru">
                                    ...
                                    <div class="col-md-7">
                                        <input name="jml_alat" class="form-control baru2" placeholder="jumlah alat" autocomplete="off">
                                    </div>
                                    <!-- <div class="col-md-1">
                                ...
                                <div class="panel-body baru">
                                    ...
                                    <div class="col-md-6">
                                        <input name="flow_sebelum" class="form-control baru2" placeholder="flow proses sebelumnya" autocomplete="off">
                                    </div>
                                </div>
                                <div class="panel-body baru">
                                    <div class="col-md-2"></div>
                                    ...
                                    <div class="col-md-6">
                                        <input name="flow_sesudah" class="form-control baru2" placeholder="flow proses sesudahnya" autocomplete="off">
                                    </div>
                                </div>
                                <div class="panel-body baru">
                                    <div class="col-md-2"></div>
