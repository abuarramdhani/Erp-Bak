...
if ($val['ket'] == 'Baru') { // view tabel baru
    ...
    $height = 2300; // tinggi modal berdasarkan data tersebut sudah accept / belum (revisi 1 = belum accept, jadi masih bisa di revisi)
...
<div class="panel-body">
    ...
    <div class="col-md-8">
        <?php if(!empty($val['poinrevisi'])){ ?>
        <div class="box box-danger box-solid">
            <div class="panel-body">
                <div class="col-md-12">
                    <label>Poin Yang Perlu Direvisi :</label>
                    <input type="hidden" name="edit_rev" value="revisi">
                </div>
                <?php for ($i=0; $i < count($val['poinrevisi']) ; $i++) {  ?>
                <div class="col-md-12">
                    <li><?= $val['poinrevisi'][$i]['poin_revisi'] ?></li>
                </div>
                <?php }?>
            </div>
        </div>
        <?php }else{ ?>
            <input type="hidden" name="edit_rev" value="edit">
        <?php }?>
        ...
        <div class="box box-info box-solid">
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    <label style="color:red">Poin Yang Perlu Direvisi :</label>
                </div>
                <?php for ($i=0; $i < count($val['poinrevisi']) ; $i++) {  ?>
                <div class="col-md-12">
                    <li><?= $val['poinrevisi'][$i]['poin_revisi'] ?></li>
            ...
            <div class="panel-body">
                ...
                <div class="col-md-9">
                    <textarea id="keterangan" name="keterangan" placeholder="keterangan" style="height:70px;width:100%"></textarea>
                </div>
            </div>
        </div>
        </div> -->
        ...
        <div class="col-md-12 text-center"><br>
            <button class="btn btn-success" formaction="<?php echo base_url("OrderToolMaking/MonitoringOrder/saveEditProses")?>"><i class="fa fa-spinner"></i> Save Edit</button>
        </div>
    </div>
</div>
