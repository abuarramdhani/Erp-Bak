	...
	<div style="width: 100%">
        <table border="1" width="100%" style="margin-top: 20px; border-collapse: : collapse">
            <tr>
                ...
                <th style="text-align: center;" colspan="4" style="background-color: #94cfff">DARI PUSAT</th>
            </tr>
            <tr>
                <th style="text-align: center;" width="23%">08:00</th>
                <th style="text-align: center;" width="23%">10:00</th>
                <th style="text-align: center;" width="23%">13:00</th>
                <th style="text-align: center;" width="23%">-</th>
            </tr>
            <tr>
                <th style="text-align: center;" rowspan="4" style="background-color: #94cfff">D<br>A<br>R<br>I<br><br>T<br>U<br>K<br>S<br>O<br>N<br>O</th>
