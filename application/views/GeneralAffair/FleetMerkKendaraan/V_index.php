                        ...
                        <div class="box box-primary box-solid">
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table class="datatable table table-striped table-bordered table-hover text-left" id="tblFleetMerkKendaraan" style="font-size:12px;">
                                        ...
                                        <tbody>
                                            <?php 
                                            	...
                                            	$encrypted_string = $this->encrypt->encode($row['merk_kendaraan_id']);
