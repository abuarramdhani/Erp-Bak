<section class="content">
    <div class="inner" >
        <div class="row">
            <form method="post" action="<?php echo site_url('GeneralAffair/LimbahTransaksi/update/'.$id);?>" class="form-horizontal">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <select id="cmbSatuanHeader" name="cmbSatuanHeader" class="select select2" data-placeholder="Choose an option" style="width: 100%">
                                                        <option value=""></option>
                                                        <option value="1" <?php if ($headerRow['satuan'] == "1") { echo "selected"; }?>>TON</option>
                                                        <option value="0" <?php if ($headerRow['satuan'] == "0") { echo "selected"; }?>>PCS</option>
                                                    </select>
                                                </div>
                                            </div>
