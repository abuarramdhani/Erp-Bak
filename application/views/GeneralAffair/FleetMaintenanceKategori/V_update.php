<section class="content">
    <div class="inner" >
        <div class="row">
            <form method="post" action="<?php echo site_url('GeneralAffair/FleetMaintenanceKategori/update/'.$id);?>" class="form-horizontal">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">Update Fleet Maintenance Kategori</div>
                                <?php
                                    foreach ($FleetMaintenanceKategori as $headerRow):
                                ?>
                                <div class="box-body">
                                    <div class="panel-body">
                                        <div class="row">
											<div class="form-group">
                                                <label for="txtMaintenanceKategoryHeader" class="control-label col-lg-4">Kategori Maintenance</label>
                                                <div class="col-lg-4">
                                                    <input type="text" placeholder="Kategori Maintenance" name="txtKategoriMaintenanceHeader" id="txtKategoriMaintenanceHeader" class="form-control" value="<?php echo $headerRow['kategori_maintenance']; ?>"/>
                                                </div>
                                            </div>
