                                    ...
                                    <div class="panel-body">
                                        <div class="row">
											<div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" placeholder="Kendaraan Id" name="txtKendaraanIdHeader" id="txtKendaraanIdHeader" class="form-control" />
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" placeholder="Pekerja" name="txtPekerjaHeader" id="txtPekerjaHeader" class="form-control" />
                                                </div>
                                            </div>
