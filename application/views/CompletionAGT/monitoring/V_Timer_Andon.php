  ...
  <table class="table table-bordered tbl-agt-timer-andon text-center" style="width:100%">
    <thead>
      <tr class="bg-primary">
        ...
        <td style="width:35%">Stop Time</td>
          ...
          <td>
            ...
            <div style="display:flex;width:80%">
                <select class="s_andon stop_andon_jam" name="" style="width:30%">
                  <option value="<?php echo explode(':', $value['TIME_STOP'])[0] ?>"><?php echo explode(':', $value['TIME_STOP'])[0] ?></option>
                ...
                <select class="s_andon stop_andon_menit" name="" style="width:30%">
                  <option value="<?php echo explode(':', $value['TIME_STOP'])[1] ?>"><?php echo explode(':', $value['TIME_STOP'])[1] ?></option>
          ...
          <td>
            ...
            <div style="display:flex;width:80%">
                <select class="s_andon start_andon_jam" name="" style="width:30%">
                  <option value="<?php echo explode(':', $value['TIME_START'])[0] ?>"><?php echo explode(':', $value['TIME_START'])[0] ?></option>
                  <option value="01">01</option>
                  <option value="02">02</option>
                  <option value="03">03</option>
                  <option value="04">04</option>
                ...
                <select class="s_andon start_andon_menit" name="" style="width:30%">
                  <option value="<?php echo explode(':', $value['TIME_START'])[1] ?>"><?php echo explode(':', $value['TIME_START'])[1] ?></option>
                  <option value="00">00</option>
                  <option value="01">01</option>
                  <option value="02">02</option>
                  <option value="03">03</option>
