    ...
    <tbody>
      <?php foreach ($get as $key => $value): ?>
        <tr>
          ...
          <td>
            <center>
              <button type="button" class="btn btn-sm btn-danger" <?php echo $value['STATUS_JOB'] != 'POS_5' ? 'disabled' : '' ?> name="button" style="width:40px;" onclick="del_agt_andon_pos('<?php echo $value['ITEM_ID'] ?>', 2)"> <i class="fa fa-trash"></i> </button>
            </center>
          </td>
        </tr>
      <?php endforeach; ?>
