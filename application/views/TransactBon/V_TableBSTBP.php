<form action="<?=base_url('TransactBon/C_Transact/insertOracle2'); ?>" method="post">
<div class="row">
    <div class="col-md-12" >
        <div class="table">
                        ...
                        <table class="datatable table table-striped table-bordered table-hover text-center" id="tblDataStock" style="width: 100%;">
                           <thead style="position:sticky;top:0;">
                                <tr class="bg-primary">
                                    ...
                                    <th  class="bg-primary" style="position:sticky;top:0;" width="50px" rowspan="2">Dikembalikan</th>
                                    <th style="display:none" class="bg-primary" style="position:sticky;top:0;" width="50px" rowspan="2">Penyerahan Postgre</th>
                                    <th  class="bg-primary" style="position:sticky;top:0;" width="50px" rowspan="2">Diterima</th>
                                    ...
                                    <th style="display:none" class="bg-primary" style="position:sticky;top:0;" width="70px" rowspan="2" >Organization ID</th>
                            </thead>
                            <tbody>
                                <tr>
                                <?php
                                    ...
                                    <input hidden name="tsc_org[]" value="<?php echo $key['org_id']; ?>">
                                    <input hidden id="give2" value="<?php echo $key['penyerahan']; ?>"/></td>
                                    </td>
                                    <td><?php echo $key['nama_barang']; ?></td>
                                    <td><?php echo $key['satuan']; ?></td>

                                    <td id="minta"><?php echo $key['permintaan']; ?></td>
                                    ...
                                    <td style="display:none"><?php echo $key['org_id']; ?></td>
                                    <!-- if (empty(array)){
                                        $org_id = 0;
                                        }else{ var = array['org_id'][kolom] }
                                        ?>
                                    </td> -->
                                </tr>
                            <?php $no++; } } ?>
