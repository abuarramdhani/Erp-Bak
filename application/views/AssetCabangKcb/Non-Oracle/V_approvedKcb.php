										...
										<tbody>
											<?php $i=1; foreach ($approved as $k) {?>
												<tr>
													...
													<?php if ($k['status'] == '2') { ?>
													<td>
													<span><label class="label label-default"><i class="fa fa-paper-plane"></i>&nbsp;Send to Marketing</span>
													</td>
													<?php } ?>
													...
													<?php }?>
													<td>
													<a href="<?php echo base_url('AssetCabangKacab/downloadKacab/'.$k['pdf_title_cbg'])?>">
