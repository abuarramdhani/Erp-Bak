							...
							<div class="row">
								<div class="col-lg-6">
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<label style="margin-left:2%; top:+3;"><input type="radio" name="approve" value="21" style="transform: scale(1.5); vertical-align:top;" checked> Terima</label>
										</div>
										<div class="col-sm-7">
											<label style="margin-left:5%; vertical-align:bottom;"><input type="radio" name="approve" value="31" style="transform: scale(1.5); vertical-align:top;"> Batalkan</label>
										</div>
									</div>
