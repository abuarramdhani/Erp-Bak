	      ...
	      <div class="row">
	        <div class="col-lg-12">
		        <div class="box box-primary box-solid">
                  ...
                  <a href="<?php echo site_url('PayrollManagement/RiwayatPenerimaKonpensasiLembur/create/') ?>" style="float:right;margin-right:1%;margin-top:-0.5%;" alt="Add New" title="Add New" >
                      <button type="button" class="btn btn-default btn-sm">
                        <i class="icon-plus icon-2x"></i>
                      </button>
                    </a>
                    <b>Set Penerima Konpensasi Lembur</b>
		          </div>
		          <div class="box-body">
		                ...
		                <tbody>
							...
							<tr>
                              ...
                              <td align='center' width='200px'>
                              	<a href="<?php echo base_url('PayrollManagement/RiwayatPenerimaKonpensasiLembur/read/'.$row->id_riwayat.''); ?>" class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="bottom" title="Read Data"><span class="fa fa-eye"></span></a>
