                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
									...
									<div class="form-group">
	                                    ...
	                                    <div class="col-lg-4">
	                                        <select style="width:100%" id="cmbKdJnsTransaksi" name="cmbKdJnsTransaksi" class="select2" data-placeholder="Choose an option"><option value=""></option>
                                                <?php
									...
									<input type="hidden" name="txtIdCuti" value="<?php echo $id_cuti; ?>" />
								</div>
