		        ...
		        <div class="box box-primary box-solid">
		          ...
		          <div class="box-body">
		            ...
		            <div class="table-responsive">
		              <div class="row">
			              <form method="post" action="<?php echo base_url('PayrollManagement/TransaksiKlaimSisaCuti/upload')?>" enctype="multipart/form-data">
					  ...
					  <?php
					    if (!empty($data)) {
					  ?>
					  <form method="post" action="<?php echo base_url('PayrollManagement/TransaksiKlaimSisaCuti/saveImport')?>">
					    <div class="row" style="margin: 10px 0 10px 10px">
