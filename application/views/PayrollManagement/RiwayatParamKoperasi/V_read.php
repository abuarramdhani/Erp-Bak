...
<div class="form-group">
                                            <label for="txtIdRiwayat" class="control-label col-lg-4">ID</label>
                                            <div class="col-lg-4">
                                                <input type="text" name="txtIdRiwayat" id="txtIdRiwayat" class="form-control" value="<?php echo $id_riwayat; ?>" readonly/>
                                            </div>
                                        </div>
<div class="form-group">
...
<div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" name="txtIkop" id="txtIkop" class="form-control" value="<?php echo $ikop; ?>" readonly/>
                                            </div>
                                        </div>
<div class="form-group">
