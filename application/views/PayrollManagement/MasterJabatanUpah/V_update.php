                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">Update Master Jabatan Upah</div>
                                <div class="box-body">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
											<div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" placeholder="Jabatan Upah" name="txtJabatanUpahHeader" id="txtJabatanUpahHeader" class="form-control" value="<?php echo $jabatan_upah; ?>"/>
                                                </div>
                                            </div>
