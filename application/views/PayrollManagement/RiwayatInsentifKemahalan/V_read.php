                    ...
                    <div class="col-lg-12">
                        <div class="box box-primary box-solid">
                            <div class="box-header with-border">
                                Read Riwayat Insentif Kemahalan
                            </div>
                        <div class="box-body">
...
<div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" name="txtInsentifKemahalan" id="txtInsentifKemahalan" class="form-control" value="<?php echo $insentif_kemahalan; ?>" readonly/>
                                            </div>
                                        </div>
<div class="form-group">
