		          ...
		          <div class="box-body">
					<div class="row">
						<div class="row" style="margin: 10px 0px">
							<form method="post" action="<?php echo base_url('PayrollManagement/Report/PotonganSPSI/search')?>" enctype="multipart/form-data">
								<div class="col-lg-2">
							...
							echo '<div class="row" style="margin: 10px 0px">
								<table>
									...
									<tr>
										...
										<td> :&nbsp</td>
										<td><a class="btn btn-xs btn-primary" href="'.site_url('PayrollManagement/Report/PotonganSPSI/GeneratePDF?year='.$year.'&month='.$month).'">'.
		            ...
		            <div class="table-responsive">
		              <table class="table table-striped table-bordered table-hover text-left" id="dataTables-reportPotonganSPSI" style="font-size:12px;">
