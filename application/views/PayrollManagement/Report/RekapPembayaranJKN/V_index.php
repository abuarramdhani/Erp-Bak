	        		...
	        		<div class="col-lg-12">
	        			<div class="col-lg-11">
			            	<div class="text-right">
			            		<h1><b>Rekap Pembayaran JKN</b></h1>
			            	</div>
			          	</div>
			          	<div class="col-lg-1">
			        ...
			        <div class="col-lg-12">
				        <div class="box box-primary box-solid">
				        	<div class="box-header with-border">
								<b>Rekap Pembayaran JKN</b>
				          	</div>
				          	<div class="box-body">
								<div class="row">
									<div class="row" style="margin: 10px 0px">
										<form method="post" action="<?php echo base_url('PayrollManagement/Report/RekapPembayaranJKN/search')?>" enctype="multipart/form-data">
											<div class="col-lg-2">
											...
											echo '<div class="row" style="margin: 10px 0px">
												<table>
													...
													<tr>
														...
														<td> :&nbsp</td>
														<td><a class="btn btn-xs btn-primary" href="'.site_url('PayrollManagement/Report/RekapPembayaranJKN/GeneratePDF?no_induk='.$no_induk.'&year='.$year).'">'.
					              	...
					              	<table class="table table-striped table-bordered table-hover text-left" style="font-size:12px;">
						                <thead class="bg-primary">
							                <tr>
												...
												<th style="text-align:center"><div style="width:100px"></div>Tagihan JKN Karyawan</th>
												<th style="text-align:center"><div style="width:100px"></div>Tagihan JKN Perusahaan</th>
												<th style="text-align:center"><div style="width:100px"></div>Total Tagihan JKN</th>
							                </tr>
						                </thead>
						                <tbody>
											<?php $no = 1; 
											if(!empty($pembayaran_jkn)){
												...
												<tr>
													...
													<td align='center'><?php echo 'Rp. '.number_format($row['jkn_karyawan'],0,",",".") ?></td>
													<td align='center'><?php echo 'Rp. '.number_format($row['jkn_perusahaan'],0,",",".") ?></td>
													<td align='center'><?php echo 'Rp. '.number_format($row['total_jkn'],0,",",".") ?></td>
												</tr>
											<?php 
												}
											}
											...
											?>
												<tr>
													...
													<td align='center'><?php echo 'Rp. '.number_format($total_pembayaran_jkn['jkn_karyawan'],0,",",".") ?></td>
													<td align='center'><?php echo 'Rp. '.number_format($total_pembayaran_jkn['jkn_perusahaan'],0,",",".") ?></td>
													<td align='center'><?php echo 'Rp. '.number_format($total_pembayaran_jkn['total_jkn'],0,",",".") ?></td>
												</tr>
											<?php
											}
											?>
