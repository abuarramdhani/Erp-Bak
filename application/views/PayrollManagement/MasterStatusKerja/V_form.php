                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
									<div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" placeholder="Status Kerja" name="txtKdStatusKerjaNew" id="txtKdStatusKerjaNew" class="form-control text-uppercase" value="<?php echo $kd_status_kerja; ?>" maxlength="2"/>
                                            </div>
                                    </div>
									<div class="form-group">
                                            <label for="txtStatusKerja" class="control-label col-lg-4">Status Kerja</label>
                                            <div class="col-lg-4">
                                                <input type="text" placeholder="Status Kerja" name="txtStatusKerja" id="txtStatusKerja" class="form-control text-uppercase" value="<?php echo $status_kerja; ?>" maxlength="50"/>
                                            </div>
                                    </div>
									<div class="form-group">
                                            <label for="txtStatusKerjaSingkat" class="control-label col-lg-4">Status Kerja Singkat</label>
                                            <div class="col-lg-4">
                                                <input type="text" placeholder="Status Kerja Singkat" name="txtStatusKerjaSingkat" id="txtStatusKerjaSingkat" class="form-control text-uppercase" value="<?php echo $status_kerja_singkat; ?>" maxlength="30"/>
                                            </div>
                                    </div>
