                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
									<div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" placeholder="UM" name="txtUmNew" id="txtUmNew" class="form-control" value="<?php echo rtrim($um); ?>" onkeypress="return isNumberKey(event)" maxlength="7"/>
                                            </div>
                                    </div>
									<div class="form-group">
                                            <label for="txtUbt" class="control-label col-lg-4">UBT</label>
                                            <div class="col-lg-4">
                                                <input type="text" placeholder="UBT" name="txtUbt" id="txtUbt" class="form-control" value="<?php echo rtrim($ubt); ?>" onkeypress="return isNumberKey(event)" maxlength="7"/>
                                            </div>
                                    </div>
