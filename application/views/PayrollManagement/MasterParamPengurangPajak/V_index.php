	      ...
	      <div class="row">
	        <div class="col-lg-12">
		        <div class="box box-primary box-solid">
                  ...
                  <a href="<?php echo site_url('PayrollManagement/MasterParamPengurangPajak/create/') ?>" style="float:right;margin-right:1%;margin-top:-0.5%;" alt="Add New" title="Add New" >
                      <button type="button" class="btn btn-default btn-sm">
                        <i class="icon-plus icon-2x"></i>
                      </button>
                    </a>
                    <b>Set Pengurang Pajak</b>
		          </div>
		          <div class="box-body">

		            <div class="table-responsive">
		              <table class="table table-striped table-bordered table-hover text-left" id="dataTables-masterParamPengurangPajak" style="font-size:12px;">
		                ...
		                <tbody>
							<?php $no = 1; foreach($masterParamPengurangPajak_data as $row) { ?>
							<tr>
							  <td align='center'><?php echo $no++;?></td>
                              <td align='center' width='200px'>
                              	<a href="<?php echo base_url('PayrollManagement/MasterParamPengurangPajak/read/'.$row->id_setting.''); ?>" class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="bottom" title="Read Data"><span class="fa fa-eye"></span></a>
