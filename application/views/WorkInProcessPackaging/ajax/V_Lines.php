              ...
              <tr class="rowbaru_wipp" id="wipprow1">
                <td>
                  <center>
                    ...
                    <input type="text" class="form-control" id="job_wipp<?php echo $no ?>" name="job1[]" value="<?php echo $l1['no_job'] ?>" readonly>
                  </center>
                </td>
                <td>
                ...
                <td>
                  <center><input type="text" class="form-control" name="target1[]" id="target_pe<?php echo $no ?>" placeholder="20%" value="<?php echo $l1['target_pe'] ?>" readonly></center>
                </td>
                <td>
                  <center><button type="button" class="btn btn-sm bg-navy" onclick="minus_wipp(<?php echo $no ?>)" style="border-radius:10px;" name="button"><i class="fa fa-minus-square"></i></button></center>
                </td>
              </tr>
              <input type="hidden" name="id_job_list1[]" id="jobid1_<?php echo $no ?>" value="<?php echo $l1['id_job_list'] ?>">
          ...
          <table class="table table-striped table-bordered table-hover text-left line2wipp" style="font-size:11px;">
            ...
            <tbody id="tambahisiwipp2">
              ...
              <tr class="rowbaru2_wipp" id="wipp2row1">
                ...
                <td>
                  <center><input type="text" class="form-control" name="target2[]" id="target2_pe<?php echo $no ?>" placeholder="20%" value="<?php echo $l2['target_pe'] ?>" readonly></center>
                </td>
                <td>
                  <center><button type="button" class="btn btn-sm bg-navy" onclick="minus_wipp2(<?php echo $no ?>)" style="border-radius:10px;" name="button"><i class="fa fa-minus-square"></i></button></center>
                </td>
              </tr>
              <input type="hidden" name="id_job_list2[]" id="jobid2_<?php echo $no ?>" value="<?php echo $l2['id_job_list'] ?>">
            ...
            <tbody id="tambahisiwipp3">
              <?php $no=1;  foreach ($line_3 as $key => $l3): ?>
                <tr class="rowbaru3_wipp" id="wipp3row1">
                  ...
                  <td>
                    <center><input type="text" class="form-control" name="target3[]" id="target3_pe<?php echo $no ?>" value="<?php echo $l3['target_pe'] ?>" placeholder="30%" readonly></center>
                  </td>
                  <td>
                    <center><button type="button" class="btn btn-sm bg-navy" onclick="minus_wipp3(<?php echo $no ?>)" style="border-radius:10px;" name="button"><i class="fa fa-minus-square"></i></button></center>
                  </td>
                </tr>
                <input type="hidden" name="id_job_list3[]" id="jobid3_<?php echo $no ?>" value="<?php echo $l3['id_job_list'] ?>">
            ...
            <tbody id="tambahisiwipp4">
              <?php $no=1;  foreach ($line_4 as $key => $l4): ?>
                <tr class="rowbaru4_wipp" id="wipp4row1">
                  ...
                  <td>
                    <center><input type="text" class="form-control" name="target4[]" id="target4_pe<?php echo $no ?>" value="<?php echo $l4['target_pe'] ?>" placeholder="40%" readonly></center>
                  </td>
                  <td>
                    <center><button type="button" class="btn btn-sm bg-navy" onclick="minus_wipp4(<?php echo $no ?>)" style="border-radius:10px;" name="button"><i class="fa fa-minus-square"></i></button></center>
                  </td>
                </tr>
                <input type="hidden" name="id_job_list4[]" id="jobid4_<?php echo $no ?>" value="<?php echo $l4['id_job_list'] ?>">
        ...
        <tbody id="tambahisiwipp5">
          <?php $no=1;  foreach ($line_5 as $key => $l5): ?>
            <tr class="rowbaru5_wipp" id="wipp5row1">
              ...
              <td>
                <center><input type="text" class="form-control" name="target5[]" id="target5_pe<?php echo $no ?>" value="<?php echo $l5['target_pe'] ?>" placeholder="50%" readonly></center>
              </td>
              <td>
                <center><button type="button" class="btn btn-sm bg-navy" onclick="minus_wipp5(<?php echo $no ?>)" style="border-radius:10px;" name="button"><i class="fa fa-minus-square"></i></button></center>
              </td>
            </tr>
            <input type="hidden" name="id_job_list5[]" id="jobid5_<?php echo $no ?>" value="<?php echo $l5['id_job_list'] ?>">
