    ...
    <div style="width:100%">
      <div style="width:100%;float:left;margin-right:23.5px">
        <table style="border-collapse:collapse;width:100%;page-break-inside:avoid">
          ...
          <tr>
            <td colspan="8" style="border-left:1px solid black;border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;padding:5px;text-align:center;font-size:14px">VISUALISASI TEMUAN</td>
          </tr>
          <tr>
