      ...
      <form action="<?= base_url('SystemIntegration/KaizenPekerjaTks/input/addKaizen') ?>" method="post" enctype="multipart/form-data">
        <div class="row">
          ...
          <div class="form-group col-md-12" hidden>
            ...
            <div class="col-md-5">
              <input name="sectionCode" id="sectionCode" type="text" class="form-control">
            </div>
          </div>
          <div class="form-group col-md-12">
            <label class="col-md-2">Seksi</label>
            <div class="col-md-5">
              <input name="employeeSection" id="employeeSection" type="text" class="form-control">
            </div>
          </div>
          <div class="form-group col-md-12">
            <label class="col-md-2">Unit</label>
            <div class="col-md-5">
              <input name="employeeUnit" id="employeeUnit" type="text" class="form-control">
            </div>
          </div>
          <div class="form-group col-md-12">
            <label class="col-md-2">Judul Kaizen</label>
            <div class="col-md-5">
              <textarea name="kaizenTitle" id="kaizenTitle" cols="50" rows="4" class="form-control <?= form_error('kaizenTitle') ? 'is-invalid' : '' ?> " required></textarea>
          ...
          <div class="form-group col-md-12">
            ...
            <div class="col-md-3">
              <select name="slcKaizenCategory" id="slcKaizenCategory" class="form-control <?= form_error('slcKaizenCategory') ? 'is-invalid' : '' ?>" required>
