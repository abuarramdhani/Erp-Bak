  ...
  <div class="table-responsive">
    ...
    <table class="table" style="border: 1px solid #000; border-bottom: none; padding-bottom: 0; margin-bottom: 0;">
      <tbody>
        <tr>
          ...
          <td style="border-top: 1px solid #000; font-weight: bold;; border-right: 1px solid #000" width="33%"><?= $kaizen[0]['pencetus'] ?><div class="text-right">No. Induk: <?= $kaizen[0]['noinduk'] ?></div></td>
    ...
    <table class="table" style="border: 1px solid #000; padding-top: 0; margin-top: 0; margin-bottom: 0; border-bottom: 0px">
     ...
     <table class="table" style="border: 1px solid #000; padding-top: 0; margin-top: 0; margin-bottom: 0; border-bottom: 0px">
      <tbody>
        <?php
          $arrTitle = array('Pembuat','Atasan Langsung','Atasan dari Atasan Langsung','Atasan level Departemen','Direktur Utama');
