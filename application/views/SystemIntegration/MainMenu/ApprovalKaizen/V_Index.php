								...
								<tbody>
									...
									<tr>
										...
										<td class="text-left">
											...
											<table width="100%">
												<tr>
													...
													<td width="62%">
													&nbsp;&nbsp;<b class="fa fa-angle-double-right"></b> <?= $kaizen_item['level'] == 6 ? 'Approval Realisasi' : 'Approval Ide' ?> 
													</td>
												</tr>
											</table>
											<?php } ?>
										...
										<td class="text-center">
											...
											<span style="background-color: #f8f9fa" class="label btn-light btn-real-dis" >Laporkan <i class="fa fa-check-circle text-info"></i></span><br/>
											(<?= date('d M Y', strtotime($kaizen_item['status_date'])) ?>)
											<?php } else { ?>
