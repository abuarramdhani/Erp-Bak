<html>
    ...
    <body style="color: black">
        <div style='text-align: left'>
            ...
            ?>
            <h3 style="color: black;">Data Pekerja Keluar</h3>
                ...
                <thead class=" bg-primary">
                    <tr>
                        ...
                        if (in_array($pos['slcStatusPekerja2'], $staff)) { ?>
                            ...
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 6%">Noind</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 300px">Nama</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 15%">Seksi</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 10%">Tanggal Keluar</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 5%">IK</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 5%">IP</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 5%">IPT</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 5%">IF</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 5%">IMS</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 5%">IMM</th>
                            ...
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 5%">UM Cabang</th>
                        ...
                        <?php   
                            ...
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 5%">IP</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 5%">IF</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 5%">HTM</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 5%">UBT</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 5%">UPAMK</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 5%">IMS</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 15pt;width: 5%">IMM</th>
                ...
                <tbody>
                    <?php if (isset($data) && !empty($data)) {
                        ...
                        foreach ($data as $key) { 
                            if (in_array($pos['slcStatusPekerja2'], $staff)) { ?>
                                <tr>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$angka ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$key['noind'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: left;font-size: 15pt"><?=$key['nama_lengkap'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: left;font-size: 15pt"><?=$key['seksi'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?php $t = strtotime($key['tgl_keluar']); echo date('d M Y',$t); ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$key['ik'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$key['ip'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$key['ipt'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$key['if'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$key['ims'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$key['imm'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$key['lembur'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$key['um_puasa'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$key['um_cabang'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$key['ubt'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$key['upamk'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$key['sisa_cuti'] ?></td>
                                    ...
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$key['jml_duka'] ?></td>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=number_format($key['nom_duka']) ?></td>
                                </tr>
                        <?php }else{ ?>
                                <tr>
                                    <td style="color: black;padding: 3px;border: 1px solid black;text-align: center;font-size: 15pt"><?=$angka ?></td>
