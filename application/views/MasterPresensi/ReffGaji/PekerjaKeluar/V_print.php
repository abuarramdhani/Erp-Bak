                ...
                <thead class=" bg-primary">
                    <tr>
                        ...
                        if (in_array($pos['slcStatusPekerja2'], $staff)) { ?>
                            ...
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 14pt;width: 5%">LEM<br>BUR</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 14pt;width: 5%">UM Puasa</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 14pt;width: 5%">UM<br>Cab-<br>ang</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 14pt;width: 5%">UBT</th>
                            <th style="color: black;padding: 3px;text-align: center;border: 1px solid black;font-size: 14pt;width: 5%">UPA<br>MK</th>
