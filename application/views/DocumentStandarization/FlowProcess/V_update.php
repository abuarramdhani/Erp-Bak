<section class="content">
    <div class="inner" >
        <div class="row">
            <form method="post" action="<?php echo site_url('DocumentStandarization/FlowProcess/update/'.$id);?>" class="form-horizontal">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">Update Flow Process</div>
                                <?php
                                    foreach ($FlowProcess as $headerRow):
                                ?>
                                <div class="box-body">
                                    <div class="panel-body">
                                        <div class="row">
											<div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" placeholder="Fp Name" name="txtFpNameHeader" id="txtFpNameHeader" class="form-control" value="<?php echo $headerRow['fp_name']; ?>"/>
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" placeholder="Fp File" name="txtFpFileHeader" id="txtFpFileHeader" class="form-control" value="<?php echo $headerRow['fp_file']; ?>"/>
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <textarea name="txaFpInfoHeader" id="txaFpInfoHeader" class="form-control" placeholder="Fp Info"><?php echo $headerRow['fp_info']; ?></textarea>
                                                </div>
                                            </div>
