                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">Read Flow Process</div>
                                <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="table-responsive">
                                                    ...
                                                    <?php foreach ($FlowProcess as $headerRow): ?>
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Fp Name</strong></td>
                                                            <td style="border: 0">: <?php echo $headerRow['fp_name']; ?></td>
                                                        </tr>
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Fp File</strong></td>
                                                            <td style="border: 0">: <?php echo $headerRow['fp_file']; ?></td>
                                                        </tr>
														<tr>
														...
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Fp Info</strong></td>
                                                            <td style="border: 0">: <?php echo $headerRow['fp_info']; ?></td>
                                                        </tr>
														<tr>
