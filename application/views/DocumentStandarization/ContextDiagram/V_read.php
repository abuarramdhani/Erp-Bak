                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">Read Context Diagram</div>
                                <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="table-responsive">
                                                    ...
                                                    <?php foreach ($ContextDiagram as $headerRow): ?>
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Cd Name</strong></td>
                                                            <td style="border: 0">: <?php echo $headerRow['cd_name']; ?></td>
                                                        </tr>
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Cd File</strong></td>
                                                            <td style="border: 0">: <?php echo $headerRow['cd_file']; ?></td>
                                                        </tr>
														<tr>
														...
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Cd Info</strong></td>
                                                            <td style="border: 0">: <?php echo $headerRow['cd_info']; ?></td>
                                                        </tr>
														<tr>
