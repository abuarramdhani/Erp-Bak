                                            ...
                                            <div class="col-lg-12">
                                                <div class="table-responsive">
                                                    ...
                                                    <?php foreach ($ContextDiagram as $headerRow): ?>
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Nama Context Diagram</strong></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="border: 0">: <a class="btn btn-info" href="<?php echo base_url('assets/upload/PengembanganSistem/StandarisasiDokumen/').'/'.$headerRow['file'];?>" target="_blank"><?php echo $headerRow['file'];?></a>
                                                            </td>
