                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-1 ">
                                <div class="text-right hidden-md hidden-sm hidden-xs">
                                    <a class="btn btn-default btn-lg" href="<?php echo site_url('DocumentStandarization/DocumentHistory/');?>">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">Read Document History</div>
                                <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="table-responsive">
                                                    ...
                                                    <?php foreach ($DocumentHistoryDetail as $headerRow): ?>
                                                        <tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Jenis Dokumen</strong></td>
                                                            <td style="border: 0">: <?php echo $headerRow['jenis_dokumen']; ?></td>
                                                        <tr>
														...
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Nama Dokumen</strong></td>
                                                            <td style="border: 0">: <?php echo $headerRow['nama_dokumen']; ?></td>
                                                        </tr>
                                                        </tr>
														<tr>
														...
														<tr>
                                                            ...
                                                            <td style="border: 0"><?php echo $headerRow['catatan_revisi']; ?></td>
                                                        </tr>
                                                        <tr>
														...
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Waktu Input Revisi Baru</strong></td>
                                                            <td style="border: 0">: <?php echo $headerRow['waktu_input_revisi_baru']; ?></td>
                                                        </tr>
                                                        <tr>
