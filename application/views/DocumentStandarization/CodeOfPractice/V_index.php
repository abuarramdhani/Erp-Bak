                    ...
                    <div class="col-lg-12">
                        <div class="box box-primary box-solid">
                            <div class="box-header with-border">
                                <a href="<?php echo site_url('DocumentStandarization/COP/create/') ?>" style="float:right;margin-right:1%;margin-top:-0.5%;" alt="Add New" title="Add New" >
                                    <button type="button" class="btn btn-default btn-sm"><i class="icon-plus icon-2x"></i></button>
                                </a>
                            </div>
                            <div class="box-body">
                                <div>
                                    <table class="datatable table table-striped table-bordered table-hover text-left" id="dataTables-COP" style="font-size:12px; overflow-x: auto; width: 100%">
                                        <thead class="bg-primary">
                                            <tr>
												...
												<th class="hidden">Jumlah Halaman</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align='center'>
                                                	<a style="margin-right:4px" href="<?php echo base_url('DocumentStandarization/COP/read/'.$encrypted_string.''); ?>" data-toggle="tooltip" data-placement="bottom" title="Read Data"><span class="fa fa-list-alt fa-2x"></span></a>
												...
												<td style="white-space: nowrap;"><?php echo $row['nama_code_of_practice'] ?></td>
                                                ...
                                                <td class="hidden"><?php echo $row['jumlah_halaman'];?></td>
