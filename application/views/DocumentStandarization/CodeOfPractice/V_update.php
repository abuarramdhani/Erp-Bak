<section class="content">
    <div class="inner" >
        <div class="row">
            <form method="post" action="<?php echo site_url('DocumentStandarization/CodeOfPractice/update/'.$id);?>" class="form-horizontal" enctype="multipart/form-data">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">Update Code Of Practice</div>
                                <?php
                                    foreach ($CodeOfPractice as $headerRow):
                                ?>
                                <div class="box-body">
                                    <div class="panel-body">
                                        <div class="row">
											<div class="form-group">
                                                <label for="txtCopNameHeader" class="control-label col-lg-4">Cop Name</label>
                                                <div class="col-lg-4">
                                                    <input type="text" placeholder="Cop Name" name="txtCopNameHeader" id="txtCopNameHeader" class="form-control" value="<?php echo $headerRow['cop_name']; ?>"/>
                                                </div>
                                            </div>

											<div class="form-group">
                                                <label for="txtCopFileHeader" class="control-label col-lg-4">Cop File</label>
                                                <div class="col-lg-4">
                                                    <input type="text" placeholder="Cop File" name="txtCopFileHeader" id="txtCopFileHeader" class="form-control" value="<?php echo $headerRow['cop_file']; ?>"/>
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                <label for="txaCopInfoHeader" class="control-label col-lg-4">Cop Info</label>
                                                <div class="col-lg-4">
                                                    <textarea name="txaCopInfoHeader" id="txaCopInfoHeader" class="form-control" placeholder="Cop Info"><?php echo $headerRow['cop_info']; ?></textarea>
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                <label for="txtSopIdHeader" class="control-label col-lg-4">Sop Id</label>
                                                <div class="col-lg-4">
                                                    <input type="text" placeholder="Sop Id" name="txtSopIdHeader" id="txtSopIdHeader" class="form-control" value="<?php echo $headerRow['sop_id']; ?>"/>
                                                </div>
                                            </div>
