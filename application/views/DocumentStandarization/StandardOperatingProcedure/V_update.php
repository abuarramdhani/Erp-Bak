                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" name="txtSopNameHeader" id="txtSopNameHeader" class="form-control" value="<?php echo $headerRow['nama_sop'];?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" name="txtNoDocHeader" id="txtNoDocHeader" class="form-control" value="<?php echo $headerRow['nomor_dokumen'];?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" name="txtNoRevisiHeader" id="txtNoRevisiHeader" class="form-control" value="<?php echo $headerRow['nomor_revisi'];?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" maxlength="10" placeholder="<?php echo date('d-m-Y')?>" name="txtTanggalHeader" class="date form-control daterangepickersingledate" data-date-format="dd-mm-yyyy" id="txtTanggalHeader" value="<?php echo $headerRow['tanggal_revisi'];?>"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="number" min="0" name="txtJmlHalamanHeader" id="txtJmlHalamanHeader" class="form-control" value="<?php echo $headerRow['jumlah_halaman'];?>" />
                                                </div>
                                            </div>
