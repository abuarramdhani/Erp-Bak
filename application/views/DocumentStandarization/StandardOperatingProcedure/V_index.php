                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box box-primary box-solid">
                            ...
                            <div class="box-body">
                                <div>
                                    <table class="datatable table table-striped table-bordered table-hover text-left" id="dataTables-standardOperatingProcedure" style="font-size:12px; overflow-x: auto; width: 100%">
