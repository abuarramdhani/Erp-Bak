                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">Create Work Instruction</div>
                                <div class="box-body">
                                    <div class="panel-body">
                                        <div class="row">
											<div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" name="txtWiNameHeader" id="txtWiNameHeader" class="form-control bubbletip-character sensitive-input"  style="text-transform: uppercase" required="" />
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" maxlength="10" placeholder="<?php echo date('d-m-Y')?>" name="txtTanggalHeader" class="date form-control DocumentStandarization-daterangepickersingledate" data-date-format="yyyy-mm-dd" id="txtTanggalHeader" required="" data-inputmask="'alias': 'dd-mm-yyyy'" />
                                                </div>
                                            </div>
