                                    ...
                                    <div class="panel-body">
                                        <div class="row">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" maxlength="10" name="txtTanggalHeader" value="<?php echo $headerRow['tanggal_revisi'] ?>" class="DocumentStandarization-daterangepickersingledate form-control" data-date-format="yyyy-mm-dd" id="txtTanggalHeader" data-inputmask="'alias': 'dd-mm-yyyy'" />
