					...
					<form method="post" action="<?php echo base_url('ADMPelatihan/Report/AddReport')?>">
						...
						<div class="col-lg-12">
				          <div class="form-group">
				            ...
				            <textarea class="textarea" name="txtdeskripsi" id="txtdeskripsi" placeholder="Masukkan deskripsi kegiatan..." style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px; table-layout: auto;"></textarea>
				          </div>
				        </div>
						<div class="col-lg-12">
				          <div class="form-group">
