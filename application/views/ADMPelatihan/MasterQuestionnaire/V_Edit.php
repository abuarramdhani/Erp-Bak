													 ...
													 <!-- <form method="post" action="<?php echo base_url('ADMPelatihan/MasterQuestionnaire/Add')?>"> -->
														...
														<tbody id="tbodyQuestionnaireSegment">
															...
															<tr class="clone" row-id="<?php echo $no; ?>">
																<td ><?php echo $no; ?></td>
																<td>
																	<input id="segment" name="txtSegment[]" class="form-control segment" value="<?php echo $sg['segment_description']?>" onkeyup="insertKuesAjax(event, this)" data-id="<?php echo $sg['segment_id'] ?>" data-toggle="tooltip" data-placement="top">
