...
<section class="content">
    <div class="inner">
        <div class="row">
            <div class="col-lg-12">
                <div class="col-lg-11 text-right"><h1>Edit Database QTW</h1></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="col-lg-3" style="margin-left: -2px;">
                                    <input type="text" class="form-control" value="<?= $data[0]['jenis_institusi'] == '1'? 'SMA / SMK / MA': ($data[0]['jenis_institusi'] == '2') ? 'Universitas' : 'Lain - lain';?>" readonly>
                                </div>
