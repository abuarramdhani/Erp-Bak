									...
									<table class="table table-sm table-bordered table-hover text-center" style="table-layout: fixed;">
										...
										<tbody>
											...
											<tr>
												...
												<td><input type="radio" class="radio2" name="<?php echo 'txtInput'.$st['statement_id'] ?>" value="4" <?php echo $check4; ?>></td>
												<td><input type="radio" class="radio2" name="<?php echo 'txtInput'.$st['statement_id'] ?>" value="3" <?php echo $check3; ?>></td>
												<td><input type="radio" class="radio2" name="<?php echo 'txtInput'.$st['statement_id'] ?>" value="2" <?php echo $check2; ?>></td>
												<td><input type="radio" class="radio2" name="<?php echo 'txtInput'.$st['statement_id'] ?>" value="1" <?php echo $check1; ?>></td>
											</tr>
											<?php 	}
												}
												?>
