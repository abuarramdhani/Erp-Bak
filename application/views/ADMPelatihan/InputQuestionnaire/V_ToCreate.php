						...
						<div class="col-md-offset-3 col-md-6">
							<div class="table-responsive" style="overflow:hidden;">
								<table class="table table-striped table-bordered table-hover text-left" id="dataTables-customer" style="font-size:14px;">
									...
									<tbody>
										<?php $no=0; foreach($questionnaire as $qe){ $no++ ?>
										<tr>
											<td align="center"><?php echo $no ?></td>
											<td><?php echo $qe['questionnaire_title']?></td>
											<td width="10%" align="center">
												<?php if($qe['submitted']<$tr['participant_number']){?>
												<a data-toogle="tooltip" title="input new" href="<?php echo site_url('ADMPelatihan/InputQuestionnaire/Create/'.$trainingid.'/'.$qe['questionnaire_id']);?>" class="btn btn-flat btn-sm btn-success"><i class="fa fa-plus"></i></a>
												<?php }else{ ?>
												<button class="btn btn-flat btn-sm btn-success" disabled><i class="fa fa-plus"></i></button>
												<?php } ?>
											</td>
											<td align="center"><?php echo $qe['submitted']?></td>
										</tr>
										<?php } ?>
									</tbody>
								</table>
