...
<head>
<title>CustomerDriver Search</title>
...
<thead style="background:#f5f5f5;" style="padding:3px;">
	...
	<th align="center" style="padding:3px;">CustomerDriver Name</th>
</thead>
<?php
$num = 0;
...
$num++;
?>
<tr class="option" onClick="sendCustomerDriver('<?php echo $CustomerDriver_item['customer_id']; ?>', '<?php echo $CustomerDriver_item['customer_name']; ?>', '<?php echo $CustomerDriver_item['customer_category_id']; ?>')" style="padding:3px;">
<td align="center" width="18%" style="border-right:1px solid #333;border-collapse:collapse;padding:3px;"><?php echo $num ?></td>
<td align="left" width="82%" style="padding:3px;"><?php echo $CustomerDriver_item['customer_name'] ?></td>
</tr>
<?php endforeach ?>
</table>
</body>
