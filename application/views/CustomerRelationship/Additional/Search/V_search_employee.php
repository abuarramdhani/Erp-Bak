...
$num++;
?>
<tr class="option" onClick="sendEmployee('<?php echo $Employee_item['employee_id']; ?>', '<?php echo $Employee_item['employee_num']; ?>', '<?php echo $Employee_item['name']; ?>', '<?php echo $rowid; ?>')" style="padding:3px;">
