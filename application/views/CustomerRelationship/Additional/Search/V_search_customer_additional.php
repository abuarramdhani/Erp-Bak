...
<head>
<title>Customer Additional Information Search</title>
...
<thead style="background:#f5f5f5;" style="padding:3px;">
	...
	<th align="center" style="padding:3px;">Additional Name</th>
</thead>
<?php
$num = 0;
...
$num++;
?>
<tr class="option" onClick="sendCustomerAdditional('<?php echo $CustomerAdditional_item['additional_id']; ?>', '<?php echo $CustomerAdditional_item['additional_name']; ?>', '<?php echo $CustomerAdditional_item['additional_description']; ?>')" style="padding:3px;">
<td align="center" width="5%" style="border-right:1px solid #333;border-collapse:collapse;padding:3px;"><?php echo $num ?></td>
<td align="left" width="95%" style="padding:3px;"><?php echo $CustomerAdditional_item['additional_name'] ?></td>
</tr>
<?php endforeach ?>
</table>
</body>
