...
$num++;
?>
<tr class="option" onClick="sendItemSparePart('<?php echo $Item_item['item_id']; ?>', '<?php echo $Item_item['segment1']; ?>', '<?php echo $Item_item['item_name']; ?>',<?php echo $rowid ?>)" style="padding:3px;">
