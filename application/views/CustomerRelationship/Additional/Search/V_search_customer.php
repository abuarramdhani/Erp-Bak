...
$num++;
?>
<tr class="option" onClick="sendCustomer('<?php echo $Customer_item['customer_id']; ?>', '<?php echo $Customer_item['customer_name']; ?>', '<?php echo $Customer_item['customer_category_id']; ?>')" style="padding:3px;">
