...
<head>
<title>Customer Group Search</title>
...
<thead style="background:#f5f5f5;" style="padding:3px;">
	...
	<th align="center" style="padding:3px;">Customer Group Name</th>
</thead>
<?php
$num = 0;
...
$num++;
?>
<tr class="option" onClick="sendCustomerGroup('<?php echo $CustomerGroup_item['customer_group_id']; ?>', '<?php echo $CustomerGroup_item['customer_group_name']; ?>', '')" style="padding:3px;">
<td align="center" width="5%" style="border-right:1px solid #333;border-collapse:collapse;padding:3px;"><?php echo $num ?></td>
<td align="left" width="95%" style="padding:3px;"><?php echo $CustomerGroup_item['customer_group_name'] ?></td>
</tr>
<?php endforeach ?>
</table>
</body>
