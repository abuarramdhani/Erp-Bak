...
<table class="table table-bordered table-hover" id="example1">
		...
		<tbody>
			<?php
			$num = 1;
			foreach($CustomerNoGroup as $cs){
			?>
			<tr onclick="sendValueCustomerNoGroup('<?php echo $cs['customer_id'];?>','<?php echo $cs['customer_name'];?>','<?php echo $cs['customer_category_id'];?>')" data-dismiss="modal" style="cursor:hand;">
