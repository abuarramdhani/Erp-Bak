...
<table class="table table-bordered table-hover" id="example1">
		...
		<tbody>
			<?php 
			$num = 1;
			foreach($Driver as $cs){
			?>
			<tr onclick="sendValueDriver('<?php echo $cs['customer_id'];?>','<?php echo $cs['customer_name'];?>','<?php echo $cs['customer_category_id'];?>')" data-dismiss="modal" style="cursor:hand;">
