<head>
	...
	function getData(base){
		...
		if(id == ''){
			...
			$.post(base+"ajax/ResultDriver", {id:id}, function(data){
				$("#result").html(data);	
			});
...
<div style="background:#FFF;width:900px;margin-left:auto;margin-right:auto;margin-top: 5%;">
 <div class="modal-header" >
	...
	<h4 class="modal-title" id="H1">Driver Search</h4>
</div>
<div class="modal-body">
	...
	<table class="table">
		<tr>
			...
			<td width="95%" style="border:none;"> <input type="text" class="form-control" name="search" id="search" value="%" placeholder="Search driver name here" autofocus/></td>
			<!--
