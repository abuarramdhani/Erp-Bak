				...
				<div class="col-lg-12">
					<div class="col-lg-11">
						<div class="text-right">
							<h1><b> Report Rekap Penjualan Unit </b></h1>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="box box-primary box-solid">
						...
						<form class="form-horizontal" method="post" action="<?php echo site_url('CustomerRelationship/Report/ExportReportRekapPenjualanUnit');?>">
						<div class="panel-body">
							<div class="col-lg-11">
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<select class="form-control province-data" multiple name="txtArea[]" data-placeholder="All Area" style="width:100%;">
											<option value=""></option>
