				...
				<div class="col-lg-12">
					<div class="col-lg-11">
						<div class="text-right">
							<h1><b> Report Data Service Keliling </b></h1>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="box box-primary box-solid">
						...
						<form class="form-horizontal" method="post" action="<?php echo site_url('CustomerRelationship/Report/ExportReportDataServiceKeliling');?>">
