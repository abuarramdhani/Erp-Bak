				...
				<div class="col-lg-12">
					<div class="col-lg-11">
						<div class="text-right">
							<h1><b> Report Data Customer Visit </b></h1>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="box box-primary box-solid">
						...
						<form class="form-horizontal" method="post" action="<?php echo site_url('CustomerRelationship/Report/ExportReportDataCustomerVisit');?>">
						<div class="panel-body">
							<div class="col-lg-10">
								...
								<div class="form-group">
									<label for="norm" class="control-label col-lg-4" name="lblArea">Area</label>
									<div class="col-lg-8">
										<select class="form-control city-data" name="txtArea[]" multiple data-placeholder="All City / Regency" style="width:100%;">
											<option value=""></option>
