...
<div class="modal fade" id="firman<?php echo $h['HEADER_ID']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    	...
    	<div class="modal-content">
            ...
            <div class="row">
      		...
      		<div class="modal-footer">
        		...
        		<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#approve<?php echo $h['HEADER_ID']; ?>">APPROVE</button>
        		<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#reject<?php echo $h['HEADER_ID']; ?>">REJECT</button>
      		</div>
    	</div>
  	</div>
</div>
