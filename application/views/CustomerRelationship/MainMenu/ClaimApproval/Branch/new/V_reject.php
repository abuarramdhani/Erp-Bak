...
<div class="modal fade" id="reject<?php echo $h['HEADER_ID']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">REJECTED CLAIM</h4>
      </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <textarea row="3" type="text" class="form-control" name="note" placeholder="Reason Claim Rejected" data-toggle="tooltip" data-placement="top" title="Alasan Klaim ditolak" required></textarea>
              </div>
            </div>
          </div>
        </div>
