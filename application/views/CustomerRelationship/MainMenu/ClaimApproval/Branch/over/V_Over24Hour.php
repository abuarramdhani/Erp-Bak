<section id="showNewClaims">
	...
	<div style="padding-top: 10px">
		...
		<div class="box-body">
			<table id="tbOverClaim" class="table table-striped table-bordered table-responsive table-hover">
				...
				<tbody>
					<?php $no=1; foreach ($header as $h) { ?>
						<tr>
							...
							<td class="col-md-2"><?php echo $h['HEADER_ID']; ?></td>
							<td class="col-md-2"><?php echo $h['PARTY_NAME']; ?></td>
							<td class="col-md-2"><?php echo $h['OWNER_NAME']; ?></td>
