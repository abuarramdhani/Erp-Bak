<section id="showNewClaims">
	...
	<div style="padding-top: 10px">
		<div class="box-header with-border">
			<h3 style="text-align:center;"><strong>Closed Claims Data</strong></h3>
		...
		<div class="box-body">
			<table id="tbClosedClaim" class="table table-striped table-bordered table-responsive table-hover">
