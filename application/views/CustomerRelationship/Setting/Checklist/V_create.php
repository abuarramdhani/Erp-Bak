<section class="content">
	...
	<div class="row">
		...
		?>
		<form method="post" action="<?php echo site_url('CustomerRelationship/Setting/Checklist/Create/')?>" class="form-horizontal">
					...
					<div class="box-body">
						<div class="panel-body">
								<div class="form-group">
										...
										<div class="col-lg-8">
											<input type="text" placeholder="Sequence" name="txtNumber" class="form-control toupper" value="<?php echo ($Checklist_item['no_urut_checklist']) + 1 ?>" />
										</div>
								</div>
								<div class="form-group">
