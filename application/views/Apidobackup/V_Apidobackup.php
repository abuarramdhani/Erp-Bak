                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive text-nowrap">
                                <table class=" table table-striped table-bordered table-hover datatable-ADB"
                                    style="width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center><?= $value['DO_SPB'] ?></center>
                                            </td>
                                            <td>
                                                <center><?= $value['CREATED_DATE'] ?></center>
                                            </td>
