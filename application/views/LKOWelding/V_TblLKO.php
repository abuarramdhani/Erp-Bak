    ...
    <table class="table table-bordered" id="tbl_hasil_lko" style="font-size: 9pt">
        <thead class="bg-teal">
            <tr>
                ...
                <th class="text-center" rowspan="2" style="vertical-align: middle;font-size: 8pt">TANGGAL</th>
        ...
        <tbody>
            ...
            foreach ($lko as $key => $lk) { ?>
                <tr>
                    ...
                    <td class="text-center"><?= $lk['TANGGAL'] ?></td>
                    ...
                    <td class="text-center"><a class="btn btn-warning btn-xs" onclick="modalEdit(<?= $lk['LKO_ID'] ?>)" title="Edit"><i class="fa fa-pencil"></i></a> <a class="btn btn-danger btn-xs" onclick="DeleteLKO(<?= $lk['LKO_ID'] ?>)" title="Delete"><i class="fa fa-remove"></i></a></td>
                </tr>
            <?php $no++;
            } ?>
        </tbody>
