<?php foreach ($lko as $laporan) { ?>
    <table style="width:100%;font-family:Calibri;margin-top:10px">
        <tr>
            <td style="font-size:7pt;text-align : left"><strong>HARI / TGL : <?= $laporan['HARI'] ?> / <?= $laporan['TANGGAL'] ?></strong></td>
            <td style="font-size:7pt;text-align : left"><strong>SHIFT : <?= $laporan['SHIFT'] ?></strong></td>
    ...
    <table style="border: 1px solid black; border-collapse:collapse;width:100%;font-family:Calibri">
        <tr>
            ...
            <th style="border: 1px solid black; border-collapse:collapse;font-size:7pt;width:30%" rowspan="2">NAMA PEKERJA</th>
            <th style="font-size:7pt;width:20%" rowspan="2">URAIAN PEKERJAAN</th>
        ...
        <?php $n = 1;
        foreach ($laporan['LAPORAN'] as $lko) { ?>
            <tr>
