			...
			<div class="col-lg-12">
				<div class="row">
					<div class="col-lg-12">
						<div class="col-lg-11">
							<div class="text-left">
								<span><h2><b>Laporan Data Asset Non Oracle  - </b>Approved</h2></span>
							...
							<div class="box-body">
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover text-center" id="tblACLDAO" style="font-size:14px;">
										<thead>
											<tr style="background-color: #00a65a;" class="bg-primary">
												<th width="5%"><center>No</center></th>
												<th width="15%"><center>Judul Proposal</center></th>
												<th width="15%"><center>Approved Date</center></th>
										...
										<tbody>
											<?php $i=1; foreach ($approved as $k) {?>
												<tr>
													...
													<?php }?>
													<td>
														<a href="<?php echo base_url('AssetCabangMarketing/downloadMkt/'.$k['pdf_title_mkt'])?>">
														<button type="button" class="btn btn-warning btn-xs" style="width:100px;" id="btnDownloadPPA"><i class="fa fa-download"></i> Download</button>
														</a>

														<a target="_blank" href="<?php echo base_url('./assets/upload/AssetCabang/Marketing').'/'.$k['pdf_title_mkt']?>">
														<button type="button" class="btn btn-primary btn-xs" style="width:100px;margin-top: 5px;margin-bottom: 5px" id="btnDeleteDraft"><i class="fa fa-check"></i> View File</button>
														</a>
