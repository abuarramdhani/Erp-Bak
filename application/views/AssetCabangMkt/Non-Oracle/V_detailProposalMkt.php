...
.inputfile + label {
  ...
  <?php echo form_open_multipart('AssetCabangMarketing/ApproveReject/'.$header[0]['id_proposal']) ?>
    <section class="content-header">
      <h1>
        Detail Proposal <b><?php echo $header[0]['batch_number']?></b>
        <input type="hidden" name="judulProposalNm" id="judulproposalhdn" value="<?php echo $header[0]['batch_number'].'.pdf'?>"/>

        <input type="hidden" name="batch_number" id="Txt_batch_number" value="<?php echo $header[0]['batch_number']?>"/>

        <!-- <input type="hidden" name="judulProposaljpg" id="judulproposaljpg" value="<?php echo $header[0]['batch_number'].'.jpg'?>"/> -->
      </h1>
    </section>
    <!-- Main content -->
...
<section class="content">
  	<div class="row">
    	<div class="col-md-12">
      	<div class="box itsfun1">
	   		<div class="box-header with-border" style="text-align: left;">
                	...
                	<b>Approve/Reject by Marketing</b><br>
              	</h3><br>
            </div>
         <div class="box-body">
					<!----- Tabel ----->
        ...
        <div class="col-md-4">
          ...
          <input style="display: none;" type="file" name="txfPdfAC" id="file-1" class="inputfile inputfile-1" />
            ...
            <div class="box-body">
               ...
               <div class="col-md-6 pull-right">
                    ...
                    <button data-toggle="tooltip" data-placement="top" title="Proses approve hanya akan diizinkan jika sudah mengupload dokumen approval" id="btnApprove" value="4" name="btnApproveAC" id="btnSubmitAC" disabled type="submit" class="zoom btn btn-success btn-m pull-right" style="margin-top: 10px; margin-bottom: 20px;margin-left: 20px;width: 100px"><i class="fa fa-check"></i> Approve</button>
             </form>
                    <button data-toggle="tooltip" data-placement="top" title="Harap cek kembali, proses yang sudah dilakukan tidak bisa diedit kembali" id="btnReject" value="5" name="btnRejectAC" type="button" onclick="getRejected(<?php echo $header[0]['id_proposal'];?>)" class="zoom btn btn-danger btn-m pull-right" style="margin-top: 10px; margin-bottom: 20px;margin-left: 20px;width: 100px"><i class="fa fa-times"></i> Reject</button>
...
// console.log(string)
var stringA = $('#Txt_batch_number').val();
var jpg = stringA+'.jpg';
console.log(jpg)
var stringB = $('#Txt_batch_number').val();
var png = stringB+'.png';
console.log(png)

      if($("#file-1").val() != "") {

          if (string2 == string || string2 == jpg || string2 == png) {
             Swal.fire({
              type: 'success',
