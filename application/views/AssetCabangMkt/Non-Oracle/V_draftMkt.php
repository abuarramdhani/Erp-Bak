										...
										<tbody>
											<?php $i=1; foreach ($draft as $k) {?>
												<tr>
													...
													<?php if ($k['status'] == '2') { ?>
													<td>
													<span><label class="label label-default"><i class="fa fa-paper-plane"></i>&nbsp;Sent to Marketing</span>
													</td>
													<?php } ?>
													...
													<?php }?>
													<td>
													<a href="<?php echo base_url('AssetCabangMarketing/Detail/'.$k['id_proposal'])?>">
													<button type="button" class="btn btn-success btn-xs" style="width:100px;" id="btnDetail"><i class="fa fa-pencil"></i> Detail</button>
													</a>

													<a target="_blank" href="<?php echo base_url('./assets/upload/AssetCabang/KepalaCabang').'/'.$k['pdf_title_cbg']?>">
													<button type="button" class="btn btn-primary btn-xs" style="width:100px;margin-top: 5px;margin-bottom: 5px" id="btnDeleteDraft"><i class="fa fa-check"></i> View Pdf</button></a>

													<a href="<?php echo base_url('AssetCabangMarketing/download/'.$k['pdf_title_cbg'])?>">
