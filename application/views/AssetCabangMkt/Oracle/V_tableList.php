								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover text-left" id="tblACLDAO" style="font-size:12px;">
										...
										<tr>
											...
											<td><?php echo $k['ATTRIBUTE_CATEGORY_CODE']?></td>
											<!-- <td><?php echo $k['ASSET_NUMBER']?></td> -->
											<td><?php echo $k['DESCRIPTION']?></td>
											<td><?php echo $k['TAG_NUMBER']?></td>
											<td><?php echo $k['DATE_PLACED_IN_SERVICE']?></td>
											<td><?php echo $k['INVOICE_NUMBER']?></td>
