				...
				<div class="row">
					<div class="col-lg-12">
						<div class="box box-primary box-solid">
							...
							<div class="box-body">
								<div class="col-lg-12">
									<form class="form-horizontal" method="post" action="<?php echo site_url('CateringManagement/TmpMakan/Edit/'.$encrypt); ?>">
										<div class="form-group">
											<label class="control-label col-lg-4">Tempat Makan</label>
											<div class="col-lg-4">
												<input type="text" name="txtTmpMakan" class="form-control" placeholder="Tempat Makan" value="<?php echo $fs_tempat_makan; ?>" required>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-lg-4">
												<select class="select select2" name="txtLetakTmpMakan" class="form-control" data-placeholder="Letak Tempat Makan" required style="width: 100%">
													<option value="<?php echo $fs_tempat; ?>"><?php echo $fs_letak; ?></option>
													<?php 
