					...
					<div class="col-md-6">
						<div class="box box-solid">
							...
							<div class="box-body">
								<div class="row">
									<div class="col-lg-12">
										<form class="form-horizontal" action="<?php echo base_url('CateringManagement/Setup/PekerjaMakanKhusus/ImportData') ?>" method="POST" enctype="multipart/form-data">
					...
					<div class="col-md-6">
						<div class="box box-solid">
							...
							<div class="box-body">
								<div class="row">
									<div class="col-lg-12">
										<form class="form-horizontal" action="<?php echo base_url('CateringManagement/Setup/PekerjaMakanKhusus/ExportData') ?>" method="POST">
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-lg-6">
													<select class="select2" style="width: 100%"  name="slc-CM-PekerjaMakanKhusus-Export-Status">
														<option>Semua</option>
														<option>Aktif</option>
											...
											<div class="form-group">
												...
												<div class="col-lg-6">
													<select class="select2" style="width: 100%"  name="slc-CM-PekerjaMakanKhusus-Export-Lokasi">
														<option>Semua</option>
