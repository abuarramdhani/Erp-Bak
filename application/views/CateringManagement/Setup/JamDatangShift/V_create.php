					...
					<div class="col-lg-12">
						<div class="box box-primary box-solid">
							...
							<div class="box-body">
								<div class="row">
									<div class="col-lg-12">
										<form class="form-horizontal" method="post" action="<?php echo site_url('CateringManagement/JamDatangShift/Create') ?>">
											<?php if(isset($alert)){ ?>
											...
											<div class="form-group">
												...
												<div class="col-lg-4">
													<select class="select select2" name="txtShiftJamDatang" data-placeholder="Pilih Shift" style="width: 100%" required>
														<option></option>
											...
											<div class="form-group">
												...
												<div class="col-lg-4">
													<div class="col-lg-12 input-group bootstrap-timepicker timepicker">
														<input type="text" name="txtAwalJamDatang" id="txtAwalJamDatang" class="form-control" placeholder="Jam Awal Absen" required>
											...
											<div class="form-group">
												...
												<div class="col-lg-4">
													<div class="col-lg-12 input-group bootstrap-timepicker timepicker">
														<input type="text" name="txtAkhirJamDatang" id="txtAkhirJamDatang" class="form-control" placeholder="Jam Akhir Absen" required>
														<span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
													</div>
												</div>
											</div>
