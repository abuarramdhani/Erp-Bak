										...
										<div class="table-responsive" >
											<table class="table table-sm table-bordered table-hover text-center" style="table-layout: fixed;" name="tblFineCatering" id="tblFineCatering">
												...
												<tbody id="tbodyFineCatering">
													...
													<tr class="clone">
														<td>
															<input id="finedate" name="TxtFineDate[]" class="form-control finedate cmsingledate" placeholder="Fine Date" value="<?php echo date('d/m/Y', strtotime($rf['receipt_fine_date']))?>">
														</td>
