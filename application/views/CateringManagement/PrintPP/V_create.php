<section class="content">
    <div class="inner" >
        <div class="row">
            <form method="post" action="<?php echo site_url('CateringManagement/PrintPP/create');?>" class="form-horizontal">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                            ...
                            <div class="col-lg-1 ">
                                <div class="text-right hidden-md hidden-sm hidden-xs">
                                    <a class="btn btn-default btn-lg" href="<?php echo site_url('CateringManagement/PrintPP/');?>">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-4">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" maxlength="10" placeholder="<?php echo date('d M Y')?>" name="txtTglBuatHeader" class="pp-date date form-control" data-date-format="yyyy-mm-dd" id="txtTglBuatHeader" style="width:100%" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" maxlength="10" placeholder="<?php echo date('d M Y')?>" name="txtPpTglKadeptHeader" class="pp-date date form-control" data-date-format="yyyy-mm-dd" id="txtPpTglKadeptHeader" style="width:100%"/>
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" maxlength="10" placeholder="<?php echo date('d M Y')?>" name="txtPpTglKaunitHeader" class="pp-date date form-control" data-date-format="yyyy-mm-dd" id="txtPpTglKaunitHeader" style="width:100%"/>
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" maxlength="10" placeholder="<?php echo date('d M Y')?>" name="txtPpTglKasieHeader" class="pp-date date form-control" data-date-format="yyyy-mm-dd" id="txtPpTglKasieHeader" style="width:100%"/>
                                                </div>
                                            </div>
