		...
		<div class="col-lg-12">
			...
			<div class="row">
				...
				<div class="box box-primary box-solid">
					...
					<div class="box-body">
					<form method="post" action="<?php echo base_url('CateringManagement/ReceiptBatch/Add')?>">
						...
						<div class="row" style="margin: 10px 10px">
							<div class="form-group">
								...
								<div class="col-lg-6">
									<select class="form-control select2" id="ordertypeBatch" name="TxtOrderType" data-placeholder="Select Order Type" required style="width: 100%">
										<option></option>
						...
						<div class="row" style="margin: 10px 10px">
							<div class="form-group">
								...
								<div class="col-lg-6">
									<select class="form-control select2" id="cateringBatch" name="TxtCatering" data-placeholder="Select Catering" required style="width: 100%">
											<option></option>
						...
						<div class="row" style="margin: 10px 10px">
							<div class="form-group">
								...
								<div class="col-lg-6">
									<input type="text" name="TxtOrderDate" id="TxtOrderDateBatch" class="form-control cmdaterange" placeholder="Order Date" required >
								</div>
							</div>
						</div>
						...
						<div class="row" style="margin: 10px 10px">
							<div class="form-group">
								...
								<div class="col-lg-6">
									<select class="form-control select2" id="bonusBatch" name="TxtBonus" required style="width: 100%">
						...
						<div class="row" style="margin: 10px 10px">
							<div class="form-group">
								...
								<div class="col-lg-6">
									<input id="singlepriceBatch" name="TxtSinglePrice" class="form-control" onkeypress="return isNumberKey(event)" placeholder="Price per qty" required >
								</div>
							</div>
						</div>
						<div class="row" style="margin: 10px 10px">
										...
										<tbody>
											<tr>
												...
												<td class="text-center">
													<input type="text" name="txtDeptQty1" id="txtDeptQtyBatch1" class="form-control" required>
												</td>
											</tr>
											<tr>
												<td>Pemasaran</td>
												<td class="text-center">
													<input type="text" name="txtDeptQty2" id="txtDeptQtyBatch2" class="form-control" required>
												</td>
											</tr>
											<tr>
												<td>Produksi</td>
												<td class="text-center">
													<input type="text" name="txtDeptQty3" id="txtDeptQtyBatch3" class="form-control" required>
												</td>
											</tr>
											<tr>
												<td>Personalia</td>
												<td class="text-center">
													<input type="text" name="txtDeptQty4" id="txtDeptQtyBatch4" class="form-control" required>
												</td>
											</tr>
											<tr>
												<td>Total Order Qty</td>
												<td class="text-center">
													<input id="orderqtyBatch" name="TxtOrderQty" class="form-control" onkeypress="return isNumberKey(event)" placeholder="Order Qty" readonly value="0" required >
												</td>
											</tr>
										</tbody>
									</table>
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading text-right">
										<a href="javascript:void(0);" class="btn btn-sm btn-primary" id="AddFineBatch" title="Tambah Baris" onclick="AddFineBatch('<?php echo base_url(); ?>')"><i class="fa fa-plus"></i></a>
										<a href="javascript:void(0);" class="btn btn-sm btn-danger" id="DelFineBatch" title="Hapus Baris" onclick="deleteRowBatch('tblFineCateringBatch')"><i class="fa fa-remove"></i></a>
										...
										<div class="table-responsive" >
											<table class="table table-sm table-bordered table-hover text-center" style="table-layout: fixed;" name="tblFineCatering" id="tblFineCateringBatch">
												...
												<tbody id="tbodyFineCateringBatch">
													<tr class="clone">
														<td><input type="text" id="finedateBatch" name="TxtFineDate[]" class="form-control cmsingledate" placeholder="Fine Date"></td>
						...
						<div class="row" style="margin: 10px 10px">
							<div class="form-group">
								...
								<div class="col-lg-3">
									<input id="fineBatch" name="TxtFine" class="form-control" onChange="countPPH()" onkeypress="return isNumberKey(event)" placeholder="Fine" value="0" readonly>
								</div>								
							</div>
						</div>
						<!-- INPUT GROUP 3 ROW 2 -->
						<div class="row" style="margin: 10px 10px">
							<div class="form-group">
								...
								<div class="col-lg-3">
									<input id="pphBatch" name="TxtPPH" class="form-control" onkeypress="return isNumberKey(event)" placeholder="PPH" readonly>
								</div>
							</div>
						</div>
						<!-- INPUT GROUP 3 ROW 3 -->
						...
						<div class="form-group">
							<div class="col-lg-8 text-right">
								<a href="<?php echo site_url('CateringManagement/ReceiptBatch');?>"  class="btn btn-success btn-lg btn-rect">Back</a>
								&nbsp;&nbsp;
