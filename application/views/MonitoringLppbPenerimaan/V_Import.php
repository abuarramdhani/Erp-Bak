                            ...
                            <div class="col-lg-1 ">
                                <div class="text-right hidden-md hidden-sm hidden-xs">
                                    <a class="btn btn-default btn-lg"
                                        href="<?php echo site_url('MonitoringLppbPenerimaan/Import/');?>">
                            ...
                            <div class="box box-primary box-solid">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <center><button class="btn btn-primary" onclick="getMLPA(this)"><i class="fa fa-search"></i> Find </button></center>
