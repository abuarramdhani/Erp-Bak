								...
								<div class="box-body">
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-lg-4">
												<input type="text" class="form-control" style="text-transform: uppercase; width: 100%" name="txtJenisUndangan" value="<?php echo $format_undangan['judul'];?>">
											</div>
										</div>
										<div class="form-group">
											<label for="txaFormatUndangan" class="control-label col-lg-2">Format Undangan</label>
											<div class="col-lg-8">
												<textarea name="txaFormatUndangan" style="width: 100%" id="MonitoringOJT-Undangan-txaFormatUndangan" class="form-control"><?php echo $format_undangan['undangan'];?></textarea>
											</div>
										</div>
									</div>
