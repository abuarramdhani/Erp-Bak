<section class="content">
	<div class="inner">
		<div class="row">
			<form class="form-horizontal" method="post" action="<?php echo base_url('OnJobTraining/LembarEvaluasi/saveEvaluasi');?>" enctype="multipart/form-data" id="MonitoringOJT-frmCetakUndangan">
				<div class="col-lg-12">
					<div class="row">
						<div class="col-lg-12">
							<div class="col-lg-11">
										...
										<div class="row">
											<div class="col-xs-3">
												<div class="form-group">
													...
													<div class="col-lg-6">
														<input type="number" class="form-control" name="numBatasTepiAtas" id="MonitoringOJT-numBatasTepiAtas" value="12.70" min="0" step="0.01" style="width: 100%" />
													</div>
												</div>
											</div>
											<div class="col-xs-3">
												<div class="form-group">
													...
													<div class="col-lg-6">
														<input type="number" class="form-control" name="numBatasTepiBawah" id="MonitoringOJT-numBatasTepiBawah" value="15.24" min="0" step="0.01" style="width: 100%" />
													</div>
												</div>
											</div>
											<div class="col-xs-3">
