<section class="content">
	<div class="inner">
		<div class="row">
			<form class="form-horizontal" method="post" action="<?php echo base_url('OnJobTraining/LembarEvaluasi/submitUpEvaluasi/'.$id);?>" enctype="multipart/form-data" id="MonitoringOJT-frmCetakUndangan">
				<div class="col-lg-12">
					<div class="row">
						<div class="col-lg-12">
							<div class="col-lg-11">
							...
							<div class="box box-primary box-solid">
								...
								<div class="box-body">
									<div class="panel-body">
										...
										<div class="form-group">
											<button type="button" class="btn btn-primary col-lg-2" id="MonitoringOJT-btnPratinjauEvaluasi">
												Pratinjau
											</button>
											<div class="col-lg-8">
										...
										<div class="row">
											<div class="col-xs-3">
												<div class="form-group">
													<label for="MonitoringOJT-numBatasTepiAtas" class="control-label col-lg-4">Tepi Atas (satuan mm)</label>
													<div class="col-lg-6">
											...
											<div class="col-xs-3">
												<div class="form-group">
													<label for="MonitoringOJT-numBatasTepiBawah" class="control-label col-lg-4">Tepi Bawah (satuan mm)</label>
													<div class="col-lg-6">
											...
											<div class="col-xs-3">
												<div class="form-group">
													<label for="MonitoringOJT-numBatasTepiKiri" class="control-label col-lg-4">Tepi Kiri (satuan mm)</label>
													<div class="col-lg-6">
											...
											<div class="col-xs-3">
												<div class="form-group">
													<label for="MonitoringOJT-numBatasTepiKanan" class="control-label col-lg-4">Tepi Kanan (satuan mm)</label>
													<div class="col-lg-6">
									...
									<div class="panel-footer">
										<div class="row text-right">
                                            <a href="<?php echo base_url('OnJobTraining/LembarEvaluasi');?>" class="btn btn-primary btn-lg btn-rect">Back</a>
                                            &nbsp;&nbsp;
