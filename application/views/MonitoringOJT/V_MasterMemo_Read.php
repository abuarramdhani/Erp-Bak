                        ...
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Lihat Format Memo</h3>
                                </div>
                                <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="table-responsive">
                                                    ...
                                                    ?>
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Jenis Memo</strong></td>
                                                            <td style="border: 0">:</td>
                                                            <td style="border: 0"><?php echo $format_memo['judul']; ?></td>
                                                        </tr>
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Format</strong></td>
                                                            <td style="border: 0">:</td>
                                                            <td style="border: 0"><?php echo $format_memo['memo']; ?></td>
                                                        </tr>
														<tr>
													<?php
                                                        }
