							...
							<div class="box-body">
								...
								<div class="tab-content">
									<div id="aktif" class="tab-pane fade in active">
										<table class="table table-bordered" id="MonitoringOJT-monitoringPekerjaAktif" style="width: 100%;">
											<thead>
												<tr>
									...
									<div id="selesai" class="tab-pane fade in">
										<table class="table table-bordered" id="MonitoringOJT-monitoringPekerjaSelesai" style="width: 100%;">
											<thead>
												<tr>
													<th style="white-space: nowrap; text-align: center;">No.</th>
													<th style="white-space: nowrap; text-align: center;">Action</th>
						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="form-group">
										<div class="col-lg-8">
											<select style="width: 100%" name="cmbDaftarPekerjaOJT" id="MonitoringOJT-cmbDaftarPekerjaOJT">
											</select>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<div class="col-lg-12">
											<label for="" class="col-lg-2 control-label">
												...
												<input type="button" class="btn btn-warning" id="MonitoringOJT-chkOrientasi-checkAll" value="Pilih Semua" /><br/>
												<input type="button" class="btn btn-danger" id="MonitoringOJT-chkOrientasi-uncheckAll" value="Kosongkan Semua" /><br/>
											</label>
											<div class="col-lg-10">
												<?php
													$indeks 			=	0;
													...
													<tr>
														...
														<td style="vertical-align: top;">
															<label for="MonitoringOJT-chkOrientasi[<?php echo $indeks;?>]">
																<input type="checkbox" name="chkOrientasi[]" class="MonitoringOJT-chkOrientasi" id="MonitoringOJT-chkOrientasi[<?php echo $indeks;?>]" value="<?php echo $id_orientasi_encode;?>" />
