...
<table class="table table-hover table-bordered table-striped">
	<thead class="bg-primary">
		<tr>
			...
			<th width="40%" style="padding: 3px 3px;"><center>Kode Pekerjaan</center></th>
	...
	<tbody>
		...
		<tr>
			...
			<td style="padding: 3px 3px;"><?php echo $SetupKebutuhan['pekerjaan'] ?></td>
			<td style="padding: 3px 3px;"><?php echo $SetupKebutuhan['kode_standar'] ?></td>
		</tr>
		<?php 
			$no++;
		} ?>
