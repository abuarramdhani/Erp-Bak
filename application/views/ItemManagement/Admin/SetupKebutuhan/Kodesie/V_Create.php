...
<section class="content">
	<form method="post" action="<?php echo base_url('ItemManagement/SetupKebutuhan/Kodesie/insert') ?>">
		<div class="row">
			<div class="col-lg-12">	
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="row" style="margin: 10px 10px">
							...
							<div class="col-lg-8">
								<input type="text" class="form-control im-datepicker periode-selesai" style="width: 100%" placeholder="PERIODE" name="txt_periode[]" value="999912" required></input>
							</div>
						</div>
						<div class="row" style="margin: 10px 10px">
							<label class="col-lg-4 control-label">JUMLAH</label>
							<div class="col-lg-8">
								<input type="number" class="form-control" style="width: 100%" placeholder="JUMLAH" name="txt_jumlah[]" value="" max="" required></input>
							</div>
						</div>
					</div>
				</div>
