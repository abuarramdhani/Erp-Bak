...
<section class="content">
	<form method="post" action="<?php echo base_url('ItemManagement/SetupKebutuhan/Kodesie/update') ?>">
		<div class="row">
			<div class="col-lg-12">	
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="row" style="margin: 10px 10px">
										...
										<div class="col-lg-4">
											<input type="text" class="form-control text-uppercase" style="width: 100%" placeholder="KODE STANDAR" name="txt_kode_standar" value="<?php echo $update_group['kode_standar'] ?>" required></input>
											<input type="hidden" class="form-control text-uppercase" name="txt_kode_standar_old" value="<?php echo $update_group['kode_standar'] ?>" required></input>
										</div>
									</div>
									<div class="row" style="margin: 10px 10px">
									...
									<div class="row" style="margin: 10px 10px">
										...
										<div class="col-lg-4">
											<input type="hidden" class="form-control text-uppercase" name="txt_kdpekerjaan_old" value="<?php echo $update_group['kdpekerjaan'] ?>" required></input>
											<select id="slcKodePkj" name="txt_kdpekerjaan" class="form-control" data-placeholder="KODE PEKERJAAN" style="width: 100%;" required>
												<option></option>
												<option selected value="<?php echo $update_group['kdpekerjaan'] ?>"><?php echo $update_group['pekerjaan'] ?></option>
											</select>
										</div>
										<div class="col-lg-6">
