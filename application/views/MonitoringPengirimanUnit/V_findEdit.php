		...
		<div class="row">
			<div class="col-lg-12">
				<div class="row">
					<div class="col-lg-12">
						<div class="text-left ">
							<span><b>Shipment Unit No. <?php echo $header[0]['no_shipment'] ?></b></span>
						</div>
					</div>
				</div>
				<br />
											...
											<table id="filter"
												class="col-md-12" style="margin-bottom: 20px">
													<tr>
																...
																<td>
																	<input class="form-control time-form" style="width: 300px" type="text" id="estimasi_brkt" value="<?php echo $header[0]['berangkat'] ?>" name="estimasi_brkt"></input>
																</td>
																<td>
																	<span><label>Cabang Tujuan</label></span>
																</td>
																<td>
																	<select id="cabang" name="cabang" class="form-control select2" style="width:300px;">
															...
															<tr>
																...
																<td>
																	<input class="form-control time-form" style="width: 300px" type="text" id="estimasi_loading" name="estimasi_loading" value="<?php echo $header[0]['loading'] ?>"></input>
																</td>
																...
																<td>
																	<select id="fingo" name="fingo" class="form-control select2" style="width:300px;">
																<option value="" > Pilih </option>
															...
															<tr>
																...
																<td>
																	...
																	<td>
																	<select id="jk" name="jk" class="form-control select2" style="width:300px;">
																<option value="" > Pilih </option>
																...
																<td>
																	<select id="status" name="status" class="form-control select2" style="width: 300px">
																		<?php
																			$y = '';
																			$n = '';
...
<td class="text-center"><select name="content" class="form-control selectUnitMPM" style="width:100%;">
						<option value="" > Pilih </option>
								<?php foreach ($contentedit as $k) { 
									$s='';
...
<td class="text-center"><select name="unit" class="form-control selectUnitMPM" style="width:100%;">
						<option value="" > Pilih </option>
								<?php foreach ($unitedit as $k) { 
									$s='';
...
<td class="text-center"><button type="button" class="btnDeleteRowUnit btn btn-danger" onclick="myFunction()"><i class="glyphicon glyphicon-trash" disable ></i></button></td>
				...
				<?php $no++;} ?>
								...
								<div class="col-md-1 pull-right">
									<button  onclick="saveEditMPM(<?php echo $header[0]['no_shipment']; ?>)" class="btn btn-success pull-right" style="margin-top: 10px" ><i class="fa fa-check"></i> Save</button>
								</div>
								</div>
							</div>
						</div>
