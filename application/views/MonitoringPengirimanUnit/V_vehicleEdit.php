							...
							<div class="box-body">
								<div class="box box-primary box-solid">
									...
									<div class="col-md-12 pull-left">                          
										<button onclick="SaveEditVehicle(<?php echo $vehicle[0]['id']?>)" type="button" class="btn btn-success pull-left" style="margin-top: 10px; margin-bottom: 20px; margin-left: 20px;" > <i class="fa fa-edit"></i> Save </button>
									</div>
