    ...
    <table class="table table-striped table-bordered table-hover text-left " id="tblterimalppb" style="font-size:12px;">
        <thead>
            <tr class="bg-primary">
                ...
                <th style="width:5%" class="text-nowrap"><center>ID Kirim</center></th>
                <th style="width:5%" hidden><center>Line Num</center></th>
                <th style="width:5%" class="text-nowrap"><center>No Lppb</center></th>
                ...
                <th style="width:5%" class="text-nowrap"><center>NOT OK</center></th>
