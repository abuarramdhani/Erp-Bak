                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <?php if ($v['ACTIVE_FLAG'] == 'B') { ?>
                                                                    <button style="border-radius: 50px;" formtarget="_blank" formaction="<?php echo base_url('CARVP/ListData/createPDFCar/' . $v['CAR_NUM']); ?>" class="btn btn-default">View</button>
                                                                    <a style="border-radius: 50px;" class="btn btn-success" onclick="ReqApprCAR(<?= $i ?>)">Request Approve</a>
                                                                    <button style="border-radius: 50px;" formaction="<?php echo base_url('CARVP/ListData/EditCAR/' . $v['CAR_NUM']); ?>" class="btn btn-warning">Edit</button>
                                                                    <a style="border-radius: 50px;" class="btn btn-danger" onclick="deleteCAR(<?= $i ?>)">Delete</a>
