<table style="width: 100%;border:1px solid black;border-collapse:collapse;font-family:arial">
    ...
    <tr>
        <td rowspan="3" style="text-align: left;padding-left:7px;font-size:8pt;padding-top:0px">Jl. Magelang 144, Yogyakarta (55241), Indonesia<br>
            ...
            Fax: (0274) 563523 </td>
        <th style="border:1px solid black;border-collapse:collapse;font-size:9pt">CAR Number</th>
        <th style="border:1px solid black;border-collapse:collapse;font-size:9pt" colspan="2"><?= $car[0]['CAR_NUM'] ?></th>
    </tr>
    <tr>
        <th style="border:1px solid black;border-collapse:collapse;font-size:9pt">CAR Type</th>
        <th style="border:1px solid black;border-collapse:collapse;font-size:9pt" colspan="2"><?= $car[0]['CAR_TYPE'] ?></th>
    </tr>
    <tr>
        <th style="border:1px solid black;border-collapse:collapse;font-size:9pt">NC Scope</th>
        <th style="border:1px solid black;border-collapse:collapse;font-size:9pt" colspan="2"><?= $car[0]['NC_SCOPE'] ?></th>
    </tr>
</table>