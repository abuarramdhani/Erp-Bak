                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="box box-solid box-primary">
                            <div class="box-header with-border"><b><p style="font-size: 15px">--- Edit Surat Penyerahan ---</p></b></div>
                                <div class="box-body">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="col-lg-12"/>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-8">
                                                                        <input class="form-control" type="text" name="inpKodesie_SP" value="<?php echo $data[0]['kodesie'] ?>" readonly>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="box box-solid box-default">
                                                    <div class="box-header with-border"><b><p style="font-size: 15px">--- Hubungan Kerja ---</p></b></div>
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                    ...
                                                    <div class="box-header with-border" style=" margin-top: 23px"><b><p style="font-size: 15px">---  Seleksi ---</p></b></div>
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="col-lg-12">
                                                                <div class="form-group">
