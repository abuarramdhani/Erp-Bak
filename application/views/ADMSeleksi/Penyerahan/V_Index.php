                    ...
                    <div class="col-lg-12">
                        <div class="box box-primary">
                            <form class="form_submit_SP">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <select name="slc_pkj_SP" class="select select2 form-control" id="slc_pkj_SP">
                                                    ...
                                                    <option value="14">[C] Cabang Outsourcing</option>
                                                    ...
                                                    <option value="9">[K] Outsourcing</option>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <button type="button" name="button" class="btn btn-danger col-lg-12" id="Reset_HasilPenyerahan" onclick="window.location.reload()">Reset</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <select class="select select2 form-control" name="slc_Kepada_SP" id="slc_Kepada_SP" style="width: 100% !important" required>
                                                ...
                                                <?php foreach ($kepada as $k) { ?>
                                                    <option value="<?php echo $k['kodesie'] . "|" . $k['kd_jabatan'] ?>"><?php echo $k['kodesie'] . " - " . $k['jabatan']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
