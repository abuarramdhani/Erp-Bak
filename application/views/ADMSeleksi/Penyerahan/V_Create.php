                  ...
                  <form id="SuratPenyerahan_utama" class="form-horizontal">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="box box-default box-solid">
                          <div class="box-header with-border hideAllHubker">
                            <b>
                          ...
                          <div class="box-header with-border nambahStyle">
                            <b>
                    ...
                    <div class="row" id="hide_plus_SP" style="margin-top: 20px; margin-bottom: 20px">
                      <div class="col-lg-12">
                        ...
                        <div class="col-lg-2">
                          <div class="col-lg-2">
                            <input type="radio" name="input_Pekerja_SP" class="input_Pekerja_SP" value="1" checked>
                          </div>
                        ...
                        <a type="button" name="button" class="btn btn-success" id="btn_Plus_Pekerja_SP">
                          <span class="fa fa-plus"></span> Tampil
                        </a>
                      </div>
                    </div>
                    <div class="panel-footer row text-center" style="margin-top: 20px;">
                      <!-- I THINK THIS WILL BE NEVER USED AND USER WILL CONFUSE -->
                    ...
                    <div class="col-lg-4">
                      <select class="select select2 form-control" name="slc_approval_SP" id="slc_approval_SP" style="width: 100% !important" required>
                        ...
                        <?php foreach ($approval as $val) : ?>
                          <option <?= ($val['noind'] == 'B0896') ? 'selected' : '' ?> value="<?php echo $val['noind']; ?>"><?php echo $val['noind'] . " - " . $val['nama'] ?></option>
                        <?php endforeach ?>
                      </select>
                    </div>
                  </div>
