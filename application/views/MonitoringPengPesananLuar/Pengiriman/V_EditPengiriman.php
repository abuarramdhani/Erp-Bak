					...
					<div class="col-lg-12">
						<div class="box itsfun1">
							...
							<div class="box-body">
												...
												class="col-md-12" style="margin-bottom: 20px;margin-left:50px">
													<tr>
															...
															<tr>
																...
																<td>
																	<input value="<?php echo $header[0]['delivery_date']?>" class="form-control deldate" style="width: 300px" id="txdDeliveryDate" name="txdDeliveryDate" required="required"></input>
																</td>
															</tr>
											</table>
										</div>
									...
									<table class="table table-bordered table-hover text-center tblMPM" data-step="1" data-intro="Berikut ini panduan untuk mengedit form pengiriman">
										...
										<tbody id="tblViewInputPengiriman">
											...
											<tr class="bakso">
												...
												<td><input disabled type="number" value="<?php echo $value['ordered_qty']?>" class="form-control QtyClsIP" style="width: 100%" id="txnQtyOrderEd" name="txnQtyOrder[]">
												</td>
												<td data-step="3" data-intro="Apabila value pengiriman pertama sama dengan pengiriman kedua, maka hapus value pertama, klik tab, kemudian masukkan value yang sama"><input value="<?php echo $value['delivered_qty']?>" max="<?php echo $value['ordered_qty']?>" onkeyup="if(this.value > <?php echo $value['ordered_qty']?>) this.value = null" onchange="functionDelivered(this)"type="number" class="form-control deliveredClsIP" style="width: 100%" id="txnDeliveredEd" name="txnDelivered[]" >
												</td>
												<td data-step="5" data-intro="Pastikan pula value Accumulation sudah benar"><input disabled type="number" value="<?php echo $value['accumulation']?>" class="form-control ACCClsIP" style="width: 100%" id="txnACCEd" name="txnACC[]">
												</td>
												<td data-step="4" data-intro="Pastikan value Outstanding sesuai dengan perhitungan"><input disabled type="number" value="<?php echo $value['outstanding_qty']?>" class="form-control OutPoClsIP" style="width: 100%" id="txnOutPOEd" name="txnOutPO[]">
												</td>
								...
								<div class="col-md-12">
<a href="<?php echo base_url("MonitoringPengirimanPesananLuar/RekapPengiriman/editPeng/".$header[0]['id_rekap_pengiriman']) ?>">
									<button data-step="6" data-intro="Jika dirasa input salah, tekan button Reset untuk mengulang proses input" id="btnReset" class="btn btn-warning pull-right" style="margin-top: 10px;margin-left: 10px;" ><i class="fa fa-exclamation"></i> Reset</button></a>
