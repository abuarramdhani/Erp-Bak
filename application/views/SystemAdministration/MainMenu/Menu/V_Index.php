									...
									<table class="table table-striped table-bordered table-hover text-left" id="tblUser" style="font-size:12px;">
										...
										?>
												<tr>
													...
													<td><?php echo $AllMenu_item['menu_name'] ?></td>
													<td><?php echo $AllMenu_item['menu_link'] ?></td>
													<td><?php echo $AllMenu_item['menu_fa'] ?></td>
													<td><?php echo $AllMenu_item['menu_title'] ?></td>
													<td align="center">
													<a href="<?php echo base_url('SystemAdministration/Menu/UpdateMenu/')."/".$encrypted_string ?>"><img src="<?php echo base_url('assets/img/edit.png');?>" title="Update <?php echo $AllMenu_item['menu_name'] ?>"></a>
