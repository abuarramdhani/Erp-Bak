																					...
																					<tr class="clone">
																						...
																						<td>
																							<select class="form-control select4" name="slcUserResponsbility[]" id="slcUserResponsbility" required>
																								...
																								?>
																									<option value="<?php echo $Responsibility_item['user_group_menu_id'] ?>" <?php if ($Responsibility_item['user_group_menu_id'] == $UserResponsibility_item['user_group_menu_id']) {
																																																															echo "selected";
																																																														} ?>><?= $Responsibility_item['user_group_menu_name'] ?></option>
																								<?php } ?>
																							</select>
																						...
																						<td>
																							<select class="form-control select4" name="slcActive[]" id="slcActive" required>
																								<option value="" <?php if ($UserResponsibility_item['active'] == "N") {
																																		echo "selected";
																																	} ?>></option>
																								<option value="Y" <?php if ($UserResponsibility_item['active'] == "Y") {
																																		echo "selected";
																																	} ?>>Yes</option>
																								<option value="N" <?php if ($UserResponsibility_item['active'] == "N") {
																																		echo "selected";
																																	} ?>>No</option>
																							</select>
																						</td>
																						<td>
																							<select class="form-control select4" name="slcLokal[]" id="slcLokal">
																								<option <?php if ($UserResponsibility_item['lokal'] == 0) {
																													echo "selected";
																												} ?> value=""></option>
																								<option <?php if ($UserResponsibility_item['lokal'] == 1) {
																													echo "selected";
																												} ?> value="1">Yes</option>
																								<option <?php if ($UserResponsibility_item['lokal'] == 0) {
																													echo "selected";
																						...
																						<td>
																							<select class="form-control select4" name="slcInternet[]" id="slcInternet">
																								<option <?php if ($UserResponsibility_item['internet'] == 0) {
																													echo "selected";
																												} ?> value=""></option>
																								<option <?php if ($UserResponsibility_item['internet'] == 1) {
																													echo "selected";
																												} ?> value="1">Yes</option>
																								<option <?php if ($UserResponsibility_item['internet'] == 0) {
																													echo "selected";
