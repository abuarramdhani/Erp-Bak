	...
	<div class="inner" >
		...
		<table class="table table-striped table-bordered table-responsive table-hover dataTable no-footer">
				...
				<tr>
					<td>keterangan</td>
					<td>
						<textarea class="form-control" name='andro-ket' required></textarea>
					</td>
				</tr>
				</table>
				<div class="col-lg-12">
					...
					<?php if($android[0]['validation'] != '0'){ ?>
					<div class="col-lg-4 text-center">
						<input type="submit" name="txtSubmit" value="Request Remove" class="btn btn-danger">
					</div>
					<?php }else{ ?>
					<div class="col-lg-4 text-center">
