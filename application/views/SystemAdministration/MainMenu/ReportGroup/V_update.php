			...
			<div class="col-lg-12">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						?>
							<form method="post" id="form-buying-type" action="<?php echo site_url('SystemAdministration/ReportGroup/UpdateReportGroup/'.$id)?>" class="form-horizontal">
							...
							<div class="panel-body">
								<div class="row">
									<div class="form-group">
											...
											<div class="col-lg-4">
												<input type="text" placeholder="ReportGroupname" name="txtReportGroupName" class="form-control" value="<?= $ReportGroup_item['report_group_name']?>"readonly/>
											</div>
									</div>
								</div>
								<div class="row">
														...
														<div class="table-responsive" >
															<table class="table table-bordered table-hover text-center"  style="table-layout: fixed;" name="tblReportGroup" id="tblReportGroup">
																...
																<tbody id="tbodyReportGroup">
																	<?php foreach($ReportGroupList as $ReportGroupList_item){
																	?>
																	<tr class="clone">
																		...
																		<td>
																			<select class="form-control select4" name="slcReport[]" id="slcReport" required>
																				...
																				?>
																				<option value="<?php echo $Report_item['report_id']?>"<?php if($Report_item['report_id']==$ReportGroupList_item['report_id']){echo "selected";} ?>><?=$Report_item['report_name']?></option>
																				<?php } ?>
																			</select>
																			<input type="hidden" name="hdnReportGroupListId[]" id="hdnReportGroupListId" value="<?= $ReportGroupList_item['report_group_list_id']?>">
																		</td>
																	</tr>
																	<?php } ?>
