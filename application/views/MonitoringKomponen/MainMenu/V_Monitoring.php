									...
									<div class="row" style="margin: 10px ">
										...
										<div class="col-md-5">
											<div class="form-group">
												...
												<select name="txsTujuanLocator" id="txsTujuanLocator" class="form-control select2-KompAsalLocator">
													<option value=""></option>
												</select>
												</div>
											</div>
										...
										<div class="col-md-5">
											<div class="form-group">
												...
												<select name="txsSort" id="txsSort" class="form-control select2-Sorting">
													<option value=""></option>
													<option value="1">Subinv. + Kode Komp.</option>
													<option value="2">Subinv. + Nama Komp. + Kode Komp.</option>
													<option value="3">Asal Komp. + Kode Komp.</option>
													<option value="4">Subinv. + Lebih Kirim + Kode Komp.</option>
												</select>
												</div>
											</div>
										</div>
										<div class="col-md-5">
											<div class="form-group">
												...
												<select name="txsJenisLaporan" id="txsJenisLaporan" class="form-control select2-JenisLap">
													<option value=""></option>
													<option value="1">Komp. > max simpan</option>
													<option value="2">Komp. < max simpan</option>
													<option value="3">Komp. dengan QTY max</option>
													<option value="4">Komp. tanpa QTY max</option>
												</select>
												</div>
											</div>
										</div>
