                                ...
                                <form method="post" action="<?=base_url('pengembalian-apd/pekerja/save_edit')?>">
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            ...
                                            <table class="table text-center" id="pad_tbl_Dtbl">
                                        ...
                                        <div class="col-md-12 text-center">
                                            <a type="button" class="btn btn-warning" href="<?=base_url('pengembalian-apd/hubker')?>">
                                                Kembali
                                            </a>
                                            <?php if ($status == 0): ?>
                                                <button type="button" class="btn btn-success" id="pad_ApproveApd" value="<?=$id?>">
                                                    Approve
                                                </button>
                                                <button type="button" class="btn btn-danger" id="pad_RejectApd" value="<?=$id?>">
                                                    Reject
                                                </button>
                                            <?php endif ?>
                                        </div>
