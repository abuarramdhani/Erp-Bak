    ...
    <div class="inner">
        <div class="row">
            <div class="col-lg-12">
                ...
                <!-- Input Form -->
                <div class="row">
                    <form enctype="multipart/form-data" autocomplete="off" action="<?php echo site_url('MonitoringFlowOut/ExternalView/update/') . '/' . $id; ?>" method="POST">
                        <?php
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select type="text" class="form-control codecompMFO" id="codecompMFO" placeholder="Masukkan Kode Komponen" name="txtComponentCode">
                                                    <option checked value="<?= $getEdit[0]['component_code_ext'] ?>">
                                                        <?= $getEdit[0]['component_code_ext'] ?></option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select style="width:100%;" name="txtPoss" id="mfo_select3" class="form-control">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="txtSeksiPenanggungJawab[]" style="width:100%;" class="form-control" id="mfo_selectPJ" multiple="multiple">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Vendor" name="txtVendor" value="<?= $getEdit[0]['vendor'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="fileLamaQr" style="float:left; background:#fff; border-color:transparent;" value="<?php echo $getEdit[0]['upload_qr'] ?>" placeholder="<?= $getEdit[0]['upload_qr'] ?>" readonly="">
                                            </div><br />
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control-file" placeholder="Upload CAR" class="upCarEd" name="upCar" accept=".pdf" value="<?= $getEdit[0]['upload_car'] ?>" style="float:left;">
                                                <input type="text" name="fileLamaCar" style="float:left; background:#fff; border-color:transparent;" class="fileLamaCar" value="<?php echo $getEdit[0]['upload_car'] ?>" placeholder="<?= $getEdit[0]['upload_car'] ?>" readonly="">
                                            </div><br />
                                            <div class="form-group">
