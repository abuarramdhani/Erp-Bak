...
<input type="hidden" id="mfoTipe" value="int">
            ...
            <div class="col-lg-12">
                        ...
                        <div class="col-lg-1 ">
                            <div class="text-right hidden-md hidden-sm hidden-xs">
                                <a class="btn btn-default btn-lg"
                                    href="<?php echo site_url('MonitoringFlowOut/InternalView'); ?>">
                ...
                <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                ...
                                <div class="box-body">
                                    <div class="panel-body">
                                        <form action="<?= base_url("MonitoringFlowOut/InternalView/ExportInt")?>" method="post" autocomplete="off">
                                        <div class="row">
                                            <div class="col-lg-8">
                                            ...
                                            <div class="col-lg-3" style="text-align:center;vertical-align:middle;">
                                                ...
                                                <a href="<?= base_url('MonitoringFlowOut/InternalView/')?>"
                            ...
                            <!-- Datatable -->
                            <div class="box box-primary box-solid" id="ajaxTblInt">
                                <div class="box-header with-border">
                                    <div class="col-lg-11" style="vertical-align:middle;">
                                        <b style="vertical-align:middle;"><b>Internal View</b></b>
                                    </div>
                                    <div class="col-lg-1">
                                        <a href="<?= base_url('MonitoringFlowOut/InternalView/Grafik')?>"
                                                ...
                                                <table class="datatable table table-striped table-bordered table-hover"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($dats as $s) {
                                                            ...
                                                            <td><?php echo $s['component_code_int'] ?></td>
                                                            ...
                                                            <td>
                                                                <button onclick="readInternal(<?= $s['id_int'] ?>)"
