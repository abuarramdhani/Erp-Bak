    ...
    <div class="inner">
        <div class="row">
            <div class="col-lg-12">
                ...
                <!-- Input Form -->
                <div class="row">
                    <form enctype="multipart/form-data" autocomplete="off" action="<?php echo site_url('MonitoringFlowOut/InternalInput/create'); ?>" method="post">
                        <div class="col-lg-12">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select type="text" class="form-control codecompMFO" id="codecompMFO" placeholder="Masukkan Kode Komponen" name="txtComponentCode" required="">
                                                    <!-- <option selected value="">Select Component Code</option> -->
                                                </select>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" style="width: 450px; height: 130px;" placeholder="Kronologi Permasalahan" name="txtKronologiPerm" required=""></textarea>
                                            </div>
                                            <div class="form-group">
