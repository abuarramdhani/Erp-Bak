...
<input type="hidden" id="mfoTipe" value="tagInt">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-1 ">
                            <div class="text-right hidden-md hidden-sm hidden-xs">
                                <a class="btn btn-default btn-lg" href="<?php echo site_url('MonitoringFlowOut/TagihanInternal'); ?>">
                ...
                <div class="col-lg-12">
                    <div class="box box-primary box-solid">
                        ...
                        <div class="box-body">
                            <form action="<?= base_url('MonitoringFlowOut/TagihanInternal/ExportInt')?>" method="post" autocomplete="off">
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3" style="text-align:center;vertical-align:middle;">
                                        ...
                                        <a href="<?= base_url('MonitoringFlowOut/TagihanInternal')?>"
                                            class="btn btn-warning btn-sm"><i class="fa fa-refresh"></i> Refresh</a>
                                        <button type="submit" class="btn btn-info btn-sm"> <i class="fa fa-file-excel-o"></i>
                                            Export</button>
                                    </div>
                                </div> <br />
                                <div class="row">
                    ...
                    <!-- Datatable -->
                    <div class="box box-primary box-solid" id="ajaxTblTagInt">
                        <div class="box-header with-border">
                            <b>Tagihan Internal</b>
                        </div>
                        <div class="box-body">
                            <div class="panel-body">
                                <div class="row">
                                        ...
                                        <table class="datatable table table-striped table-bordered table-hover"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $tanggalnew ?></td>
                                                    <td><?= $tagihanAll['component_code_int'] ?></td>
