								...
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-lg-4 col-md-4">
											<div class="col-lg-4 col-xs-5">
												<input type="text" class="form-control" name="txtSisaCuti" id="txtSisaCuti" value="<?php if (empty($SisaCuti['0']['sisa_cuti'])) { echo "0";} else { echo $SisaCuti['0']['sisa_cuti'];} ?> Hari" readonly>
											</div>
											<div class="col-lg-8">
												<span class="label label-warning">Tanggal Boleh Ambil Cuti Anda : <?php if(!empty($mintglpengambilan['0']['tgl_boleh_ambil'])){ echo date("d F Y",strtotime($mintglpengambilan['0']['tgl_boleh_ambil']));}else{ echo "---";} ?>
												</span>
												<input type="hidden" id="minDateCuti" value="<?php if(!empty($mintglpengambilan['0']['tgl_boleh_ambil'])){ echo date("d F Y",strtotime($mintglpengambilan['0']['tgl_boleh_ambil']));}else{ echo "---";} ?>">
											</div>
										</div>
									</div>
									<div class="form-group">
									...
									<!-- <div class="row"> -->
										...
										<div class="panel-footer text-center">
											<button type="button" id="submit_tahunan" class="btn btn-success">Simpan</button>
