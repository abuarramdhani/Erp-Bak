										...
										<div class="box ">
											<div class="panel-body">
													<div class="form-group">
														...
														<div class="col-lg-4">
															<div class="col-lg-4">
																...
																<?php endforeach; ?>
																	<input type="text" class="form-control" name="txtIdCuti" id="txtIdCuti" value="<?php echo $key['lm_pengajuan_cuti']  ?>" readonly>
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-lg-4">
															<div class="col-lg-12">
																	<input type="text" class="form-control" name="txtSisaCuti" id="txtSisaCuti" value="<?php echo $key['tgl_pengajuan']  ?>" readonly>
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-lg-4">
															<div class="col-lg-12">
																	<input type="text" class="form-control" name="" id="" value="<?php echo $key['noind'].' - '.$key['nama']  ?>" readonly>
															</div>
														</div>
													</div>
													<div class="form-group">
															...
															<div class="col-lg-12">
																<select class="select select2" name="slc_JenisCutiTahunan" id="slc_JenisCutiTahunan" data-placeholder="-- silahkan pilih --" style="width:100%;" required>
																	...
																	<?php foreach ($Cuti as $key){ ?>
																		<?php if ($Edit['0']['lm_jenis_cuti_id'] == $key['lm_jenis_cuti_id']) { $selected = "selected";}else{$selected ="";} ?>
													...
													<div class="form-group txtKeperluan">
														...
														<div class="col-lg-4">
															<div class="col-lg-12">
																<textarea class="form-control" style="resize:none;" name="txtKeperluan" id="txtKeperluan" rows="5" cols="50" placeholder="Isi Keperluan"><?php echo $Edit['0']['keperluan'] ?></textarea>
															</div>
														</div>
													</div>
													<div class="form-group">
