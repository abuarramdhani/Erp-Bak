    ...
    <div class="inner">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form autocomplete="off" action="<?php echo base_url('ManufacturingOperationUP2L/QualityControl/createLaporan1'); ?>" method="POST">
                            <div class="box box-primary box-solid">
                    ...
                    <form autocomplete="off" action="<?php echo base_url('ManufacturingOperationUP2L/QualityControl/createLaporan2'); ?>" method="POST">
                        <div class="col-lg-6">
                            <div class="box box-primary box-solid">
                    ...
                    <form autocomplete="off" action="<?php echo base_url('ManufacturingOperationUP2L/QualityControl/createLaporan3'); ?>" method="POST">
                        <div class="col-lg-6">
                            <div class="box box-primary box-solid">
                    ...
                    <form autocomplete="off" action="<?php echo base_url('ManufacturingOperationUP2L/QualityControl/createLaporan4'); ?>" method="POST">
                        <div class="col-lg-6">
                            <div class="box box-primary box-solid">
                    ...
                    <form autocomplete="off" action="<?php echo base_url('ManufacturingOperationUP2L/QualityControl/createLaporan5'); ?>" method="POST">
                        <div class="col-lg-6">
                            <div class="box box-primary box-solid">
