                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control jsSlcComp toupper" name="txtComponentCodeHeader" id="txtComponentCodeHeader" required="" data-placeholder="Component Code" onchange="getCompDescMO(this)">
                                                        <option></option>
                                                    </select>
                                                </div>
                                            </div>
