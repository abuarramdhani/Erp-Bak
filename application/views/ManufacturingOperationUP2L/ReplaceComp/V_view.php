                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-1">
                            <div class="text-right hidden-md hidden-sm hidden-xs">
                                <a class="btn btn-default btn-lg" href="<?php echo site_url('ManufacturingOperationUP2L/Job/ReplaceComp');?>">
                            ...
                            <div class="box-body">
                                                ...
                                                <tbody>
                                                    <?php $numb=1; foreach ($jobLineReject as $rj) { ?>
                                                        <tr row-id="<?php echo $numb; ?>" data-subinv="<?php echo $rj['subinventory_code'] ?>">
                                                            ...
                                                            <td>
                                                                <a href="<?php echo base_url('ManufacturingOperationUP2L/Job/ReplaceComp/deleteRejectComp/'.$value['WIP_ENTITY_NAME'].'/'.$rj['replacement_component_id']) ?>" onclick="return confirm('Are you sure to remove this data?');" class="btn btn-danger btn-block" data-toggle="tooltip" data-placement="left" title="Remove Reject Component">
                                                                    <i class="fa fa-minus"></i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                ...
                                <div class="panel-footer" id="generateBtnArea">
                                    <div class="row text-right">
                                        <a id="btnClearRjc" class="btn btn-default btnReject" href="<?php echo base_url('ManufacturingOperationUP2L/Job/ReplaceComp/clearJob/'.$value['WIP_ENTITY_NAME']); ?>" <?php if (empty($jobLineReject)) { echo "disabled"; } ?>>CLEAR</a>
...
<div class="modal fade" id="modalFormReject" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="post" target="_blank" action="<?php echo base_url('ManufacturingOperationUP2L/Job/ReplaceComp/submitJobForm/'.$id) ?>">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <label>Subinventory</label>
