                                        ...
                                        <div class="box box-default box-solid">
                                                ...
                                                <div class="panel-body" id="container-employee">
                                                    <div class="form-group employee">
                                                        <label for="txtCoreQuantityHeader" class="control-label col-lg-4">Nama</label>
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="row" style="padding:17px;">
                                                            ...
                                                            <label for="txtCoreQuantityHeader" class="control-label col-lg-2">Lembur</label>
                                                            <div class="col-lg-2">
                                            ...
                                            <div class="box box-default box-solid">
                                                ...
                                                <div class="panel-body" id="container-compcore">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-info addCompCore"> <i class="fa fa-plus"></i></button>
                                                        <button type="button" class="btn btn-danger delcompCore" style="display:none"> <i class="fa fa-times"></i></button>
