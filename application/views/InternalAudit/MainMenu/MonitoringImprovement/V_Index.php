											...
											<tbody>
												<?php foreach ($dataImprovement as $k => $v) { ?>
													...
													<td>
														...
														<button class="btn btn-cust-m btn-md <?= $v['sign_print'] ?>" title="Print" data-toggle="tooltip" data-id="<?= $v['id'] ?>" > <b class="fa fa-print"></b></button>
														</a>
														<a href="<?= base_url('InternalAudit/MonitoringImprovement/Edit/'.$v['id']) ?>">
														<button class="btn btn-cust-m btn-md btn-primary" title="Edit" data-toggle="tooltip" > <b class="fa fa-edit"></b></button>
														</a>
														<button class="btn btn-cust-e btn-md btn-danger" title="Delete" data-toggle="tooltip" data-id="<?= $v['id'] ?>" onclick="delImprovementIa(this)"> <b class="fa fa-trash"></b></button>
														</center>
													</td>
												</tr>
												<?php } ?>
