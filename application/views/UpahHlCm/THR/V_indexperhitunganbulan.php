					...
					<div class="col-lg-12">
						<div class="box box-primary box-solid">
							...
							<div class="box-body">
								<div class="row">
									<div class="col-lg-12">
										<a href="<?php echo base_url('HitungHlcm/THR/PerhitunganBulan/proses') ?>" class="btn btn-primary">Hitung Bulan THR</a>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12">
													...
													if (isset($data) && !empty($data)) {
														...
														foreach ($data as $dt) {
															...
															<tr>
																...
																<td style="text-align: center;vertical-align: middle;">
																	<a class="btn btn-info" href="<?php echo base_url('HitungHlcm/THR/PerhitunganBulan/read?tanggal='.$dt['tgl_idul_fitri']) ?>" target="blank"><span class="fa fa-file-o"></span>&nbsp;SEMUA</a>
																</td>
																<td style="text-align: center;vertical-align: middle;">
															...
															<tr>
																...
																<td style="text-align: center;vertical-align: middle;">
																	<a class="btn btn-info" href="<?php echo base_url('HitungHlcm/THR/PerhitunganBulan/read?tanggal='.$dt['tgl_idul_fitri']."&lokasi=01") ?>" target="blank"><span class="fa fa-file-o"></span>&nbsp;YOGYAKARTA</a>
																</td>
																<td style="text-align: center;vertical-align: middle;">
															...
															<tr>
																...
																<td style="text-align: center;vertical-align: middle;">
																	<a class="btn btn-info" href="<?php echo base_url('HitungHlcm/THR/PerhitunganBulan/read?tanggal='.$dt['tgl_idul_fitri']."&lokasi=02") ?>" target="blank"><span class="fa fa-file-o"></span>&nbsp;TUKSONO</a>
																</td>
																<td style="text-align: center;vertical-align: middle;">
