			...
			<div class="row">
				...
				<div class="box box-primary box-solid">
					<div class="box-header with-border">
						<b>Form Pembuatan Master Surat Peringatan</b>
					</div>
					
					<div class="box-body">
					<form method="post" action="<?php echo base_url('PenilaianKinerja/MasterSuratPeringatan/Add')?>">
						...
						<div class="row" style="margin: 10px 10px">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input name="txtNoSP" class="form-control">
								</div>
							</div>
						</div>
						<div class="row" style="margin: 10px 10px">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input name="txtNilai" class="form-control" type="number">
								</div>
							</div>
						</div>
						<hr>
