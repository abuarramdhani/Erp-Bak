									...
									<div class="col-lg-12">
										...
										<?php foreach ($rekap as $key) { ?>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" value="<?php echo $key['batas_bawah'] ?>" class="form-control" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-lg-4">Batas Atas</label>
												<div class="col-lg-4">
													<input type="text" value="<?php echo $key['batas_atas'] ?>" class="form-control" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-lg-4">Pengurang</label>
												<div class="col-lg-4">
													<input type="number" value="<?php echo $key['pengurang'] ?>" min="0" name="txtPengurangPrestasi" class="form-control" required>
												</div>
											</div>
											<div class="form-group">
