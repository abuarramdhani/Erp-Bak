			...
			<div class="row">
				...
				<div class="box box-primary box-solid">
					<div class="box-header with-border">
						<b>Form Pembuatan Master Kategori</b>
					</div>
					
					<div class="box-body">
					<form method="post" action="<?php echo base_url('PenilaianKinerja/MasterKategoriPenilaian/Add')?>">
						...
						<div class="row" style="margin: 10px 10px">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input name="txtStandar" class="form-control" type="number">
								</div>
							</div>
						</div>
						<hr>
