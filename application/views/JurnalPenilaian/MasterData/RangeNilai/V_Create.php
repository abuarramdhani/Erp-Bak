			...
			<div class="row">
				...
				<div class="box box-primary box-solid">
					<div class="box-header with-border">
						<b>Form Pembuatan Master Range Nilai</b>
					</div>
					
					<div class="box-body">
					<form method="post" action="<?php echo base_url('PenilaianKinerja/MasterRangeNilai/Add')?>">
						...
						<div class="row" style="margin: 10px 10px">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input name="txtBA" class="form-control">
								</div>
							</div>
						</div>
						<div class="row" style="margin: 10px 10px">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input name="txtBB" class="form-control">
								</div>
							</div>
						</div>
						<div class="row" style="margin: 10px 10px">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input name="txtKategori" class="form-control">
								</div>
							</div>
						</div>
						<hr>
