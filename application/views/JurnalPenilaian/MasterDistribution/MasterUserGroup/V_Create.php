			...
			<div class="row">
				...
				<div class="box box-primary box-solid">
					<div class="box-header with-border">
						<b>Form Pembuatan Master Unit Group</b>
					</div>
					
					<div class="box-body">
					<form method="post" action="<?php echo base_url('PenilaianKinerja/MasterUnitGroup/add')?>">						
						<hr>
						<div class="row" style="margin: 10px 10px">
							<div class="form-group">
								<label class="col-lg-2 control-label"> Unit Group </label>
								<div class="col-lg-7">
									<input name="txtUnitGroup" class="form-control">
								</div>
							</div>
						</div>
						<hr>
