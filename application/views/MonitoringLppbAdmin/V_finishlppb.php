							...
							<div class="box-body">
								<table class="table text-center dtTableMl">
									...
									<tr>
										<td><?php echo $no?></td>
										<td>
											<a title="Detail Lppb" href="<?php echo base_url('MonitoringLPPB/Finish/FinishDetail/'.$lb['BATCH_NUMBER'])?>" class="btn btn-default btn-xs"><i class="fa fa-file-text-o"></i></a>
										</td>
