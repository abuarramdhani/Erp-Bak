		...
		<table id="showTableLppb" class="table table-striped table-bordered table-hover text-center">
			<thead style="vertical-align: middle;"> 
				<tr class="bg-primary">
					...
					<!-- <th class="text-center" style="display: none">BATCH DETAIL ID </th> -->
			...
			<tbody>
				...
				<tr id="<?php echo $no; ?>">
					...
					<!-- <td class="text-center"><?php echo $batchdetail['BATCH_DETAIL_ID']?> </td> -->
		...
		<div class="pull-right">
			<button type="button" id="addDetailLppbNumber" class="btn btn-primary" style="margin-top: 10px">Add</button>
		</div>
