    ...
    <section class="content">
        <div class="row">
            <!-- /.col -->
            <div class="col-md-12">
                <form action="<?= base_url('PurchaseManagementSendPO/SendPO/SendEmail') ?>" method="post" enctype="multipart/form-data">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <label for="txtPMSPONoPO" class="col-sm-2 control-label" style="font-weight:normal">PO Number</label>

                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="txtPMSPONoPO" name="txtPMSPONoPO" placeholder="Purchase Order Number" value="<?= $po_Lnumber; ?>">
                                </div>
                                ...
                                <div class="col-sm-2">
                                    <ul class="timeline" style="margin:0px">
                                        <li class="time-label" style="margin:0px">
                                            <span class="bg-red">&nbsp;<i class="fa fa-remove"></i><span class="spnPMSPOWarnAddrNotFound"></span></span>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="form-group">
                            <label for="txtPMSPOCCEmailAddr" class="col-sm-2 control-label" style="font-weight:normal">CC. Email Address</label>
                            <div class="col-sm-3">
                                <input type="email" class="form-control" id="txtPMSPOCCEmailAddr" name="txtPMSPOCCEmailAddr" placeholder="Email Address CC">
                            </div>
                            <div class="col-sm-6 divPMSPOCCEmailAddrWarn" style="height: 30px; float:left;display:none">
                                <!-- timeline time label -->
                                <ul class="timeline" style="margin:0px">
                                    <li class="time-label" style="margin:0px">
                                        <span class="bg-yellow">&nbsp;<i class="fa fa-warning"></i>&nbsp;Pisahkan
                        ...
                        <div class="form-group">
                            <label for="txtPMSPOSubject" class="col-sm-2 control-label" style="font-weight:normal">Subject</label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="txtPMSPOSubject" name="txtPMSPOSubject" placeholder="Subject This Message">
                            </div>
                        </div><br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="slcPMSPOFormatMessage" class="col-sm-2 control-label" style="font-weight:normal">Format Message</label>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <select id="slcPMSPOFormatMessage" class="form-control select2" style="width: 100%;">
                        ...
                        <div class="form-group">
                            <textarea id="txaPMSPOEmailBody" class="form-control" name="txaPMSPOEmailBody" style="height: 300px" disabled></textarea>
                        </div>
                    ...
                    <div class="box-footer">
                        <div class="pull-right">
                            ...
                            <button type="button" class="btn btn-primary btnPMSPOcheckSend"><i class="fa fa-envelope-o"></i> Send</button>
                        </div>
                        <button type="button" class="btn btn-default btnConfirmDiscard"><i class="fa fa-times"></i>
                            Discard</button>
                        <button type="reset" class="btn btn-default btnPMSPODiscard" style="display:none"><i class="fa fa-times"></i> Discard</button>
                    </div>
                    <!-- /.box-footer -->
            </div>
            <!-- /. box -->
