                                        ...
                                        <tbody>
                                            ...
                                            <?php if($value['SELISIH_WAKTU_1'] > 24 && $value['VENDOR_CONFIRM_DATE'] === NULL && $value['SEND_DATE_2'] === NULL){
                                                ...
                                                <td style="min-width: 120px; max-width: 120px; text-align: center;">
                                                    ...
                                                    <a class="btn btn-success btn-edit <?= ($value['SELISIH_WAKTU_2'] > 24 && $value['VENDOR_CONFIRM_DATE'] == NULL)?'hidden':''; ?>" href="<?= base_url("PurchaseManagementSendPO/PoLog/edit") . '?po_numb=' . $value['PO_NUMBER']; ?>" title="Edit"><i class="fa fa-edit"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
