                                    ...
                                    <table class="table table-bordered table-hover text-left" id="tbl-PoLogbook" style="font-size:12px; width: 150%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="<?php if($value['DISTRIBUTION_METHOD'] !== "none" && $value['SELISIH_WAKTU_1'] > 24 && $value['VENDOR_CONFIRM_DATE'] === NULL && $value['SEND_DATE_2'] === NULL){
                                                ...
                                                <td>
                                                    <center><a href="<?= base_url('PurchaseManagementSendPO/PoLogbook/download') . '/' . $value['PO_NUMBER'] . '-' . $value['PO_REVISION'] . '/' . $value['ATTACHMENT']; ?>" style="text-decoration: none;"><?= $value['ATTACHMENT']; ?></a></center>
                                                </td>
