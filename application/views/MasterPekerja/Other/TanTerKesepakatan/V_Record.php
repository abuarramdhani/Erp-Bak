    ...
    <div class="panel-group">
      <div class="panel panel-primary">
        <div class="panel-heading" style="display: flex; justify-content: space-between;">
          <a href="<?= base_url('MasterPekerja/TanTerKesepakatan') ?>">
            <button class="btn btn-default">
              <i class="fa fa-arrow-left"></i>
              <span>Kembali</span>
            </button>
          </a>
          <h3 style="text-align: right;">Record Tanda Terima Kesepakatan</h3>
        </div>
        <div class="panel-body">
          <div class="col-md-12">
            <form action="<?= base_url('MasterPekerja/TanTerKesepakatan/record') ?>" method="GET" class="form-horizontal">
              <div class="row">
                <div class="col-md-12">
