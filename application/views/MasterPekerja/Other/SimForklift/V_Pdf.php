	...
	if (isset($pekerja) && !empty($pekerja)) {
		...
		foreach ($pekerja as $value) {
			if ($value->jenis == "Utama") {
				?>
					<div style="height: 85.60mm;width: 53.98mm;border: 1px solid black;color: black;float: left;background-image: url(<?php echo base_url('assets/img/SimForklift/front_utama.png') ?>);background-repeat: no-repeat;background-attachment: fixed;background-size: 100% 100%;margin-right: 5mm;margin-bottom: 5mm;margin-left: 5mm;">
					...
					<div style="height: 85.60mm;width: 53.98mm;border: 1px solid black;color: black;float: left;background-image: url(<?php echo base_url('assets/img/SimForklift/back.png') ?>);background-repeat: no-repeat;background-attachment: fixed;background-size: 100% 100%;margin-right: 5mm;margin-bottom: 5mm;margin-left: 5mm;font-family: calibri;">
				...
				?>
					<div style="height: 85.60mm;width: 53.98mm;border: 1px solid black;color: yellow;float: left;background-image: url(<?php echo base_url('assets/img/SimForklift/front_cadangan.png') ?>);background-repeat: no-repeat;background-attachment: fixed;background-size: 100% 100%;margin-right: 5mm;margin-bottom: 5mm;margin-left: 5mm;">
						<div style="width: 100%;text-align: center;margin-top: 8mm;">
