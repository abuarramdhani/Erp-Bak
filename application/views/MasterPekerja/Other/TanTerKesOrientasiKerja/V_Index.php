    ...
    <div class="panel-group">
      <div class="panel panel-primary">
        <div class="panel-heading" style="display: flex; justify-content: space-between;">
          <a href="<?= base_url('MasterPekerja/TanTerKesOrientasiKerja/record') ?>">
            <button class="btn btn-warning">
              <span>Record</span>
              <i class="fa fa-server"></i>
            </button>
          </a>
          <h3 style="text-align: right;">Cetak Tanda Terima Kesepakatan Orientasi Kerja</h3>
        </div>
        <div class="panel-body">
          <div class="form-group" style="padding-bottom: 1em;">
            <button class="btn btn-success pull-left">
              <a style="color: white" href="<?php echo base_url('MasterPekerja/TanTerKesOrientasiKerja/excel') ?>">
            ...
            <a href="<?php echo base_url('MasterPekerja/TanTerKesOrientasiKerja/delete_all') ?>" class="btn btn-danger pull-right" style="margin-right: 20px;" onclick="return confirm('Apakah anda yakin ingin mengosongkan tabel ini ?')">Kosongkan Tabel</a>
          </div>
          <br>
          <div>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?= $key['lokasi'] ?></td>
                    <td align="center">
                      <a href="<?php echo base_url('MasterPekerja/TanTerKesOrientasiKerja/delete' . '/' . $id); ?>"><span class="glyphicon glyphicon-trash"></span></a>
                    </td>
                  </tr>
                <?php
                  $no++;
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="<?php echo base_url('MasterPekerja/TanTerKesOrientasiKerja/insert'); ?>">
