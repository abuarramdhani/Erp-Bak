...
// Set document properties
	...
	// Add some data
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E3', 'NO KPJ');
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F3', 'NO JP');
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G3', 'LOKASI');
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H3', 'TANGGAL');
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I3', 'NAMA&TTD');
	...
	$no = 0;
	$i=3;
 	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', "TANDA TERIMA KARTU BPJS KETENAGAKERJAAN");
	...
	$objPHPExcel->setActiveSheetIndex(0)
				...
				->setCellValueExplicit($kolomE, $tc['no_kpj'], PHPExcel_Cell_DataType::TYPE_STRING)
				->setCellValueExplicit($kolomF, $tc['jp'], PHPExcel_Cell_DataType::TYPE_STRING)
				->setCellValueExplicit($kolomG, $tc['lokasi'], PHPExcel_Cell_DataType::TYPE_STRING)
				->setCellValueExplicit($kolomH, date('Y-m-d', strtotime($tc['created_timestamp'])), PHPExcel_Cell_DataType::TYPE_STRING);
