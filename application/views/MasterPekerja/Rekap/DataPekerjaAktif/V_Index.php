            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-5">
                            <div class="text-right"><h1><b>DaftarPekerjaAktif</b></h1></div>
                        </div>
                        <div class="col-lg-1">
                        </div>
                    </div>
                                ...
                                <div class="col-md-12">
                                    <form id="mpk_dpadivfom">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control mpk_dpatgl" name="tanggal">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <button class="btn btn-primary" id="mpk_btnsrcdpa" type="button">
                                                Lihat
                                            </button>
                                        </form>
                                    </div>
                                </div>
                                <div class="col-md-12" style="margin-top: 50px;" id="mpk_dpadivtbl">
