<section class="content">
	<div class="inner" >
			<div class="box box-header"  style="padding-left:20px">
				<h3 class="pull-left"><i class="fa fa-print">&nbsp;</i><strong> Cetak Laporan Kunjungan Pekerja </strong></h3>
			</div>
		</div>
		<div class="panel box-body" style="font-size: 13px;">
			<form id="formLap" method="post" action="<?php echo base_url('MasterPekerja/LaporanKunjungan/cetakLaporanKunjungan'); ?>">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="form-group col-md-6">
							...
							<select required style="width: 100%" class="form-control slc-namaatasan" name="atasan" id="atasan"><option value=""></option></select>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="form-group col-md-6">
							...
							<select required style="width: 100%" class="form-control slc-namapetugas" name="petugas" id="nolap"><option value=""></option></select>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-1"><label for="pekerja">Pekerja</label></div>
					<div class="form-group col-md-6">
						    ...
						    <select required style="width: 100%" class="form-control slc-laporankunjungan" name="pekerja" id="pekerja"><option value=""></option></select>
					 </div>	
				</div>
			</div>		
			...
			<div class="row">
				...
				<div class="col-md-1"> <label for="diagnosa">Diagnosa</label></div>
					<div class="form-group col-md-6">
				  	     <input required type="text" name="diagnosa" class="form-control" id="diagnosa" placeholder="Diagnosa">
				  </div>
				</div>
			</div>
			...
			<div class="row latar-belakang">
				...
				<div class="col-md-1"> <label for="latbel">Latar Belakang </label></div>
					<div class="form-group col-md-6">
					    ...
					    <input required name="latar_belakang[]" type="text" class="form-control latbel" id="latbel" placeholder="Latar Belakang">
					  </div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-2"></div>
					...
					<div class="col-md-2">
						<button disabled id="deleteLatarBelakang" type="button" class="btn btn-warning">Hapus Latar Belakang</button>
					</div>
				</div>
			</div>
			<br/>
			...
			<div class="row">
				...
				<div class="col-md-1"><label for="lapkun"><i class="fa fa-pencil-square">&nbsp;&nbsp;</i>Laporan Hasil Kunjungan</label></div>
					<div class="form-group col-md-8">
					  	...
					  	<textarea required class="form-control txtLapKun preview-Lapkun ckeditor" id="lapkun" name="LapKun" rows="10"></textarea>
					</div>
				</div>
			</div>			  
			</form>
...
<div class="box-preview" style="width: 100%;background: white;padding-top: 20px;display: none">
	...
	<div class="col-md-12">
		...
		<div class="col-md-8" style="display: none;" id="divCetak">
			<center><button type="button" class="btn btn-primary btn-cetak btn-lg"><i class="fa fa-file-pdf-o">&nbsp;&nbsp;</i><b>Save</b></button></center>
		</div>
	</div>
	</div>
