									...
									<div class="col-lg-12">
										...
										<form class="form-horizontal" method="POST" action="<?php echo site_url('MasterPekerja/Surat/SuratIsolasiMandiri/Simpan'.$link) ?>" target="_blank" onsubmit="setTimeout(function () { window.location.href = baseurl+'Covid/MonitoringCovid'; }, 5000)" id="mpk_frmis">
											...
											<div class="form-group">
												...
												<div class="col-lg-4">
													<select class="slcMPSuratIsolasiMandiriPekerjax slcMPSuratIsolasiMandiriTo" data-placeholder="Tembusan" name="slcMPSuratIsolasiMandiriTembusan" id="slcMPSuratIsolasiMandiriTembusan" style="width: 100%">
														<option></option>
