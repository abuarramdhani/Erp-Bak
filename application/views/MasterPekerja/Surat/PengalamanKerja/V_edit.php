									...
									?>
										<form class="form-horizontal" method="POST" action="<?php echo site_url('MasterPekerja/Surat/PengalamanKerja/Update/' . $datane) ?>">
											...
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" name="txtMPSuratPengalamanKerjaMasuk" autocomplete="off" id="txtMPSuratPengalamanKerjaMasuk" class="form-control " value="<?php echo $dt['masukkerja'] ?>" placeholder="Masuk Kerja" readonly required>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<select name="txtMPSuratPengalamanKerjaSampai" placeholder="Tanggal Sampai" id="txtMPSuratPengalamanKerjaSampai" class="form-control">
														<option value="<?= $dt['tgl_kena'] ?>"><?= $dt['tgl_kena'] ?></option>
														<option value="1900-01-01" <?= ($dt['tgl_kena'] == '1900-01-01') ? 'selected' : '' ?>>Tanggal dibuatnya surat keterangan ini dan masih bekerja</option>
													</select>
