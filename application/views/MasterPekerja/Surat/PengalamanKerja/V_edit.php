									...
									?>
											...
											-->
												<div class="form-group">
													...
													<div class="col-lg-4">
														<input type="text" name="txtMPSuratPengalamanKerjaMasuk" autocomplete="off" id="txtMPSuratPengalamanKerjaMasuk" class="form-control " value="<?php echo $dt['masukkerja'] ?>" placeholder="Masuk Kerja" required>
													</div>
												</div>
												<div class="form-group">
