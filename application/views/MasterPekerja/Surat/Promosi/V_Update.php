                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="select2" name="txtNoind" id="MasterPekerja-SuratPromosi-DaftarPekerja" style="width: 100%" readonly>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select name="txtKodesieBaru" class="select2" id="MasterPekerja-SuratPromosi-DaftarSeksi" style="width: 100%">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select name="txtGolonganPekerjaanBaru" class="form-control select2" id="MasterPekerja-SuratPromosi-DaftarGolongan">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select name="txtPekerjaanBaru" class="form-control select2" id="MasterPekerja-SuratPromosi-DaftarPekerjaan">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <textarea class="ckeditor" name="txaPreview" id="MasterPekerja-SuratPromosi-txaPreview">
