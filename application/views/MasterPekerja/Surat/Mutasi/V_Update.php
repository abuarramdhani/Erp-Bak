<section class="content">
    <div class="inner" >
        <div class="row">
            <form id="MasterPekerja-SuratMutasi-FormCreate" method="post" action="<?php echo site_url('MasterPekerja/Surat/SuratMutasi/edit/'.$id);?>" class="form-horizontal" >
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select  class="select2" name="txtNoind" id="MasterPekerja-Surat-DaftarPekerja" style="width: 100%" readonly>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" name="txtKodesieLama" class="form-control" id="MasterPekerja-txtKodesieLama" readonly="" value="<?php echo $edit['kodesie_lama'];?> - <?php echo $edit['seksi'];?>">
                                                        </div>
                                                    </div>  
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" name="txtPekerjaanLama" class="form-control" id="MasterPekerja-txtPekerjaanLama" readonly="" value="<?php echo $edit['kd_pkj_lama'].' - '.$edit['pekerjaan'];?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" name="txtLokasiKerja" class="form-control" id="MasterPekerja-txtLokasiKerjaLama" readonly="" value="<?php echo $edit['lokasi_kerja_lama'];?> - <?php echo $edit['lokasi_kerja'];?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select name="txtKdJabatanBaru" class="form-control select2" id="MasterPekerja-DaftarKodeJabatan">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select name="txtLokasiKerjaBaru" class="form-control select2" id="MasterPekerja-DaftarLokasiKerja">
                                                                <option value="<?php echo $edit['lokasi_kerja_baru'];?>" selected>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select name="txtTempatMakan1Baru" class="form-control select2 MasterPekerja-DaftarTempatMakan" >
                                                                 <option value="<?php echo $edit['tempat_makan_1_baru']; ?>"></option>
                                                                <?php
                                                                    foreach ($DaftarTempatMakan1 as $tempatmakan1) 
                                                                    {
                                                                         $tmsb = '';
                                                                         if($tempatmakan1['tempat_makan_1_baru']==$edit['tempat_makan_1_baru']) {
                                                                            $tmsb='selected';
                                                                         }
                                                               ?>
                                                             <option <?php echo $tmsb ?> value="<?php echo $tempatmakan1['tempat_makan_1_baru'];?>" ><?php echo $tempatmakan1['tempat_makan_1_lama']?>
                                                             </option>
                                                               <?php
                                                                    }
                                                                ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select name="txtTempatMakan2Baru" class="form-control select2 MasterPekerja-DaftarTempatMakan" >
                                                                 <option value="<?php echo $edit['tempat_makan_2_baru']; ?>"></option>
                                                                <?php
                                                                    foreach ($DaftarTempatMakan2 as $tempatmakan2) 
                                                                    {
                                                                        $tmdb='';
                                                                        if($tempatmakan2['tempat_makan_2_baru']==$edit['tempat_makan_2_baru']) {
                                                                            $tmdb='selected';
                                                                        }
                                                               ?>
                                                             <option <?php echo $tmdb ?> value="<?php echo $tempatmakan2['tempat_makan_2_baru'];?>" ><?php echo $tempatmakan2['tempat_makan_2_baru'];?></option>
                                                               <?php
                                                                    }
                                                                ?>
                                                            </select>
