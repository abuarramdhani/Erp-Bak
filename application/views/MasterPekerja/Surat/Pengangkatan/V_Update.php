                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" name="txtNoindBaru" id="MasterPekerja-Surat-UpdatePekerja" class="toupper form-control MasterPekerja-txtNoindBaru" value="<?php echo $edit['nomor_induk_baru']?>">
