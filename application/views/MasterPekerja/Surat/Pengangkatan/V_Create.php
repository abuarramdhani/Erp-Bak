<section class="content">
    <div class="inner" >
        <div class="row">
            <form id="MasterPekerja-SuratPengangk-FormCreate" method="post" action="<?php echo site_url('MasterPekerja/Surat/SuraPengangkatan/add');?>" class="form-horizontal" >
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <textarea class="ckeditor" name="txaPreview" id="MasterPekerja-SuratMutasi-txaPreview"></textarea>
                                                        </div>
                                                    </div>  
                                                </div>
                                                <div class="col-lg-4">
