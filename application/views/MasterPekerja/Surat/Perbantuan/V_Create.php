<section class="content">
    <div class="inner" >
        <div class="row">
            <form id="MasterPekerja-SuratPerbantuan-FormCreate" method="post" action="<?php echo site_url('MasterPekerja/Surat/SuratPerbantuan/add');?>" class="form-horizontal" >
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">Create Surat Perbantuan</div>
                                    <div class="box-body">
                                        <div class="panel-body">
                                           ...
                                           <div class="col-lg-6">
                                                    <div class="form-group">
                                                       ...
                                                       <div class="col-lg-8">
                                                            <input type="text" name="txtTanggalBerlaku" class="form-control MasterPekerja-daterangepicker">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <div class="col-lg-2 text-right">
                                                            <a id="MasterPekerja-SuratPerbantuan-btnPreview" title="Preview" class="btn btn-info">Preview</a>
                                                        </div>
                                                        <div class="col-lg-10">
                                                            <textarea class="ckeditor redactor" name="txaPreview" id="MasterPekerja-SuratPerbantuan-txaPreview"></textarea>
                                                        </div>
                                                    </div>  
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control" readonly="" name="txtNomorSurat" id="MasterPekerja-SuratPerbantuan-txtNomorSurat">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control" readonly="" name="txtKodeSurat" id="MasterPekerja-SuratPerbantuan-txtKodeSurat">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control" style="text-transform: uppercase;" name="txtHalSurat" value="" id="MasterPekerja-SuratPerbantuan-txtHalSurat">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
