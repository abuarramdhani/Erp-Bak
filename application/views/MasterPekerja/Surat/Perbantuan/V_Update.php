                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="select2" name="txtNoind" id="MasterPekerja-SuratPerbantuan-DaftarPekerja" style="width: 100%" readonly>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select name="txtGolonganPekerjaanBaru" class="form-control select2" id="MasterPekerja-SuratPerbantuan-DaftarGolongan">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select name="txtPekerjaanBaru" class="form-control select2" id="MasterPekerja-SuratPerbantuan-DaftarPekerjaan">
