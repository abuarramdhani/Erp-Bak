<table class="table table-striped table-bordered table-hover text-left dataTable" style="font-size:12px;">
  <thead class="bg-primary">
    <tr>
      ...
      <th style="text-align:center;">Staff / NonStaff</th>
    ...
    ?>
      <tr>
        ...
        <td align='center' style="white-space: nowrap;">
          <!-- <a target="_blank" style="margin-right:4px" href="<?php echo base_url('MasterPekerja/Surat/SuratPengangkatanStaff/previewcetak/' . $encrypted_string . ''); ?>" data-toggle="tooltip" data-placement="bottom" title="Preview Cetak"><span class="fa fa-file-pdf-o fa-2x"></span></a>
          <a style="margin-right:4px" href="<?php echo base_url('MasterPekerja/Surat/SuratPengangkatanStaff/update/' . $encrypted_string . ''); ?>" data-toggle="tooltip" data-placement="bottom" title="Edit Data"><span class="fa fa-pencil-square-o fa-2x"></span></a>
          <a href="<?php echo base_url('MasterPekerja/Surat/SuratPengangkatanStaff/delete/' . $encrypted_string . ''); ?>" data-toggle="tooltip" data-placement="bottom" title="Hapus Data" onclick="return confirm('Are you sure you want to delete this item?');"><span class="fa fa-trash fa-2x"></span></a> -->
        ...
        <td>
          <?= strstr($row['no_surat'], $kode_staff) ? 'STAFF' : 'NON-STAFF'  ?>
        </td>
        ...
        <td style="text-align: center;"><?= $row['deleted_by'] ?></td>
        <td style="text-align: center;"><?= date('Y-m-d H:i:s', strtotime($row['deleted_date'])) ?></td>
      </tr>
    <?php endforeach; ?>
  </tbody>
</table>
