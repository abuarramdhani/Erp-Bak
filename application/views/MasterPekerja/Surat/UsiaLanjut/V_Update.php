<section class="content">
    <div class="inner" >
        <div class="row">
            <form id="MasterPekerja-SuratUsiaLanjut-FormCreate" method="post" action="<?php echo site_url('MasterPekerja/Surat/SuratUsiaLanjut/edit');?>" class="form-horizontal" >
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">Edit Surat Pemberitahuan Usia Lanjut</div>
                                    <div class="box-body">
                                        ...
                                        <?php 
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="select2 MasterPekerja-Surat-DaftarPekerja" name="txtAproval1" style="width: 100%">
                                                               <option selected="" value="<?php echo $isiSuratUsiaLanjut[0]['atasan_1'].' - '.$isiSuratUsiaLanjut[0]['namaatasan1']; ?>"><?php echo $isiSuratUsiaLanjut[0]['atasan_1'].' - '.$isiSuratUsiaLanjut[0]['namaatasan1']; ?></option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="select2 MasterPekerja-Surat-DaftarPekerja" name="txtAproval2" style="width: 100%">
                                                                <option selected="" value="<?php echo $isiSuratUsiaLanjut[0]['atasan_2'].' - '.$isiSuratUsiaLanjut[0]['namaatasan2']; ?>"><?php echo $isiSuratUsiaLanjut[0]['atasan_2'].' - '.$isiSuratUsiaLanjut[0]['namaatasan2']; ?></option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" value="<?php echo $isiSuratUsiaLanjut[0]['no_surat']; ?>"  class="form-control MasterPekerja-SuratUsiaLanjut-txtNomorSurat" name="txtNomorSurat" id="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" value="<?php echo $isiSuratUsiaLanjut[0]['kode']; ?>" class="form-control" name="txtKodeSurat" id="MasterPekerja-Surat-txtKodeSurat">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <textarea class="ckeditor MasterPekerja-SuratUsiaLanjut-txaPreview" name="txaPreview"><?php echo $isiSuratUsiaLanjut[0]['isi_surat']; ?></textarea>
                                                        </div>
                                                    </div>  
                                                </div>
                                            </div>
                                        ...
                                        <div class="panel-footer">
                                            <div class="row text-right">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-lg btn-rect">Save Change</button>
                                            </div>
                                        </div>
                                    </div>
                            </div>
