                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-1">
                            <div class="text-right hidden-md hidden-sm hidden-xs">
                                ...
                                <a class="btn btn-default btn-lg" href="<?php echo site_url('MasterPekerja/Surat/SuratRotasi');?>">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover text-left" id="tbl" .$new_table_name. "" style="font-size:12px;">
                                        ...
                                        <tbody>
                                            <?php 
                                                $no = 1; 
                                                foreach($DaftarSuratRotasi as $row):
                                            ...
                                            <tr>
                                                ...
                                                <td align='center' style="white-space: nowrap;">
                                                    <a style="margin-right:4px" href="<?php echo base_url('MasterPekerja/Surat/SuratRotasi/previewcetak/'.$encrypted_string.''); ?>" data-toggle="tooltip" data-placement="bottom" title="Preview Cetak"><span class="fa fa-file-pdf-o fa-2x"></span></a>
