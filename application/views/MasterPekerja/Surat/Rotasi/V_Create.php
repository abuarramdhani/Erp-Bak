<section class="content">
    <div class="inner" >
        <div class="row">
            <form id="MasterPekerja-SuratRotasi-FormCreate" method="post" action="<?php echo site_url('MasterPekerja/Surat/SuratRotasi/add');?>" class="form-horizontal" >
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">Create Surat Rotasi</div>
                                    <div class="box-body">
