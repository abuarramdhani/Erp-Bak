<section class="content">
    ...
    <script>var base_url = '<?php echo base_url() ?>';</script>
        <div class="row">
            <form id="MasterPekerja-SuratDemosi-FormCreate" method="post" action="<?php echo site_url('MasterPekerja/Surat/SuratDemosi/add');?>" class="form-horizontal" >
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">Create Surat Demosi</div>
                                    <div class="box-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select name="txtPekerjaanBaru" class="form-control select2 MasterPekerja-SuratMutasi-DaftarPekerjaan kerja">
                                                                <option value=""></option>
                                                            </select>
                                                        </div>
                                                    </div>
                                           ...
                                           <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <textarea class="ckeditor" name="txaPreview" id="MasterPekerja-SuratDemosi-txaPreview"></textarea>
                                                        </div>
                                                    </div>  
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control" readonly="" name="txtNomorSurat" id="MasterPekerja-SuratDemosi-txtNomorSurat">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control" readonly="" name="txtKodeSurat" id="MasterPekerja-SuratDemosi-txtKodeSurat">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control" style="text-transform: uppercase;" name="txtHalSurat" value="" id="MasterPekerja-SuratDemosi-txtHalSurat">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
