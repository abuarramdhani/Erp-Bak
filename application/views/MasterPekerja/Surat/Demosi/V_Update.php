<section class="content">
    <div class="inner" >
        <div class="row">
            <form id="MasterPekerja-SuratDemosi-FormCreate" method="post" action="<?php echo site_url('MasterPekerja/Surat/SuratDemosi/edit/'.$id);?>" class="form-horizontal" >
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                            ...
                            <div class="col-lg-1 ">
                                <div class="text-right hidden-md hidden-sm hidden-xs">
                                    <a class="btn btn-default btn-lg" href="<?php echo site_url('MasterPekerja/Surat/SuratDemosi/');?>">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">Update Surat Demosi</div>
                                    <div class="box-body">
                                        <div class="panel-body">
                                            <div class="row">
                                            </div>
                                            <?php
                                                foreach ($editSuratDemosi as $edit) 
                                                {
                                            ?>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="select2" name="txtNoind" id="MasterPekerja-SuratDemosi-DaftarPekerja" style="width: 100%" readonly>
                                                   ...
                                                   <!--  <div class="form-group">
                                                        <label for="cmbNoind" class="col-lg-4 control-label">Nomor Induk</label>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control" name="txtNoind" readonly="" id="MasterPekerja-SuratDemosi-DaftarPekerja" value="<?php echo $edit['noind'];?>">    
                                                        </div>
                                                    </div> -->
                                                </div>
                                                <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select name="txtGolonganPekerjaanBaru" class="form-control select2" id="MasterPekerja-SuratDemosi-DaftarGolongan">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select name="txtPekerjaanBaru" class="form-control select2" id="MasterPekerja-SuratDemosi-DaftarPekerjaan">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <div class="col-lg-2 text-right">
                                                            <a id="MasterPekerja-SuratDemosi-btnPreview" title="Preview" class="btn btn-info">Preview</a>
                                                        </div>
                                                        <div class="col-lg-10">
                                                            <textarea class="ckeditor" name="txaPreview" id="MasterPekerja-SuratDemosi-txaPreview">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control" readonly="" name="txtNomorSurat" id="MasterPekerja-SuratDemosi-txtNomorSurat" value="<?php echo $edit['no_surat'];?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control" readonly="" name="txtKodeSurat" id="MasterPekerja-SuratDemosi-txtKodeSurat" value="<?php echo $edit['kode'];?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control" style="text-transform: uppercase;" name="txtHalSurat" id="MasterPekerja-SuratDemosi-txtHalSurat" value="<?php echo $edit['hal_surat'];?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
