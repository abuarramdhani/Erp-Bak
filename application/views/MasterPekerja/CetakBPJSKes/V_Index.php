    ...
    <div class="panel-group">
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 style="text-align: right;">Cetak Tanda Terima BPJS Kesehatan</h3>
        </div>
            ...
            <table id="tbl_datacetak" class="table table-hover table-bordered table-responsive">
              <thead>
                <tr>
                  ...
                  <th style="text-align: center;">No Kes</th>
              ...
              <tbody>
                ...
                foreach ($data as $key ) {
                  ...
                  <tr>
                    ...
                    <td><?php echo $key['no_kes']?></td>
                    <td align="center"><a href="<?php echo base_url('MasterPekerja/TanTerBPJSKes/delete'.'/'.$id);?>"><span class="glyphicon glyphicon-trash"></span></a></td>
                  </tr>
                  <?php
                  $no++;
                }
         ...
         <div class="modal fade" id="modalCetakBPJSKes" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
           <div class="modal-dialog" role="document">
             <div class="modal-content">
               ...
               <form method="POST" action="<?php echo base_url('MasterPekerja/TanTerBPJSKes/insert');?>">
