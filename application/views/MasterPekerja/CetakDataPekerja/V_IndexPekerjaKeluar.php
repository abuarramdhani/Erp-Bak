        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-lg-12">
                            <div class="text-right"><h1> <b>Export Data Pekerja Keluar</b></h1></div>
                        </div>
                    </div>
                </div>
                <br/>
                ...
                <div class="row">
                   <div class="col-lg-12" style="padding-top: 20px;">
                      <div class="col-lg-8" align="right">
                          <button class="btn btn-primary btn-preview" type="submit"><i class="fa fa-eye"></i>&nbsp;Preview</button>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="panel box-body">
              <div class="row">
                <div class="col-lg-12">
                  <h4><b>Data Pekerja Keluar CV. Karya Hidup Sentosa</b></h4>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-12">
              ...
              <div class="row">
                ...
                <div class="table-responsive">
                  <table id="tbl_datapkjkeluar" class="table table-striped table-bordered table-hover">
...
$(document).ready(function(){
  ...
  $(".btn-excel").on('click',function(){
    $("#formExport").attr('action','<?php echo base_url('MasterPekerja/CetakPekerjaKeluar/exportExcel'); ?>');
    $("#formExport").submit()
  });
  ...
  $(".btn-preview").on('click',function(){
    ...
    $("#formExport").attr('action','<?php echo base_url('MasterPekerja/CetakPekerjaKeluar/preview'); ?>');
    $("#formExport").submit()
  });
