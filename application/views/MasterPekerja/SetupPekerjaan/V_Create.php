                                    ...
                                    <form class="form-horizontal" method="post" action="<?php echo site_url('MasterPekerja/SetupPekerjaan/create'); ?>">
                                        <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <select name="cmbBidang" data-placeholder="Bidang" class="select2 setupPekerjaan-cmbBidang" style="width: 100%">
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <select name="cmbUnit" data-placeholder="Unit" class="select2 setupPekerjaan-cmbUnit" style="width: 100%">
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <select name="cmbSeksi" data-placeholder="Seksi" class="select2 setupPekerjaan-cmbSeksi" style="width: 100%">
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-4">
                                                             <input type="text" name="txtKodeUrut" class="form-control" id="txtKodeUrut" >
                                                        </div>
                                                     </div> 
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-6">
                                                             <input type="text" name="txtPekerjaan" class="form-control" id="txtPekerjaan" >
                                                        </div>
                                                     </div>     
                                                     <div class="form-group">
                                                        <label for="txtLearningPeriode" class="col-lg-2 control-label">Learning Periode</label>
                                                         <div class="form-group">
                                                        <div class="col-lg-2">
                                                             <input type="text" name="txtLearningPeriodelama" class="form-control" id="txtLearningPeriodelama" >
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="txtJenisBaju" class="col-lg-2 control-label">Jenis Baju</label>
                                                         <div class="col-lg-10">
                                                          <label style="padding-left: 0px;" class="radio-inline"><input type="radio" name="rd_kancing" checked="true"
                                                         ...
                                                         <label style="padding-left: 0px;"class="radio-inline"><input type="radio" name="rd_kancing" value="Kancing Lengan Panjang "> Kancing Lengan Panjang 
                                                          ...
                                                          <input type="radio" name="rd_kancing" 
