                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <input type="text" name="txtKodeUrut" class="form-control" id="txtKodeUrut" value ="<?php echo $edit['kdpekerjaan']; ?>" >
                                                        </div>
                                                     </div> 
                                                     <div class="form-group">
                                                        <label for="txtPekerjaan" class="col-lg-2 control-label">Pekerjaan</label>
                                                        <div class="col-lg-6">
                                                              <input type="text" name="txtPekerjaan" class="form-control" id="txtPekerjaan" value ="<?php echo $edit['pekerjaan']; ?>" >
                                                        </div>
                                                     </div>    
                                                     <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        <label for="txtJenisPekerjaan" class="col-lg-2 control-label">Jenis Pekerjaan</label>
                                                         <div class="col-lg-6">
                                                          ...
                                                          <input type="radio" name="rd_labour"  <?php if($edit['jenispekerjaan'] == 'f'){ echo "checked";} ?> value="false"> Direct Labour</label>
                                                         <label style="padding-left: 0px;" class="radio-inline"><input type="radio" name="rd_labour" <?php if($edit['jenispekerjaan'] == 't'){ echo "checked";} ?> value="true"> Indirect Labour </label>
                                                         </div>
                                                    </div>  
                                                    <div class="form-group">
                                                        <label for="txtJenisBaju" class="col-lg-2 control-label">Jenis Baju</label>
                                                         <div class="col-lg-10">
                                                          <label style="padding-left: 0px;" class="radio-inline"><input type="radio" name="rd_kancing" <?php if($edit['jenisbaju'] == 'Kancing Lengan Pendek'){ echo "checked";} ?>
                                                          value="Kancing Lengan Pendek"> Kancing Lengan Pendek</label>
                                                         <label style="padding-left: 0px;"class="radio-inline"><input type="radio" name="rd_kancing" <?php if($edit['jenisbaju'] == 'Kancing Lengan Panjang'){ echo "checked";} ?> value="Kancing Lengan Panjang "> Kancing Lengan Panjang 
                                                         </label>
                                                          <label style="padding-left: 0px;" class="radio-inline">
                                                          <input type="radio" name="rd_kancing" <?php if($edit['jenisbaju'] == 'Kancing Rekat Panjang'){ echo "checked";} ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="txtJenisCelana" class="col-lg-2 control-label">Jenis Celana</label>
                                                         <div class="col-lg-6">
                                                          <label style="padding-left: 0px;" class="radio-inline"><input type="radio" name="rd_celana" <?php if($edit['jeniscelana'] == 'Celana Krem'){ echo "checked";} ?> value="Celana Krem"> Celana Krem</label>
