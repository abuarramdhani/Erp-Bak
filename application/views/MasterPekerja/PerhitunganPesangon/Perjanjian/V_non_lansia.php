...
<div style="width: 100%;padding-right: 20px;padding-left: 20px">
  ...
  <p style="text-align: center; font-size: 15px; font-family: times; line-height:1px;"><b>KARENA NON USIA LANJUT</b></p>
	<br>
  ...
  <table style="border: 1px solid black; width: 100%">
    ...
    <tr>
      ...
      <td style="border-right:1px solid black; border-bottom: 1px solid black; width:10px; text-align: center font-size: 14px; font-family: times; text-align: center;" valign="top">:</td>
			<td style="width:5px; border-bottom: 1px solid black;"></td>
			<td style="border-bottom: 1px solid black; font-size: 14px; font-family: times; text-align: justify;">Menyadari sepenuhnya rencana Perusahaan dan bersedia di-PHK karena Non Usia Lanjut secara Bipartit<hr width="40%" style="margin-bottom: 0.5em; margin-right: auto;"></td>
    </tr>
    <tr>
      <td style="border-right:1px solid black; border-bottom: 1px solid black; width:20px; font-size: 14px; font-family: times; text-align: center;"></td>
      ...
      <td style="border-right:1px solid black; border-bottom: 1px solid black; width:10px; text-align: center font-size: 14px; font-family: times; text-align: center;" valign="top">:</td>
			<td style="width:5px; border-bottom: 1px solid black;"></td>
			<td style="border-bottom: 1px solid black; font-size: 14px; font-family: times; text-align: justify;">Melaksanakan proses PHK Non Usia Lanjut secara Bipartit<hr width="40%" style="margin-right: auto; margin-bottom: 0.5em;"></td>
    </tr>
    <tr>
      <td style="height: 15px; border-right: 1px solid black; border-bottom: 1px solid black;"></td>
      <td style="height: 15px; border-right: 1px solid black; border-bottom: 1px solid black;"></td>
