...
<div style="width: 100%;padding-right: 20px;padding-left: 20px">
  ...
  <table style="border: 1px solid black; width: 100%">
    ...
    <tr>
      ...
      <td style="border-right:1px solid black; border-bottom: 1px solid black; width:10px; text-align: center font-size: 14px; font-family: times; text-align: center;" valign="top">:</td>
			<td style="width:5px; border-bottom: 1px solid black;"></td>
			<td style="border-bottom: 1px solid black; font-size: 14px; font-family: times; text-align: justify;"><b><?php echo $jenis ?> <?php echo ucwords(strtolower($key['nama'])).'('.$key['noind'].')' ?></b> akan diputus Hubungan Kerja (PHK) karena Usia Lanjut Dipercepat oleh Perusahaan, dan sesuai dengan pasal 14 ayat (15) Perjanjian Kerja Bersama CV. Karya Hidup Sentosa, sehingga hubungan kerja dengan Perusahaan berakhir pada tanggal <b><?php echo date('d').' '.$month.' '.date('Y') ?></b></td>
    </tr>
    <tr>
      <td style="height: 15px; border-right: 1px solid black; border-bottom: 1px solid black;"></td>
      <td style="height: 15px; border-right: 1px solid black; border-bottom: 1px solid black;"></td>
