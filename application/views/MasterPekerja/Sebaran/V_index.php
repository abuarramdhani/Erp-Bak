												...
												<?php 
													if (isset($sebaran_pusat) && !empty($sebaran_pusat)) {
														...
														foreach ($sebaran_pusat as $sbr) {
															?>
															<div id="tagged<?php echo $nomor ?>" class="tag1" style="top: <?php echo $sbr['posY'] ?>px; left: <?php echo $sbr['posX'] ?>px;background: <?php echo $sbr['color'] ?>;" data-toggle="popover" title="<?php echo $sbr['title'] ?>" data-content="
															    <b style='color: red'>merah   : <?php echo $sbr['merah'] ?></b><br>
																<b style='color: blue'>biru    : <?php echo $sbr['biru'] ?></b><br>
															    <b style='color: grey'>abu-abu : <?php echo $sbr['abu'] ?></b><br>
																" data-html="true" data-placement="top" role="button" tabindex="0">
...
<script type="text/javascript">
	function clickcoordp(event){
		...
		console.log("top: " + pos_y + "px; left: " + pos_x + "px;");
	}
