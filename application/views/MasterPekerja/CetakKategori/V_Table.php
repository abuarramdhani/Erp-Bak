    ...
    <tbody>
        ...
        ?>
                    <tr>
                        ...
                        if (in_array("to_char(tgllahir", $select)) {
                        ...
                        if (in_array("to_char(tglnikah", $select)) {
                        ...
                        if (in_array("to_char(masukkerja", $select)) {
                            echo "<td>" . $val['masukkerja'] . "</td>";
                        }
                        if (in_array("to_char(diangkat", $select)) {
                            echo "<td>" . $val['diangkat'] . "</td>";
                        }
                        if (in_array("tp.lmkontrak", $select)) {
                            echo "<td>" . $val['lmkontrak'] . "</td>";
                        }
                        if (in_array("to_char(akhkontrak", $select)) {
                            echo "<td>" . $val['akhkontrak'] . "</td>";
                        }
                        if (in_array("to_char(tglkeluar", $select)) {
                        ...
                        if (in_array("to_char(tb.tglakhir", $select)) {
                        ...
                        if (in_array("to_char(ttk.tglakhir", $select)) {
