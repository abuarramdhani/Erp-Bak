	...
	<div class="inner"  style="padding-top: 50px">
		<div class="box box-info">
			<div class="box-header with-border">
				<h3><b><center>ADD TO DO</center></b></h3>
			...
			<div class="box-body">
				<div class="row">
				<form method="post" action="<?php echo base_url('ProductionEngineering/Order/add')?>">
					<div class="col-md-4">
							<label>TO DO</label>
					</div>
					<div class="col-md-8">
					<div class="form-group">
						<input type="text" name="textOrder_" class="form-control" required>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-8">
						<div class="form-group">
						<input type="text" name="textDeskripsiOrder" class="form-control" required>
						</div>
					</div>
				</div>
