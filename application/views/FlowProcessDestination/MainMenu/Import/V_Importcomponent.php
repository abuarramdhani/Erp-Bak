					...
					<div class="col-lg-12" >
						<div class="box box-primary box-solid">
							<div class="box-header with-border">
								<button class="btn btn-md btn-primary"><b>Import Component</b></button>
							</div>
							<div class="box-body">
                                <center>
								<br><br>
									<table style="border: none;">
										<tr>
											<form method="post" class="import_excel" id="import_excel" enctype="multipart/form-data" action="<?= base_url(); ?>FlowProcessDestination/Import/importcomponent">
											<td>
												<div class="col-md-1"> 
											...
											<td>
												<div class="col-md-1">
													<button type="submit" name="import_excel" class="btn btn-md bg-blue" id="import_excel_btn">IMPORT EXCEL</button>
												</div>
											</td>
											<!-- <td>
												<div class="col-md-1">
