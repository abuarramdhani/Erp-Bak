					...
					<div class="col-lg-12" >
						<div class="box box-primary box-solid">
							<div class="box-header with-border">
								<button class="btn btn-md  btn-primary btnFrmFPDHome2"><b>Form Search Product</b></button>
							...
							<div class="box-body" style="min-height: 350px" >
								<div class="col-lg-12 ndas">
									...
									<div class="col-lg-6">
									<select class="slc2 focus slcProductFPD2" style="width: 100%" name="slcProductFPD" data-placeholder="Search By Product Code / Desciption .." >
										<option></option>
