								...
								<tbody>
									...
									?>
										...
										<tr>
											...
											<td align="center">
												<a target="blank_" data-toggle="tooltip" id="btn-reg-person" title="list registered people" href='<?php echo site_URL() ?>PresenceManagement/Monitoring/Connect/<?php echo $encrypted_string ?>' class="btn bg-navy btn-xs"><i class="fa fa-group"></i></a>
												<a target="blank_" title="Change Name Location Device" data-toggle="modal" data-filter="<?php echo $data_device['id_lokasi']; ?>" data-id="<?php echo $data_device['lokasi']; ?>" class="modalchangelocationname btn bg-maroon btn-xs"  href="#confirm-change-location"><i class="fa fa-edit"></i></a>
												<a target="blank_" data-toggle="tooltip" id="btn-reg-person" title="Refresh Database" href='<?php echo site_URL() ?>PresenceManagement/Cronjob/Refresh_Database/<?php echo $encrypted_string ?>' class="btn bg-green btn-xs btn-refresh-db"><i class="fa fa-refresh"></i></a>
												<a target="blank_" data-toggle="tooltip" id="btn-reg-person" title="Update Seksi" href='<?php echo site_URL() ?>PresenceManagement/Cronjob/UpdateSection/<?php echo $encrypted_string ?>' class="btn bg-orange btn-xs btn-refresh-db"><i class="fa fa-sitemap"></i></a>
												<a target="blank_" data-toggle="tooltip" title="Change setting device" href='<?php echo site_URL() ?>PresenceManagement/Monitoring/SettingDev/<?php echo $encrypted_string ?>' class="btn bg-purple btn-xs"><i class="fa fa-cogs"></i></a>
												<a target="blank_" title="Check Miss Distribution Presence" data-toggle="modal" data-filter="<?php echo $data_device['id_lokasi']; ?>" data-id="<?php echo $data_device['lokasi']; ?>" class="distribusi-presensi btn bg-red btn-xs"  href="#distribusi-presensi"><i class="fa fa-history"></i></a>
