        ...
        <div class="col-lg-12">
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h4 style="font-weight:bold;"><i class="fa fa-hourglass-3"></i> Record Terlambat Transact</h4>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12" style="margin-top:10px">
                            <div class="box-body" style="background:#ffffff !important; border-radius:7px;margin-bottom:15px;">
                                        ...
                                        <table class="table table-striped table-bordered table-hover text-left history_mtt" style="font-size:11px;">
                                            <thead>
                                                <tr class="bg-primary">
                                                    ...
                                                    <th class="text-center" colspan="3" style="vertical-align:middle">Alasan</th>
                                                    <!-- Alasan terlambat -->
                                                </tr>
                                                <tr class="bg-primary">
                                                    ...
                                                    <th class="text-center" style="border-top:0px;">Alasan</th>
                                                    <th class="text-center" style="border-top:0px;">PIC</th>
                                                    <th class="text-center" style="border-top:0px;">Tgl Input</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php foreach ($get as $key => $g) :
                                                    ...
                                                    <tr data-mtt="<?php echo $g['LINE_ID'] ?>">
                                                        ...
                                                        <td class="text-center">
                                                            <span id="alsn_<?php echo $g['LINE_ID'] ?>"><?php echo $g['ALASAN'] ?></span>
                                                        </td>
                                                        <td class="text-center">
                                                            <span id="alsn_<?php echo $g['LINE_ID'] ?>"><?php echo $g['PIC_ALASAN'] ?></span>
                                                        </td>
                                                        <td class="text-center">
                                                            <span id="alsn_<?php echo $g['LINE_ID'] ?>"><?php echo $g['TGL_INPUT_ALASAN'] ?></span>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                ...
                                <?php } else { ?>
                                    <center>
                                        <h3>Tidak Ada BTAG/MO Terlambat Transact</h3>
                                        <center>
                                        <?php } ?>
                            </div>
                        </div>
