                                ...
                                <table class="table table-striped table-bordered table-hover text-left " id="dataTables-PengSistem" style="font-size:12px; width:max-content;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr row-id="<?php echo $row['id']?>">
                                            ...
                                            <td><a onmouseover="link_um(<?php echo $row['id']?>)" id="um_lilola<?php echo $row['id']?>" data-toggle="tooltip" title="<?= $row['file']; ?>" href="<?php echo base_url('assets/upload/PengembanganSistem/um').'/'.$row['file'];?>" target="_blank"><?php if ($row['file'] != "" ) {echo '<i class="far fa-file-pdf"> View</i>'; } ?></a>
                                            </td>
