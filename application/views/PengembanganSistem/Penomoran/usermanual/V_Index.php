                                ...
                                <table class="table table-striped table-bordered table-hover text-left " id="dataTables-PengSistem" style="font-size:12px;">
                                  ...
                                  <tbody>
                                        ...
                                        <tr row-id="<?php echo $row['id']?>">
                                            ...
                                            <td><a data-toggle="tooltip" title="<?= $row['file']; ?>" href="<?php echo base_url('assets/upload/Peng.Sistem/um').'/'.$row['file'];?>" target="_blank"><?php if ($row['file'] != "" ) {echo '<i class="far fa-file-pdf"> View</i>'; } ?></a>
                                            </td>
