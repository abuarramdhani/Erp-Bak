                            ...
                            <div class="box-body">
                              <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover text-left " id="dataTables-PengSistem" style="font-size:12px;">
                                    <thead>
                                        <tr class="bg-info">
                                            <th style="vertical-align: middle; max-width: 1%">No.</th>
                                            <th style="vertical-align: middle; max-width: 10%">No. Dokumen</th>
                                            <th style="vertical-align: middle; max-width: 25%">Judul Dokumen</th>
                                            <th style="vertical-align: middle; max-width: 80px">Oracle / Android / Web Base / Form</th>
                                            <th style="vertical-align: middle; max-width: 60px">Rev. Date</th>
                                            <th style="vertical-align: middle; max-width: 60px">No. Rev.</th>
                                            <th style="vertical-align: middle; max-width: 10%">SOP</th>
                                            <th style="vertical-align: middle; max-width: 10%">PIC</th>
                                            <th style="vertical-align: middle; max-width: 5%">File</th>
                                            <th style="vertical-align: middle; max-width: 10%">Status</th>
                                            <th style="vertical-align: middle; max-width: 15%">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
