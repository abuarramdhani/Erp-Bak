    ...
    <div class="inner" >
        <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form method="post" action="<?php echo base_url('PengembanganSistem/Input_fp') ?>" class="form-horizontal">
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-lg-6">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-lg-8">
                                                          <input type="number" required="" min="00" max="10000" name="number_rev_fp" id="number_rev-fp" class="form-control" placeholder="input nomor revisi doc">
                                                      </div>
                                                  </div>
                                                  <div class="form-group row">
                                ...
                                <div class="box-body">
                                  <div class="table-responsive">
                                    ...
                                    <?php $no= 1; foreach ($listdatafp as $row) { ?>
                                        ...
                                        <td><a data-toggle="tooltip" title="<?= $row['file'];?>" href="<?php echo base_url('assets/upload/Peng.Sistem/fp').'/'.$row['file'];?>" target="_blank"><?php if ($row['file'] != "" ) {echo '<i class="far fa-file-pdf"> View</i>'; } ?></a>
                                        </td>
