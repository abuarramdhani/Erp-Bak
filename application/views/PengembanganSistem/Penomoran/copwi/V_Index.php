                                  ...
                                  <table class="table table-striped table-bordered table-hover text-left " id="dataTables-PengSistem" style="font-size:12px;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr row-id="<?php echo $row['id']?>">
                                            ...
                                            <td><a data-toggle="tooltip" title="<?= $row['file']; ?>" href="<?php echo base_url('assets/upload/Peng.Sistem/copwi').'/'.$row['file'];?>" target="_blank"><?php if ($row['file'] != "" ) {echo '<i class="far fa-file-pdf"> View</i>'; } ?></a>
                                            </td>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <form class="form-validate form-horizontal " method="post" action="<?php echo base_url().'PengembanganSistem/upload_file_cop_wi/'.$row['nomor_doc']; ?>" enctype="multipart/form-data">
                                                    <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                       ...
                                                       <input name="judul_cop_wi" hidden="" value="<?=$row["judul_doc"]; ?>">
                                                    <div class="form-group">
