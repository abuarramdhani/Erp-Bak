<section class="content">
    <div class="inner" >
        <div class="row">
            <form method="post" action="<?php echo base_url().'PengembanganSistem/update_cop_wi/'.$listdatacw[0]['nomor_doc'] ?>" class="form-horizontal" enctype="multipart/form-data">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <input type="number" min="00" max="1000" name="number_sop_cw" value="<?= $listdatacw[0]['number_sop'];?>" class="form-control" id="nomor_sop_cw" oninput="nomor_cop_wi_ps()" placeholder="00" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
