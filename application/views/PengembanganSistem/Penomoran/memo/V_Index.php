                                ...
                                <table class="table table-striped table-bordered table-hover text-left " id="dataTables-PengSistem" style="font-size:12px;">
                                  <thead>
                                    ...
                                    <?php $no= 1; foreach ($listdata_memo as $row) { ?>
                                        ...
                                        <td><a data-toggle="tooltip" title="<?= $row['file'];?>" href="<?php echo base_url('assets/upload/Peng.Sistem/memo').'/'.$row['file'];?>" target="_blank"><?php if ($row['file'] != "" ) {echo '<i class="far fa-file-pdf"> View</i>'; } ?></a>
                                        </td>
                                        <td>
