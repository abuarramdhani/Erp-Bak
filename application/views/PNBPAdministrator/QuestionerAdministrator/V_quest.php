					...
					<div class="col-lg-12">
						<?php if (isset($question) and !empty($question)) { ?>
							<div class="box box-primary box-solid">
								...
								<div class="box-body">
									<?php 	
										$encrypted_string = $this->encrypt->encode($id_kelompok." - ".$noind);
	            						$encrypted_string = str_replace(array('+', '/', '='), array('-', '_', '~'), $encrypted_string); 
	            					?>
									<form method="POST" action="<?php echo site_url('PNBP/QuestionerAdmin/Quest/'.$encrypted_string) ?>">
										<div class="row">
											<div class="col-lg-12">
								...
								if (isset($selesai) and $selesai == "selesai") {	?>
									<div class="box box-solid box-primary">
										...
										<div class="box-body">
											<div class="row">
												<div class="col-lg-12">
													<form method="POST" action="<?php echo site_url('PNBP/QuestionerAdmin/Save') ?>">
														<div class="form-group text-center">
															<p>
																Anda Yakin ingin menyimpan jawaban questioner ?
																<input type="hidden" name="txtPNBPNoind" value="<?php echo $noind ?>">
															</p>
														</div>
														<div class="form-group text-center">
															<button type="submit" class="btn btn-success">Ya</button>
															<a href="<?php echo site_url('PNBP/QuestionerAdmin') ?>" class="btn btn-danger">Tidak</a>
														</div>
													</form>
												</div>
											</div>
