	...
	<div style="padding-top: 10px">
		...
		<?php foreach($search as $search_item){ ?>
			<tr>
				...
				<td style="width:80%;"><input class="form-control" name="parameter" value="<?php echo $search_item['parameter']; ?>" type="text"/></td>
			</tr>
			<tr>
				<td style="width:20%;">Value</td>
				<td style="width:80%;"><input class="form-control" name="value" value="<?php echo $search_item['value']; ?>" type="text"/></td>
			</tr>
			<?php } ?>
			<tr>
				<td>
