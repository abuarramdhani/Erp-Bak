					...
					<div class="col-lg-12">
						<div class="box box-primary box-solid">
							<div class="box-header with-border">
								<h3 class="fa fa-calendar">&emsp;Monitoring Evaluasi Pekerja Staf</h3>
							...
							<div class="box-body">
								<ul class="nav nav-tabs nav-justified">
									<li class="active"><a data-toggle="pill" href="#staf">Kontrak Staf</a></li>
									<li><a data-toggle="pill" href="#tkpw">Kontrak Staf TKPW</a></li>
								</ul>
								<br>
								<div class="tab-content">
									<!-- Kontrak Staf -->
									<div id="staf" class="tab-pane fade in in active">
										<div class="col-lg-12 bg-info text-center" style=" margin-bottom: 30px;">
											<label class="text-center" style="font-size: 16px;">Status : KONTRAK STAF</label>
										</div>
										<table class="table table-bordered table-responsive-xs table-sm" style="width: 100%;" id="EPNS_Monitoring_kns">
											...
											<tbody>
												<?php
												if (empty($monitoring_staf)) {  }else {
													$no = 1;
													$nowcolor = 0;
													$preview = $monitoring_staf['0']['tgl_masuk'];
													foreach ($monitoring_staf as $key) {
									...
									<!-- KONTRAK STAF TKPW-->
									<div id="tkpw" class="tab-pane fade in">
										<div class="col-lg-12 bg-info text-center" style=" margin-bottom: 30px;">
											<label class="text-center" style="font-size: 16px;">Status : KONTRAK STAF TKPW</label>
										</div>
										<table class="table table-bordered table-responsive-xs table-sm" style="width: 100%;" id="EPNS_Monitoring_staf">
											<thead>
												<tr style="background-color: #3c8dbc !important; color:white;">
													<th class="text-center" style="white-space: nowrap;">No</th>
													<th class="text-center" style="white-space: nowrap;">Action</th>
											...
											<tbody>
												<?php
												if (empty($monitoring_tkpw)) {  }else {
													$no = 1;
													$nowcolor = 0;
													$preview = $monitoring_tkpw['0']['tgl_masuk'];
													foreach ($monitoring_tkpw as $key) {
															$encrypt = $this->encrypt->encode($key['id']);
															$encrypt = str_replace(array('+', '/', '='), array('-', '_', '~'), $encrypt);
															$color = ['', 'coloring_tabel', 'coloring_tabel1'];
														?>
						...
						<div class="box box-primary box-solid ">
							...
							<div class="box-body">
								<div class="col-lg-12" style="margin-bottom: 30px;">
									...
									<div class="col-lg-1">
										<button type="button" name="cari_pekerja" class="btn btn-primary glyphicon glyphicon-search" id="EPNS_cari_pekerja_staf"></button>
									</div>
								</div>
