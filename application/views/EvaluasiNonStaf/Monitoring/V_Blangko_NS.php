<div class="row">
  ...
  <table style="width: 100%; border-collapse: collapse; font-size: 12px; font-family: times;">
    ...
    <tr>
      <td colspan="13" align="center" style="font-face: times; font-size:18px;"><b>EVALUASI PEKERJA KONTRAK NON STAF</b></td>
    </tr>
    <tr>
      <td colspan="13" style="height:10px"></td>
    </tr>
    <tr>
      <td colspan="13">Mohon diisi penilaian pekerja Kontrak Non Staf di seksi Bapak/Ibu terhadap beberapa aspek dibawah ini dan dikembalikan ke seksi Recruitment & Selection <b>maksimal 7 hari sebelum masa kontrak berakhir.</b></td>
    </tr>
    <tr>
  ...
  <pagebreak>
    <table style="width: 100%; border-collapse: collapse; font-size: 12px; font-family: times;">
      ...
      <tr>
        <td colspan="13" style="padding-left: 13px">PETUNJUK PENILAIAN CALON PEKERJA KONTRAK NON STAF</td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="13" style="padding-left: 13px">Demikian petunjuk pengisian lembar evaluasi tenaga kerja kontrak non staf. Mohon segera dikembalikan ke Personalia bila telah diisi, maksimal 7 hari sebelum masa orientasi berakhir. Terimakasih.</td>
      </tr>
      <tr>
