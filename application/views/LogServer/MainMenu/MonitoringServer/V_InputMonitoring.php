								...
								<div class="row">
									...
									<div class="col-lg-12" style="margin: 5px">
										<div class="form-group">
												...
												<div class="col-lg-8">
													<select multiple data-placeholder="Pilih Pekerja" class="form-control select2" name="employeeLS[]" style="width: 100%">
														<option></option>
									...
									<div class="col-lg-12" style="margin: 5px">
										<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" placeholder="Input Tanggal" name="dateLS" id="dateLS" class="form-control datepicker" data-date-format="dd-M-yyyy " required/>
												</div>
										</div>
									</div>
									<div class="col-lg-12" style="margin: 5px">
