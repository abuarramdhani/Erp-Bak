                ...
                <div class="">
                    <div class="col-lg-12">
                        <div class="box box-primary box-solid">
                            ...
                            <a href="<?=base_url('PatroliSatpam/web/add_rekap_temuan')?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Tambah</a>
                            </div>
                            <div class="box-body">
                                    ...
                                    <table class="table table-bordered table-hover table-striped text-center pts_tblask">
                                        ...
                                        <tbody>
                                            <?php $x=1; foreach ($list as $key): ?>
                                                <tr>
                                                    <td><?=$x?></td>
                                                    <td data-order="<?=$key['periode']?>">
                                                        <?php 
                                                            $pr = explode(' - ', $key['periode']);
                                                            $d0 = date('d-M-Y', strtotime($pr[0]));
                                                            $d1 = date('d-M-Y', strtotime($pr[1]));
                                                            echo $d0.' - '.$d1;
                                                        ?>
                                                    </td>
