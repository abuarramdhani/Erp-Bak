    ...
    <div class="inner" >
        <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form onkeydown="return event.key != 'Enter';" method="post" action="<?= base_url('DokumenUnit/user_manual/input_data_um') ?>" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input oninput="this.value = this.value.toUpperCase()" type="text" autocomplete="off" name="numberstd" class="form-control" id="um-numberstd" placeholder="nomor dokumen">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input autocomplete="off" type="number" name="number_sop_um" min="00" value="00" required="" class="form-control" id="nomor_sop_um" placeholder="00" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                            ...
                                            <div class="panel-footer">
                                                <div class="row text-right">
                                                    <button type="button" onclick="notif_input_um()" data-toggle="modal" data-target="#modal-default"  data-backdrop="static" data-keyboard="false" class="btn btn-primary btn-rect">Save Data</button>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/.modal -->
                                                ...
                                                <tr row-id="<?php echo $row['id']?>">
                                                    ...
                                                    <div >
                                                            <div class="btn-group" style="width: max-content;<?php if (trim($row["user"]) !== trim($user)) {
                                                                echo 'display : none;';}?>">
                                                            <a class="btn-xs btn btn-success" href="<?php echo base_url('DokumenUnit/user_manual/edit_UM/'.$row['id'])?>" title="Edit"><i class="fa fa-pencil"></i></a>
