                                ...
                                <div class="box-body">
                                    ...
                                    <div class="panel-footer">
                                        <div class="row text-right">
                                            ...
                                            &nbsp;&nbsp;
                                            <button type="button" onclick="notif_edit_flow()" data-toggle="modal" data-target="#modal-default" data-backdrop="static" data-keyboard="false" class="btn btn-primary btn-lg btn-rect">Save Data</button>
                                        </div>
                                    </div>
                                </div>
                                    <!--/.modal -->
