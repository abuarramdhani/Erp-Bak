    ...
    <div class="inner" >
        <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form onkeydown="return event.key != 'Enter';" method="post" action="<?php echo base_url('DokumenUnit/Input_fp') ?>" class="form-horizontal" enctype="multipart/form-data">
                                          ...
                                          <div class="row">
                                              <div class="col-lg-6">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-lg-8">
                                                          <input oninput="this.value = this.value.toUpperCase()" type="text" autocomplete="off" name="numberstd" class="form-control" id="numberflow" placeholder="nomor dokumen">
                                                      </div>
                                                  </div>
                                                  <div class="form-group row">
