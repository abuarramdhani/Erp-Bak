<section class="content">
    <div class="inner" >
        <div class="row">
            <form onkeydown="return event.key != 'Enter';" method="post" action="<?php echo base_url().'DokumenUnit/update_cop_wi/'.$listdatacw[0]['id'] ?>" class="form-horizontal" enctype="multipart/form-data">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="<?= $listdatacw[0]['nomor_doc'];?>" type="text" name="nomor_doc" class="form-control" id="ceknumberdoc">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
