    ...
    <div class="inner" >
        <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                           <form onkeydown="return event.key != 'Enter';" method="post" action="<?= base_url('DokumenUnit/input_cop_wi') ?>" class="form-horizontal" enctype="multipart/form-data">
                                  ...
                                  <div class="box-body">
                                          ...
                                          <div class="row">
                                              <div class="col-lg-6">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-lg-8">
                                                          <input oninput="this.value = this.value.toUpperCase()" type="text" autocomplete="off" name="stdnumbercop" class="form-control" id="ceknumberdoc" placeholder="input nomor dokumen">
                                                      </div>
                                                  </div>
                                                  <div class="form-group row">
                                                  ...
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-lg-8">
                                                          <select name="doccopwi_cw" required="" class="form-control select2" data-placeholder="--PIlih Data--">
                                              ...
                                              <div class="col-lg-6">
                                                  ...
                                                  <div class="form-group row">
                                                      <label for="status_cw" class="control-label col-lg-4">Upload File</label>
                                                      <div class="col-lg-8">
                                      ...
                                      <div class="panel-footer">
                                          <div class="row text-right">
                                              <button type="button" onclick="notif_input_cop_wi()" data-toggle="modal" data-target="#modal-default" data-backdrop="static" data-keyboard="false" class="btn btn-primary btn-rect">Save Data</button>
                                          </div>
                                      </div>
                                  </div>
                                      <!--/.modal -->
                                  ...
                                  <table class="table table-striped table-bordered table-hover text-left " id="dataTables-PengSistem" style="font-size:12px; width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr row-id="<?php echo $row['id']?>">
                                                ...
                                                <td>
                                                    <div class="btn-group" style="width: max-content;<?php if (trim($row["user"]) !== trim($user)) {
                                                        echo 'display : none;';
                                                    }?>">
                                                        <a class="btn btn-xs btn-success" href="<?php echo base_url('DokumenUnit/edit_cop_wi/'.$row['id'])?>" title="Edit"><i class="fa fa-pencil"></i></a>
                                                        <a class="btn btn-xs btn-warning" data-toggle="modal" data-toggle="tooltip" data-target="<?php echo "#modal_edit".$row['id'];?>" data-backdrop="static" data-keyboard="false" title="Upload"><i class="fa fa-cloud-upload"></i></a>
