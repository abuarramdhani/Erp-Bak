<center><label>SPB/DOSP (BEST AGRO) BELUM DILAYANI</label></center>
<div class="table-responsive">
  <div class="panel-body">
    <div class="table-responsive" >
    <table class="datatable table table-bordered table-hover table-striped text-center tblpelayanan" id="tblBest" style="width: 100%;table-layout:fixed">
        ...
        <tbody>
            ...
            ?>
                <tr id="baris<?= $val['NO_DOKUMEN']?>">
                    ...
                    <?php } else { ?>
                        <select id="pic<?= $val['NO_DOKUMEN']?>" name="picspb" class="form-control select2 select2-hidden-accessible picSPBBest" style="width:100%;" required>
                            <option></option>
                        </select>
                    </td>
                    <?php }?>
