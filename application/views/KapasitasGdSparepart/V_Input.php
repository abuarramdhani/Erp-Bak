                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <input type="button" class="btn btn-xs btn-success" id="btnbesc1" name="btn_besc[]" value="Besc" style="color:black;margin-left:10px;width:70px" onclick="btnBescKgs(1)">
                                            </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <input type="button" class="btn btn-xs btn-success" id="btnbesc2" name="btn_besc[]" value="Besc" style="color:black;margin-left:10px;width:70px" onclick="btnBescKgs(2)">
                                            </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <input type="button" class="btn btn-xs btn-success" id="btnbesc3" name="btn_besc[]" value="Besc" style="color:black;margin-left:10px;width:70px" onclick="btnBescKgs(3)">
                                            </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <input type="button" class="btn btn-xs btn-success" id="btnbesc4" name="btn_besc[]" value="Besc" style="color:black;margin-left:10px;width:70px" onclick="btnBescKgs(4)">
                                            </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <input type="button" class="btn btn-xs btn-success" id="btnbesc5" name="btn_besc[]" value="Besc" style="color:black;margin-left:10px;width:70px" onclick="btnBescKgs(5)">
                                            </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <input type="button" class="btn btn-xs btn-success" id="btnbesc6" name="btn_besc[]" value="Besc" style="color:black;margin-left:10px;width:70px" onclick="btnBescKgs(6)">
                                            </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <input type="button" class="btn btn-xs btn-success" id="btnbesc7" name="btn_besc[]" value="Besc" style="color:black;margin-left:10px;width:70px" onclick="btnBescKgs(7)">
                                            </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <input type="button" class="btn btn-xs btn-success" id="btnbesc8" name="btn_besc[]" value="Besc" style="color:black;margin-left:10px;width:70px" onclick="btnBescKgs(8)">
                                            </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <input type="button" class="btn btn-xs btn-success" id="btnbesc9" name="btn_besc[]" value="Besc" style="color:black;margin-left:10px;width:70px" onclick="btnBescKgs(9)">
                                            </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <input type="button" class="btn btn-xs btn-success" id="btnbesc10" name="btn_besc[]" value="Besc" style="color:black;margin-left:10px;width:70px" onclick="btnBescKgs(10)">
                                            </span>
                                            </div>
                                        </div>
                                    </div>
