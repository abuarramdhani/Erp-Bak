                ...
                <tr id="baris<?= $val['NO_DOKUMEN']?>">
                    ...
                    <td class="<?= $td?>">
                      ...
                      <?php if ($val['JENIS_DOKUMEN'] == 'SPB'){ ?>
                        <a href="<?php echo base_url('KapasitasGdSparepart/Cetak/cetakSPB3/'.$val['NO_DOKUMEN'].'_y') ?>" style="margin-top:5px;width:114px;" target="_blank" class="btn btn-danger" ><i class="fa fa-file-pdf-o"> S. No Border</i></a>
                      <?php }elseif ($val['JENIS_DOKUMEN'] == 'DOSP') { ?>
                        <a href="<?php echo base_url('KapasitasGdSparepart/Cetak/cetakDOSP2/'.$val['NO_DOKUMEN'].'_y') ?>" style="margin-top:5px;" target="_blank" class="btn btn-danger" ><i class="fa fa-file-pdf-o">D. No Border</i></a> <br>
                      <?php } ?>
                    </td>
                </tr>
            <?php $no++; $i++; } ?>
