    ...
    <table class="datatable table table-bordered table-hover table-striped text-center" id="tbserah" style="width: 100%;">
        ...
        <?php $no = 1; 
            ...
            <tr data-row="<?= $spb[$i]['MO_NUMBER']?>" data-id="<?= $spb[$i]['ITEM_COLY']?>">
                <td style="align-left" class="<?= $spb[$i]['MO_NUMBER']?>"><input type="hidden" name="jmlscan[]" value="0"><?= $no?></td>           
                ...
                <td class="<?= $spb[$i]['MO_NUMBER']?>"><input type="hidden" name="tujuan[]" value="<?= $spb[$i]['TUJUAN']?>"><?= $spb[$i]['TUJUAN']?></td>       
                ...
                <td style="text-align:left"  class="<?= $spb[$i]['MO_NUMBER']?>"><input type="hidden" name="berat[]" value="<?= $spb[$i]['SUM_WEIGHT']?>"><?= $spb[$i]['SUM_WEIGHT']?></td>      
            </tr>  
        <?php $no++; }  ?>    
        </tbody>
    </table>
