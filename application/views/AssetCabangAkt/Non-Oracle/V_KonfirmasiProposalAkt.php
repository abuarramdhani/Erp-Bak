...
.inputfile + label {
  ...
  <?php echo form_open_multipart('AssetCabangMarketing/ApproveReject/'.$header[0]['id_proposal']) ?>
    <section class="content-header">
      <h1>
        Konfirmasi Proposal <b><?php echo $header[0]['batch_number']?></b><input type="hidden" name="judulProposalNm" id="judulproposalhdnakt" value="<?php echo $header[0]['batch_number']?>"/>
      </h1>
    </section>
    <!-- Main content -->
          ...
          <div class="col-md-8 pull-left">
            ...
            <div class="box-body">
               ...
               <div class="col-md-6 pull-right">
                    ...
                    <button data-toggle="tooltip" data-placement="top" title="Konfirmasi bahwa dokumen sudah diterima dari Marketing" id="btnReceiveAkt" value="4" name="btnReceiveAkt" id="btnReceiveAkt" type="button" onclick="receivedAkuntansi(<?php echo $header[0]['id_proposal'];?>)" class="zoom btn btn-success btn-m pull-right" style="margin-top: 10px; margin-bottom: 20px;margin-left: 20px;width: 100px"><i class="fa fa-check"></i> Received</button>
