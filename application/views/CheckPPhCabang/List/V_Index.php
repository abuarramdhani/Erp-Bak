				...
				<div class="col-lg-12">
					<div class="box box-primary box-solid">
						<div class="box-header with-border">
							<b> Daftar Upload Batch PPH Cabang </b>
						</div>
						<div class="box-body">
							<div>
								<table class="table table-striped table-bordered table-hover text-left  tblDataPPHCabang" >
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<center>
												<form target="_blank" action="<?= base_url('AccountPayables/CheckPPhCabang/List/action') ?>" method="POST">
													...
													<tr>
														<td>
															...
															<button name="jenisAct" value="subPPH" class="btn btn-xs btn-primary btns"> 
																<b class="fa fa-file-text "></b> Lap. Subtotal PPH Cabang
															</button>
														</td>
														...
														<td>
															<button name="jenisAct" value="sumPPH" class="btn btn-xs btn-primary btns"> 
																<b class="fa fa-file-text "></b> Lap. Summary PPH Cabang
															</button>
														</td>
													</tr>
														<td>
															<button name="jenisAct" value="recPPH" class="btn btn-xs btn-primary btns"> 
																<b class="fa fa-file-text "></b> Rekap Laporan PPH Cabang
															</button> 
										...
										<div class="modal fade" id="modalDelete" role="dialog" aria-labelledby="modalDelete" aria-hidden="true">
				                          <div class="modal-dialog" style="min-width:800px;">
				                            ...
				                            <form action="<?= base_url('AccountPayables/CheckPPhCabang/List/action') ?>" method="POST">
