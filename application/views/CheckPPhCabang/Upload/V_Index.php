        ...
        <div class="col-lg-12">
          <div class="box box-deafault">
            <div class="box-header with-border" style="background:#FFF; height: 459px">
              ...
              <div class="row">
                <form id="form_pph_cabang" class="form-inline" method="post" enctype="multipart/form-data" accept-charset="utf-8" action="<?= base_url('AccountPayables/CheckPPhCabang/Upload/proccess') ?>">
