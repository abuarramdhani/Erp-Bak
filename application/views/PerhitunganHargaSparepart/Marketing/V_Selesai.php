        ...
        <div class="col-lg-12 container">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-table"></i> Daftar Selesai</h3>
                        ...
                        <table class="table table-bordered table-hover tblPHSView" style="width: 150%">
                            <thead>
                                <tr class="bg-primary">
                                    ...
                                    <th class="t-head-center">Attachment</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($selesai_rows as $k => $v) : ?>
                                    <tr>
                                        <td><?= $k + 1 ?></td>
                                        <td><?= $v->ORDER_ID ?></td>
                                        ...
                                        <td><?= $v->COMMENTS ?></td>
                                        <td class="text-center"><a class="btn btn-primary btn-sm" href="<?= base_url($v->FILE_SPT) ?>">Download</a></td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
                        </table>
