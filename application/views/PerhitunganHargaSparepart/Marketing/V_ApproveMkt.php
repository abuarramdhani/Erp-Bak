                ...
                <div class="box-body">
                    <div class="panel-body">
                        <table class="table table-bordered table-hover tblPHSViewApproval" style="width: 150%">
                            <thead>
                                <tr class="bg-primary">
                                    <th class="t-head-center"><input type="checkbox" class="CheckSprAllMkt"></th>
                            ...
                            <tbody>
                                <?php foreach ($approvemkt_rows as $k => $v) : ?>
                                    <tr>
                                        <td><input type="checkbox" class="CheckSprlistMkt" data-row="<?= $k ?>"></td>
                                        <td><?= $k + 1 ?></td>
                                        <td><?= $v->ORDER_ID ?><input type="hidden" class="NoOrdermkt" data-row="<?= $k ?>" value="<?= $v->ORDER_ID ?>" /></td>
                                        ...
                                        <!-- <td class="text-center">
                                            <button class="btn btn-success btn-sm" onclick="ApprMktToPIEA(<?= $v->ORDER_ID ?>)">Approve</button>
                                            <button class="btn btn-danger btn-sm" onclick="RejectMkt(<?= $v->ORDER_ID ?>)">Reject</button>
                                        </td> -->
                    ...
                    <div class="panel-body">
                        <div class="col-md-12" style="text-align: right;">
                            <button class="btn btn-success btn-sm" onclick="ApprMktToPIEA()">Approve</button>
                            <button class="btn btn-danger btn-sm" onclick="RejectMkt()">Reject</button>
                        </div>
                        <div class="col-md-2">
                        </div>
                    </div>
