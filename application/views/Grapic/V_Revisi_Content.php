<style type="text/css">html, body { scroll-behavior: smooth; } tbody tr td { height: 60px;/*padding-top: 18px !important;*/ } thead tr th { height: auto; } .fixed-column { position: absolute; background: white; width: 100px; left: 16px; margin-bottom: 2px; } .background-red { background-color: #FF5252; color: white; }</style>
...
<div class="row" id="frame-total-khs-data">
    <div class="box box-primary box-solid">
        ...
        <div id="box-body-data-total-khs" class="box-body" style="padding: 16px; overflow-y: auto; background-color: white;">
            <table class="table table-bordered table-hover text-center" style="overflow-x: scroll; width: 100%; display: block;">
                <thead>
                    ...
                    <tr>
                        ...
                        <?php else: ?>
                            <th class="<?= (($i + 1) % 2 == 0) ? 'bg-primary' : 'bg-orange' ?>" colspan="2"><?= $month ?></th>
                        <?php if($monthListNumber[$i] <= $currentMonth): ?>
                            <th class="<?= (($i + 1) % 2 == 0) ? 'bg-primary' : 'bg-orange' ?>" colspan="2"><?= $currentMonthFormatted ?></th>
                        <?php else: ?>
                            <th class="<?= (($i + 1) % 2 == 0) ? 'bg-primary' : 'bg-orange' ?>" colspan="2">-</th>
                        <?php endif; endif; ?>
                        <?php $i++; endforeach ?>
                    </tr>
                    <tr>
...
<div class="row">
    <div class="box box-primary box-solid">
        ...
        <div id="box-body-data-<?= $department ?>" class="box-body" style="padding: 16px; padding-bottom: 0; overflow-y: auto; background-color: white;">
