									...
									<div id="exTab2" class="container col-md-12">	
										...
										<label for="cmbPilihData" class="control-label col-lg-4 text-right">Pilih Data : </label> 
											...
											<select id="divselector" class="form-control" >
												...
												<option value="3">--Dept. Produksi - Melati</option>
												<option disabled="">=============Dept. Produksi (Pekerja Direct/Indirect Labour=============</option>
												<option value="4">--Dept. Produksi - Pekerja Tidak Langsung / InDirect Labour</option>
												<option value="5">--Dept. Produksi - Pekerja Langsung / Direct Labour</option>
												...
												<option value="25">--Dept. Produksi - Seksi Gudang Produksi Dan Ekpedisi</option>
												<option value="26">--Dept. Produksi - Seksi Gudang Produksi Dan Ekpedisi-TKS</option>
												<option value="27">--Dept. Produksi - Seksi Heat Treatmen-TKS</option>
												<option value="28">--Dept. Produksi - Seksi Lab. Kimia dan Pasir Cetak</option>
												<option value="29">--Dept. Produksi - Seksi Machining 1</option>
												<option value="30">--Dept. Produksi - Seksi Machining A-TKS</option>
												<option value="31">--Dept. Produksi - Seksi Machining B</option>
												<option value="32">--Dept. Produksi - Seksi Machining B-TKS</option>
												<option value="33">--Dept. Produksi - Seksi Machining C</option>
												<option value="34">--Dept. Produksi - Seksi Machining C-TKS</option>
												<option value="35">--Dept. Produksi - Seksi Machining D</option>
												<option value="36">--Dept. Produksi - Seksi Machining D-TKS</option>
												<option value="37">--Dept. Produksi - Seksi Machining E</option>
												<option value="38">--Dept. Produksi - Seksi Machining Prototype</option>
												<option value="39">--Dept. Produksi - Seksi Maintenace</option>
												<option value="40">--Dept. Produksi - Seksi Maintenace-TKS</option>
												<option value="41">--Dept. Produksi - Seksi Maintenace Dan Pengembangan Alat</option>
												<option value="42">--Dept. Produksi - Seksi Maintenace Dan Pengembangan Alat-TKS</option>
												<option value="43">--Dept. Produksi - Seksi Painting Dan Packaging</option>
												<option value="44">--Dept. Produksi - Seksi Painting Dan Packaging-TKS</option>
												<option value="45">--Dept. Produksi - Seksi Penerimaan Barang Gudang</option>
												<option value="46">--Dept. Produksi - Seksi Penerimaan Barang Gudang-TKS</option>
												<option value="47">--Dept. Produksi - Seksi Pengeluaran Barang Gudang</option>
												<option value="48">--Dept. Produksi - Seksi Pengeluaran Barang Gudang-TKS</option>
												<option value="49">--Dept. Produksi - Seksi Pengembangan Prototype A</option>
												<option value="50">--Dept. Produksi - Seksi Pengembangan Prototype B</option>
												<option value="51">--Dept. Produksi - Seksi Pola</option>
												<option value="52">--Dept. Produksi - Seksi Pola/Pattern-TKS</option>
												<option value="53">--Dept. Produksi - Seksi Potong AS</option>
												<option value="54">--Dept. Produksi - Seksi PPC , Gudang dan Administrasi</option>
												<option value="55">--Dept. Produksi - Seksi PPC Tool Making</option>
												<option value="56">--Dept. Produksi - Seksi PPIC</option>
												<option value="57">--Dept. Produksi - Seksi PPIC-TKS</option>
												<option value="58">--Dept. Produksi - Seksi PPIC, Gudang Dan Administrasi-TKS</option>
												<option value="59">--Dept. Produksi - Seksi PPIC Prototype Desain</option>
												<option value="60">--Dept. Produksi - Seksi Production And Inventory ERP Application</option>
												<option value="61">--Dept. Produksi - Seksi Production Engineering</option>
												<option value="62">--Dept. Produksi - Seksi Production Engineering-DOJO</option>
												<option value="63">--Dept. Produksi - Seksi QC Desain, Riset Dan Testing</option>
												<option value="64">--Dept. Produksi - Seksi Quality Assurance</option>
												<option value="65">--Dept. Produksi - Seksi Quality Control</option>
												<option value="66">--Dept. Produksi - Seksi Quality Control-TKS</option>
												<option value="67">--Dept. Produksi - Seksi Quality Engineering</option>
												<option value="68">--Dept. Produksi - Seksi Quality - TKS</option>
												<option value="69">--Dept. Produksi - Seksi Rekayasa Dan Rebuilding Mensin</option>
												<option value="70">--Dept. Produksi - Seksi Riset Dan Testing Alat Uji</option>
												<option value="71">--Dept. Produksi - Seksi Riset Dan Testing Cultivator</option>
												<option value="72">--Dept. Produksi - Seksi Riset Dan Testing Harvester</option>
												<option value="73">--Dept. Produksi - Seksi Riset Dan Testing Pengembangan</option>
												<option value="74">--Dept. Produksi - Seksi Riset Dan Testing PPIC</option>
												<option value="75">--Dept. Produksi - Seksi Riset Dan Testing Quick Truck</option>
												<option value="76">--Dept. Produksi - Seksi Riset Dan Testing Traktor 2W</option>
												<option value="77">--Dept. Produksi - Seksi Riset Dan Testing Traktor 4W</option>
												<option value="78">--Dept. Produksi - Seksi Sheet Metal-TKS</option>
												<option value="79">--Dept. Produksi - Seksi Tool Making 1</option>
												<option value="80">--Dept. Produksi - Seksi Tool Making A</option>
												<option value="81">--Dept. Produksi - Seksi Tool Making B</option>
												<option value="82">--Dept. Produksi - Seksi Tool Warehouse</option>
												<option value="83">--Dept. Produksi - Seksi Tool Warehouse-TKS</option>
												<option value="84">--Dept. Produksi - Seksi Welding A</option>
												<option value="85">--Dept. Produksi - Seksi Welding B</option>
												<option value="86">--Dept. Produksi - Seksi Welding-TKS</option>
