        ...
        <div class="col-lg-12">
          <div class="box box-deafault">
            <div class="box-header with-border" style="background:#FFF; height: 459px">
              ...
              <div class="row">
                <form id="form_pph" class="form-inline" method="post" enctype="multipart/form-data" accept-charset="utf-8" action="<?= base_url('AccountPayables/CheckPPh/Upload/proccess') ?>">
              ...
              <?php if ($errorupd)  { ?>
                                ...
                                <div class="modal fade" id="infoErrorPPh" role="dialog" aria-labelledby="modalDelete" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body" >
                                        <center>
                                          ...
                                          <table class="table table-striped table-bordered tblListErrorPPH">
                                            <thead>
                                              <tr class="bg-info">
                                                <th>No.</th>
                                                <th>Vendor</th>
