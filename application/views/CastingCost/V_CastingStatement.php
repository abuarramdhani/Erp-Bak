		...
		<div class="row" >			
				...
				<table border="1px" style="width: 100% ;border: 1px solid #333; height: 100%" >
						...
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;"> 
							<?php if($data_casting['casting_weight'] != ''){echo number_format($data_casting['casting_weight'], 2).' Kg';}  
									else{ echo "-";}
							?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;"> 
							<?php echo number_format($data_casting['remelt_weight'], 2).' Kg'; ?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;"> 
							<?php echo number_format($data_casting['liquid_weight'], 2).' Kg'; ?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;"> 
							<?php echo number_format($data_casting['yield_casting'], 2).' %'; ?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;">
							 <?php echo number_format($data_casting['scrap_reject'], 2).' %'; ?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;"> 
							<?php echo number_format($data_casting['basic_tonage'], 2).' Kg/Shift '; ?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;"> 
							<?php if($data_casting['material_core'] != ''){echo number_format($data_casting['material_core'], 2);}  
									else{ echo "-";}
							?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;"> 
							<?php if($data_casting['core_weight'] != ''){echo number_format($data_casting['core_weight'], 2).' Kg';}  
									else{ echo "-";}
							?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<?php if($data_casting['target_core'] != ''){echo number_format($data_casting['target_core'], 2).' Pieces/Shift';}  
									else{ echo "-";}
							?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						...
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;"> 
							<?php echo number_format($data_casting['target_mold_pieces'], 2).' Pieces/Shift'; ?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;"> 
							<?php echo number_format($data_casting['cavity'], 2).' cavity'; ?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px">Target Cetak/Shift</td>
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;"> 
							<?php echo number_format($data_casting['target_mold_flask'], 2).' Flask/Shift'; ?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;"> 
							<?php echo number_format($data_casting['sand_mold_weight'], 2).' Kg'; ?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;">
							 <?php echo number_format($data_casting['grindstone'], 2).' Pieces'; ?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;"> 
							<?php echo number_format($data_casting['target_grinding'], 2).' Pieces'; ?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
						<tr style="border:1px solid #333 ;padding: 5px">
							...
							<td style="border:1px solid #333 ;padding: 5px; text-align: center;"> 
							<?php if($data_casting['time_making'] != ''){echo number_format($data_casting['time_making'], 2).' Jam';}  
									else{ echo "-";}
							?></td>
							<td style="border:1px solid #333 ;padding: 5px"></td>
						</tr>
