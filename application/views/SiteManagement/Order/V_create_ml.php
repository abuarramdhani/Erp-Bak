<section class="content">
    <div class="inner" >
        <div class="row">
            <form method="post" action="<?php echo site_url('SiteManagement/Order/createMaintenanceListrik');?>" class="form-horizontal">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <textarea placeholder="Ket Order Detail" name="txtKetOrderDetail" class="form-control"></textarea>
                                                </div>
                                            </div>
