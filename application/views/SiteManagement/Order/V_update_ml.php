<section class="content">
    <div class="inner" >
        <div class="row">
            <form method="post" action="<?php echo site_url('SiteManagement/Order/updateMaintenanceListrik/'.$id);?>" class="form-horizontal">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-11">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
											<div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" placeholder="No Order" name="txtNoOrderHeader" id="txtNoOrderHeader" class="form-control" value="<?php echo $headerRow['no_order']; ?>" required/>
                                                </div>
                                            </div>
