                    ...
                    <div class="col-lg-12">
                        <div class="box box-primary box-solid">
                            <div class="box-header with-border">
                                <h4>Record Data Lantai Parkir Maintenance</h4>
                            </div>
                            <div class="box-body">
                                <div>
                                    <table class="table table-striped table-bordered table-hover text-left sm_datatable" style="font-size:12px;">
                                        ...
                                        <tbody>
                                           <?php $no=1;foreach ($Maintenance as $key):
                                            ...
                                            <tr>
                                                ...
                                                <td align='center'>
                                                    ...
                                                    <a style="margin-right:4px" href="<?php echo site_URL() ?>SiteManagement/RecordData/deleteDataSiteManagement?id=<?php echo $encrypted_string ?>&menu=CeilingFan" data-toggle="tooltip" data-placement="bottom" title="Delete Data" onclick="return confirm('Are you sure you want to delete this item?');"><span class="fa fa-trash fa-2x"></span></a>
                                                </td>
                                                <?php else: ?>
                                                <td><?php echo date('d F Y', strtotime($key['tanggal_jadwal']));?></td>
