	...
	<div class="inner"  style="padding-top: 50px">
		<div class="box box-info">
			<div class="box-header with-border">
				<h3><b><center>ADD TIPE</center></b></h3>
			...
			<div class="box-body">
				<div class="row">
				<form method="post" action="<?php echo base_url('CBOPainting/Setup/Tipe/Add')?>">
					<div class="col-md-4">
							<label>TIPE</label>
					</div>
					<div class="col-md-8">
					<div class="form-group">
						<input type="text" name="textTipe" class="form-control" required>
						</div>
					</div>
				</div>
