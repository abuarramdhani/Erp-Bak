<section class="content">
	<div class="inner" >
		<div class="row">
			...
			<div class="col-md-1">
				<a class="btn btn-default btn-lg" href="<?php echo base_url('CBOPainting/Setup/Komponen/New'); ?>">
	...
	<div class="box box-info">
		<div class="box-body">
			<table id="tablekomponen" class="table table-striped table-bordered table-responsive table-hover" >
				...
				<tbody>
				<?php $no = 1; foreach ($komponen as $cl) { ?>
					<tr>
