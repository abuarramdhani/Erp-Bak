                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-1">
                            <div class="text-right hidden-md hidden-sm hidden-xs">
                                <a class="btn btn-default btn-lg" href="<?php echo site_url('WasteManagement/LimbahTransaksi/ReportHarian');?>">
                    ...
                    <div class="col-lg-12">
                        <div class="box box-primary box-solid">
                            <div class="box-header with-border">
                                <form action="<?php echo site_url('WasteManagement/LimbahTransaksi/FilterDataReportHarian/');?>" method="post" enctype="multipart/form-data">
                                        <div class="col-md-2">
                                        ...
                                        <?php
                                                ...
                                                <?php
                                                    ...
                                                    ?>
                                                    <form method="POST" action="<?php echo site_url('WasteManagement/LimbahTransaksi/cetakExcelHarian/'.$tanggalawallink.'/'.$tanggalakhirlink) ?>";">
