                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-1">
                            <div class="text-right hidden-md hidden-sm hidden-xs">
                                <a class="btn btn-default btn-lg" href="<?php echo site_url('WasteManagement/LimbahTransaksi/ReportBulanan');?>">
                        ...
                        <div class="box box-primary box-solid">
                            <div class="box-header with-border">
                                <form action="<?php echo site_url('WasteManagement/LimbahTransaksi/FilterDataReportBulanan/');?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="input-group">
                                        <?php
                                                if(!empty($LimbahMasuk) && !empty($LimbahKeluar)){
                                                ?>
                                                <?php
                                                }else{
                                                    ...
                                                    ?>
                                                    <form method="POST" action="<?php echo site_url('WasteManagement/LimbahTransaksi/cetakExcelBulanan/'.$tanggalawallink.'/'.$tanggalakhirlink) ?>";">
                                    ...
                                    <div class="table-responsive">
                                        <table class="datatable table table-striped table-bordered table-hover text-left dataTable-limbah" style="font-size:12px;">
                                            ...
                                            <tbody>
                                                <?php 
                                                    $no = 1;
                                                    if(!isset($LimbahMasuk)){
                                                        $data_item = $filterMasuk;
                                                    }else{
                                                        $data_item = $LimbahMasuk;
                                                    } 
                                    ...
                                    <div class="table-responsive">
                                        <table class="datatable table table-striped table-bordered table-hover text-left dataTable-limbah" style="font-size:12px;">
                                            ...
                                            <tbody>
                                                <?php 
                                                    $no = 1;
                                                    if(!isset($LimbahKeluar)){
                                                        $data_item = $filterKeluar;
                                                    }else{
                                                        $data_item = $LimbahKeluar;
                                                    }  
                                                    foreach($data_item as $row):
                                                ?>
                                                <tr>
