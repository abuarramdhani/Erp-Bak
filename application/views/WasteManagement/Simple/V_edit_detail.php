			...
			<div class="col-lg-12">
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="col-lg-1 text-right">
							<a href="<?php echo site_url('WasteManagement/Simple/Read/'.$SimpleDetail['0']['id_simple']) ?>" class="btn btn-default btn-lg">
				...
				<div class="row">
					<div class="box box-primary box-solid">
						...
						<div class="box-body">
							<form method="POST" action="<?php echo site_url('WasteManagement/Simple/Edit_Detail/'.$DetailId); ?>" class="form-horizontal">
								<div class="panel-body">
									<div class="col-lg-12">
										...
										<div class="form-group">
											...
											<div class="col-lg-4">
												<input type="text" class="form-control" name="txtTanggalDihasilkan" id="txtTanggalDihasilkan" class="date form-control" placeholder="<?php echo date('d M Y')?>" data-date-format="yyyy-mm-dd" value="<?php echo $SimpleDetail['0']['tanggal_dihasilkan'] ?>" required>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-lg-4">Kode Manifest</label>
											<div class="col-lg-4">
												<input type="text" class="form-control" name="txtManifest" value="<?php echo $SimpleDetail['0']['kode_manifest'] ?>" required>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-lg-4">
												<div class="input-group">
													<input type="text" class="form-control" name="txtJumlah" value="<?php echo $SimpleDetail['0']['jumlah'] ?>" required>
										...
										<div class="form-group">
											...
											<div class="col-lg-4">
												<textarea class="form-control" name="txtCatatan" style="width:100%;"><?php echo $SimpleDetail['0']['catatan'] ?></textarea>
											</div>
										</div>
										<div class="form-group">
