          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div style="float:right">
                <a style="float:right;border:1.5px solid white;" href="<?php echo base_url('RunningTimeLinePnP/setting/history') ?>" class="btn btn-primary"><i class="fa fa-hourglass-3"></i> History</a>
              </div>
            </div>
          </div>
        </div>
