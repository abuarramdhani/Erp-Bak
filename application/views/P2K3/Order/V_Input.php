                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-1">
                        <div class="text-right hidden-md hidden-sm hidden-xs">
                            <a class="btn btn-default btn-lg" href="<?php echo site_url('P2K3/Order/input');?>">
                                ...
                                <div class="box-body">
                                                        ...
                                                        <div class="tab-pane active">
                                                            <div class="panel panel-default">
                                                                              ...
                                                                              <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                  ...
                                                                                  <div class="modal-footer">
                                                                                    ...
                                                                                    <a class="btn btn-primary" href="<?php echo base_url('P2K3/Order/reset')?>">YES</a>
                                                                                  </div>
                                                                                </div>
                                                                              </div>
                                                                            </div>
                                                                ...
                                                                <div class="panel-body" style="overflow-x: auto;">
                                                                    <table id="tb_InputKebutuhanAPD" class="table table-striped table-bordered table-hover" style="font-size:12px; position: center; overflow-x: auto; table-layout: fixed; width: 1500px; max-width: 2000px">
                                                                            <thead>
                                                                                <tr class="bg-primary">
                                    ...
                                    <div class="panel-footer">
                                        <div class="row text-right" style="margin-right: 12px">
                                            ...
                                            <a href="<?php echo site_url('P2K3/Order/list_order');?>" class="btn btn-primary btn-lg btn-rect">Back</a>
                                            &nbsp;&nbsp;
