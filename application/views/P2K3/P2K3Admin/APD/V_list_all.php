                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box box-primary box-solid">
                            <div hidden class="box-header with-border" style="height: 60px;">
                            ...
                            <div class="box-body">
                                <div hidden class="row text-right" style="margin-right: 3px;">
                                    <a hidden class="btn btn-primary" id="bt_export" href="<?php echo site_url('P2K3/Order/cek')?>">Export &nbsp<span class="glyphicon glyphicon-arrow-up"></a>
                                </div>
                                <br>
