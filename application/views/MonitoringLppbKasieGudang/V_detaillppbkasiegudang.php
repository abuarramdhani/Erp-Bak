												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<?php }else{ ?>
															<button class="btn btn-primary" onclick="actionLppbKasieGudang(this)" value="3" name="proses" data-id="<?= $p['BATCH_DETAIL_ID']?>">Ok</button>
															<button class="btn btn-danger" onclick="actionLppbKasieGudang(this)" value="4" name="proses" data-id="<?= $p['BATCH_DETAIL_ID']?>">Not Ok</button>
															<?php } ?>
