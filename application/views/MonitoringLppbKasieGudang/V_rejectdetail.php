 							...
 							<div class="box-body">
 										<div class="col-md-6">
 											<table class="col-md-12" style="margin-bottom: 20px">
 												...
 												<tr>
 													...
 													<td>
 														<input type="text" name="gudang" class="form-control" style="width: 100%; margin-bottom: 10px" value="<?php echo $lppb[0]['SOURCE']?>" readonly >
 													</td>
 												</tr>
 											</table>
 										</div>
 								...
 								<div class="col-md-12">
 									...
 									<div class="col-md-2 pull-right">
 										<a href="<?php echo base_url('MonitoringLppbKasieGudang/Reject')?>">
