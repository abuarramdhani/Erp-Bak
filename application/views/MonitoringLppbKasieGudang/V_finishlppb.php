							...
							<div class="box-body">
								<table class="table text-center dtTableMl">
									...
									<tr>
										<td><?php echo $no?></td>
										<td>
											<button title="Detail Lppb" onclick="MdlFinishKasie(<?php echo $lb['BATCH_NUMBER']?>)" data-toggle="modal" data-target="mdlFinishKasieGudang"" class="btn btn-default btn-sm"><i class="fa fa-file-text-o"></i> Detail</button>
										</td>
