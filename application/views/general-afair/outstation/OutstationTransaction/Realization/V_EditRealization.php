											...
											<?php foreach ($data_simulation as $dsim) { ?>
												...
												<table class="table">
													<tr>
														...
														<td><select id="employee" name="txt_employee_id"  class="form-control select2" style="width: 100%" data-placeholder="employee">
															<option value=""></option>
															<?php foreach($Employee as $ed){?>
																...
																?>
																<option <?php echo $employee_selected?> value="<?php echo $ed['employee_id'] ?>"><?php echo $ed['employee_id'] ?></option>
															<?php } ?>
														</select></td>
													</tr>
													<tr>
