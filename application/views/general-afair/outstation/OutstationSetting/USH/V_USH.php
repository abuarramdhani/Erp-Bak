														...
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<div class="modal-footer">
																	...
																	<button id="delete_button" type="button" data-dismiss="modal" data-toggle="modal" data-target="#delete_data" class="btn btn-danger" onClick="checkDelete('<?php echo base_url('Outstation/ush/delete')?>','<?php echo $du['position_id'].' - '.$du['group_id']?>')">Delete</button>
																</div>
															</div>
														</div>
													</div>
