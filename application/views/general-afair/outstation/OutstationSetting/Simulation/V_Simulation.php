							...
							<div class="box-body with-border">
								...
								<table id="data_table" class="table table-bordered table-striped table-hover">
									...
									<tbody>
										...
										<tr>
											<td><?php echo $no++?></td>
											<td><?php echo $dsim['position_name']?></td>
											<td><?php echo $dsim['area_name']?></td>
											<td><?php echo $dsim['city_type_name']?></td>
											<td><?php echo $dsim['nominal']?></td>
											<td>
												<a class="btn btn-warning" href="<?php echo base_url('Outstation/simulation/edit/'.$dsim['simulation_id'])?>"><i class="fa fa-edit"></i> Edit</a> <button class="btn btn-danger" data-toggle="modal" data-target="#delete_<?php echo $dsim['simulation_id']?>"><i class="fa fa-times"></i> Delete</button>
												<div class="modal fade" id="delete_<?php echo $dsim['accomodation_allowance_id']?>">
