					...
					<div class="col-md-12">
						<div class="box box-primary" style="margin: 0 auto;width: 60%">
							<div class="box-body with-border">
								<form method="post" action="<?php echo base_url('Outstation/component/update') ?>">
									<?php foreach ($data_component as $dc) {?>
										<input type="hidden" name="txt_component_id" value="<?php echo $dc['component_id']?>" />
										<table class="table">
											<tr>
												<td width="25%">Component Name</td>
												<td><input type="text" name="txt_component_name" maxlength="100" class="form-control" value ="<?php echo $dc['component_name']?>" required></td>
											</tr>
											<tr>
												<td>Start Date</td>
