					...
					<div class="col-md-12">
						<div class="box box-primary" style="margin: 0 auto;width: 60%">
							<div class="box-body with-border">
								<form method="post" action="<?php echo base_url('Outstation/component/new/save') ?>">
									<table class="table">
										<tr>
											<td width="25%">Component Name</td>
											<td><input type="text" name="txt_component_name" maxlength="100" class="form-control" required></td>
										</tr>
										<tr>
											<td>Start Date</td>
