                    ...
                    <div class="box-body table-responsive no-padding">
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <p class="bold">Approval List DPB Vendor</p>
                            </div>
                            <div class="panel-body">
                                ...
                                <table class="table table-bordered table-hover table-striped tblADOList" style="display: none; width: 100%">
                                    ...
                                    <tbody>
                                        <?php foreach ($listApproval as $key => $val) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form action="<?= base_url('ApprovalDO/ApprovalDPB/DetailVendor') ?>" method="post" target="_blank">
