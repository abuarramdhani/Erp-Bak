        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Approval Delivery Order</h3>
                </div>
                <div class="box-body">
                    <div class="box-body table-responsive no-padding">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <p class="bold">Approval DO List</p>
                            </div>
                                        ...
                                        <?php foreach ($RequestedDOList as $key => $val) : ?>
                                            <tr>
                                                ...
                                                <td width="10%" class="text-center">
                                                    <?php if ($val['NO_SO']) : ?>
                                                        <a href='<?= base_url("ApprovalDO/Detail/Approval-{$val['NO_DO']}-{$val['NO_SO']}") ?>' target="_blank" title="Detail" class="btn btn-default">
                                                            <i class="fa fa-book"></i>&nbsp; Detail
                                                        </a>
                                                    <?php else : ?>
                                                        <a href='<?= base_url("ApprovalDO/Detail/ApprovalSPB-{$val['NO_DO']}-") ?>' target="_blank" title="Detail" class="btn btn-default">
                                                            <i class="fa fa-book"></i>&nbsp; Detail
                                                        </a>
                                                    <?php endif ?>
                                                </td>
