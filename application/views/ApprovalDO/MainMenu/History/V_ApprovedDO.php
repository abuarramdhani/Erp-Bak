        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">History Approved Delivery Order</h3>
                </div>
                <div class="box-body">
                    <div class="box-body table-responsive no-padding">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <p class="bold">Approved DO List</p>
                            </div>
                                ...
                                <table class="table table-bordered table-hover table-striped tblADOList" style="display: none">
                                    <thead>
                                        <tr class="bg-primary" height="50px">
                                            ...
                                            <th width="14%" class="text-center">Approved Date</th>
                                            <th width="13%" class="text-center">Approved By</th>
                                            <th width="10%" class="text-center no-orderable">Action</th>
                                            <th width="10%" class="text-center">Status</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($ApprovedDOList as $key => $val) : ?>
                                            <tr>
                                                ...
                                                <td width="14%" class="text-right"><?= $val['APPROVED_DATE'] ?></td>
                                                <td width="13%"><?= $val['APPROVED_BY'] ?></td>
                                                <td width="10%" class="text-center">
                                                    <?php if ($val['NO_SO']) : ?>
                                                        <a href='<?= base_url("ApprovalDO/Detail/Approved-{$val['NO_DO']}-{$val['NO_SO']}") ?>' target="_blank" title="Detail" class="btn btn-default">
                                                            <i class="fa fa-book"></i>&nbsp; Detail
                                                        </a>
                                                    <?php else : ?>
                                                        <a href='<?= base_url("ApprovalDO/Detail/ApprovedSPB-{$val['NO_DO']}-{$val['NO_SO']}") ?>' target="_blank" title="Detail" class="btn btn-default">
                                                            <i class="fa fa-book"></i>&nbsp; Detail
                                                        </a>
                                                    <?php endif ?>
                                                </td>
