        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">History Rejected Delivery Order</h3>
                </div>
                <div class="box-body">
                    <div class="box-body table-responsive no-padding">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <p class="bold">Rejected DO List</p>
                            </div>
                                ...
                                <table class="table table-bordered table-hover table-striped tblADOList" style="display: none">
                                    <thead>
                                        <tr class="bg-primary" height="50px">
                                            ...
                                            <th width="14%" class="text-center">Reject Date</th>
                                            <th width="13%" class="text-center">Reject By</th>
                                            <th width="10%" class="text-center no-orderable">Action</th>
                                            <th width="10%" class="text-center">Status</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($RejectedDOList as $key => $val) : ?>
                                            <tr>
