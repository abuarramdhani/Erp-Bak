        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Waiting List Approval Daftar Penerimaan Barang KHS</h3>
                </div>
                <div class="box-body">
                    <div class="box-body table-responsive no-padding">
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <p class="bold">Waiting List DPB KHS</p>
                            </div>
                                        ...
                                        <?php foreach ($DPBKHSList as $key => $val) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form action="<?= base_url('ApprovalDO/DPBKHS/Detail') ?>" method="post" target="_blank">
