        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">List Daftar Pengiriman Barang KHS</h3>
                </div>
                <div class="box-body">
                    <div class="box-body table-responsive no-padding">
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <p class="bold pull-left">List DPB KHS</p>
                                <a href="<?= base_url('ApprovalDO/DPBKHS/Add') ?>" target="_blank" class="btn btn-success pull-right <?= $UserAccess['add_data'] ?>" title="Tambahkan Data Baru">
                                    ...
                                    <tbody>
                                        <?php foreach ($DPBKHSList as $key => $val) : ?>
                                            <tr>
                                                ...
                                                <td class="text-right"><?= $val['TGL_KIRIM'] ?></td>
                                                ...
                                                <td class="text-center">
                                                    <form action="<?= base_url('ApprovalDO/DPBKHS/Detail') ?>" method="post" target="_blank" class="text-nowrap">
                                                        ...
                                                        <button type="button" title="Hapus" class="btn btn-danger btnADODeleteDPBKHS" <?= $UserAccess['delete'] ?>>
