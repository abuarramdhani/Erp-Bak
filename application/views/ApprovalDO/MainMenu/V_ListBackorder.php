        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">List Backorder</h3>
                </div>
                <div class="box-body">
                    <div class="box-body table-responsive no-padding">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <p class="bold">List Backorder</p>
                            </div>
                            <div class="panel-body">
                                ...
                                <table class="table table-bordered table-hover table-striped tblADOList" style="display: none">
                                    ...
                                    <tbody>
                                        <?php foreach ($BackorderList as $key => $val) : ?>
                                            <tr>
                                                <td width="10%" class="text-right"><?= $key+1 ?></td>
                                                <td class="text-right tdASODONumber"><?= $val['SOURCE_HEADER_NUMBER'] ?></td>
                                                <td class="text-center">
                                                    <a href="<?= base_url('ApprovalDO/Detail/ListBackorder--'.$val['SOURCE_HEADER_NUMBER']) ?>" target="_blank" title="Detail PDF" class="btn btn-default">
