                    ...
                    <div class="box-body table-responsive no-padding">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php if (isset($DPBKHSDetail[0]['GUDANG_PENGIRIM'])) echo $DPBKHSDetail[0]['GUDANG_PENGIRIM'];?>" readonly>
                                </div>
                            </div>
                        </div>
                        <br />
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <span class="input-group-addon"><i style="width:15px;" class="fa fa-home"></i></span>
                                    <input class="form-control txtADOAlamatBongkar"  <?= $UserAccess['edit_field'] ?> value="<?php if (isset($DPBKHSDetail[0]['ALAMAT_BONGKAR'])) echo $DPBKHSDetail[0]['ALAMAT_BONGKAR'] ?>">
                                </div>
                            </div>
                        </div>
                        <br />
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    ...
                                    <input class="form-control txtADOCatatan" <?= $UserAccess['edit_field'] ?> value="<?php if (isset($DPBKHSDetail[0]['CATATAN'])) echo $DPBKHSDetail[0]['CATATAN'] ?>">
                                </div>
                            </div>
                        </div>
                        <br />
