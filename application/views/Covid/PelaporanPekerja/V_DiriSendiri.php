                        ...
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border text-center" style="font-weight: bold; font-size: 20px;">
                                    Luar Kota - Diri Sendiri
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <form id="cvd_frmsbmtcvd" method="post" action="<?php echo base_url('Covid/MonitoringCovid/insertDiriSendiri')?>" enctype="multipart/form-data">
                                            <div class="col-md-12">
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="slc-CVD-MonitoringCovid-Tambah-Pekerja" name="slc-CVD-MonitoringCovid-Tambah-Pekerja" class="select2" style="width: 100%" data-placeholder="Pilih Pekerja">
                                                                <?php
                                            ...
                                            <div class="col-md-12">
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <label for="usr">Apakah anda dan atau orang yang dikunjungi mengalami sakit ? </label>
                                                            &nbsp; &nbsp;&nbsp;
                                                        ...
                                                        <div class="form-group">
                                                            <label for="usr">Apakah anda dan atau yang berpergian bersama anda mengalami sakit setelah kembali ? </label>
                                                            &nbsp; &nbsp;&nbsp;
                                            ...
                                            <div class="col-md-12 text-center">
                                                ...
                                                <button name="source" value="diri_sendiri" type="submit" class="btn btn-success">Submit</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
