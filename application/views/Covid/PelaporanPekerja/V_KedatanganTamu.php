                        ...
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border text-center" style="font-weight: bold; font-size: 20px;">
                                     Luar Kota - Kedatangan Tamu
                                </div>
                                <div class="panel-body">
                                  <div class="row">
                                      <form id="cvd_frmsbmtcvd" method="post" action="<?php echo base_url('Covid/MonitoringCovid/insertKedatanganTamu')?>" enctype="multipart/form-data">
                                            <div class="col-md-12">
