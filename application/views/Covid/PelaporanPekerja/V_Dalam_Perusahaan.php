                        ...
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border text-center" style="font-weight: bold; font-size: 20px;">
                                    Kontak dengan Probable/Konfirmasi Covid 19 - Dalam Perusahaan
                                </div>
                                <div class="panel-body">
                                  <div class="row">
                                      <form id="cvd_frmsbmtcvd" method="post" action="<?php echo base_url('Covid/MonitoringCovid/insertDalamPerusahaan')?>" enctype="multipart/form-data">
                                            <div class="col-md-12">
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <br>
                                                            <input type="radio" name="hubungan_dp" required value="Rekan 1 Seksi 1 Ruangan/Area" style="clear: none;width: auto;">
                                                            <label style="margin-left: 10px;clear: none;width: auto;">
                                                                Rekan 1 Seksi 1 Ruangan/Area
                                                            </label>
                                                            <br>
                                                            <input type="radio" name="hubungan_dp" value="Rekan 1 Seksi Beda Ruangan/Area">
                                                            <label style="margin-left: 10px;">
                                                                Rekan 1 Seksi Beda Ruangan/Area
                                                            </label>
                                                            <br>
                                                            <input type="radio" name="hubungan_dp" value="Rekan Beda Seksi 1 Ruangan/Area">
                                                            <label style="margin-left: 10px;">
                                                                Rekan Beda Seksi 1 Ruangan/Area
                                                            </label>
                                                            <br>
                                                            <input type="radio" name="hubungan_dp" value="Rekan Beda Seksi Beda Ruangan/Area">
                                                            <label style="margin-left: 10px;">
                                                                Rekan Beda Seksi Beda Ruangan/Area
                                                            </label>
                                                            <br>
                                                            <input type="radio" name="hubungan_dp" value="lainnya">
                                                            <label style="margin-left: 10px;">
                                                                Lainnya
                                                            </label>
                                                            <br>
                                            ...
                                            <div class="col-md-12 text-center">
                                                ...
                                                <button name="source" value="dalam_perusahaan" type="submit" class="btn btn-success">Submit</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
