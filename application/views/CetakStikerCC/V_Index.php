<section id="content">
    <div class="inner" style="background: url('<?php echo base_url('assets/img/1.jpg');?>');background-size: cover;" >
            <!-- Content Header (Page header) -->
            <section class="content-header">
                    <div class="row">
                        <div class="col-lg-12">
                            <br />
                            <h3 style="text-align: center;"><b >Cetak Stiker Cost Center</b></h3>
                        </div>
                    </div>
            </section>
            <hr />
