...
<div class="panel-body text-right">
    <button class="btn" formtarget="_blank" formaction="<?php echo base_url("MonitoringJobProduksi/LaporanProduksi/detail_laporan")?>"><i class="fa fa-download"></i> DETAIL</button>
