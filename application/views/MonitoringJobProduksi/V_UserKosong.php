<?php
$getuser = $this->M_usermng->getUser("where jenis = 'Superuser'");
foreach ($getuser as $key => $val) {
    $user = $this->M_usermng->getuserMJP($val['NO_INDUK']);
    $getuser[$key]['NAMA'] = $user[0]['nama'];
}
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="box box-primary box-solid">
                            <div class="box-body">
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <center><h4>Tipe user tidak dikenali harap hubungi User dibawah untuk mendaftarkan user anda : </h4><center>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="col-md-3"></div>
                                        <div class="col-md-7">
                                            <?php $no = 1; foreach ($getuser as $key => $value) { ?>
                                                <p class="text-left"><?= $no?>. <?= $value['NO_INDUK']?> - <?= $value['NAMA']?></p>
                                            <?php $no++; }?>
                                        </div>
                                    </div>
                                </div>
