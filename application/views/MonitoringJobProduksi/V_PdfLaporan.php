...
<table style="width: 100%; border-bottom :0px; border-collapse: collapse;" >
	...
	?>
    <tr>
        <td style="border-bottom:0px solid black; border-collapse: collapse;text-align:center;font-size: 12px">Target laju saat ini : <?= round(($data['ttl_target'] - $data['ttl_real'])/ (($data['hari'] - 4) - $tanggal)).' '.$satuan_laju?></td>
    </tr>
</table>
</div>
<br>
