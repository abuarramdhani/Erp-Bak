		...
		<table id="poLinesTable" class="table table-striped table-bordered table-hover text-center tblMI">
			<thead style="vertical-align: middle;"> 
				<tr class="bg-primary">
					...
					<th class="text-center" style="display: none">Nama Vendor</th>
					<th class="text-center" style="display: none">PO Number</th>
			...
			<tbody>
				...
				<tr id="<?php echo $no; ?>">
					<td>
						<input class="checkbox addMonitoringInvoice" value="<?php echo $no; ?>" type="checkbox" name="inputInvoice" data-id="<?php echo $po_num['LINE_ID']?>">
					</td> 
					<td class="text-center"> <?php echo $po_num['LINE_NUM']?> </td>
					<td class="text-center" style="display: none"> <?php echo $po_num['VENDOR_NAME']?> </td>
					<td class="text-center" style="display: none"> <?php echo $po_num['NO_PO']?> </td>
