							...
							<div class="box-body">
								<table id="rejectdetail"  >
									...
									<tr>
										...
										<td>
											<input class="form-control" size="40" type="text" name="invoice_amount" value="<?php echo $invoice[0]['INVOICE_AMOUNT']?>" readonly>
										</td>
									</tr>
									<tr>
										<td>
							...
							<div class="box-body">
								<div class="col-md-12">
									<div style="overflow:auto;">
											<table id="rejectpo" class="table table-striped table-bordered table-hover text-center" style="min-width:200%;">
