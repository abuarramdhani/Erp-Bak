								...
								<div class="row">
									<div class="col-lg-6">
											...
											<div class="col-sm-5">
												<div class="bootstrap-timepicker">
													<div class="input-group">
														...
														<input type="text" class="form-control pull-right spl-date" name="tanggal_0" value="<?php echo date_format(date_create($l['Tgl_Lembur']), "d-m-Y"); ?>" <?= $status ?>>
													</div>
												</div>
											</div>
											<div class="col-sm-5">
												<div class="bootstrap-timepicker">
													<div class="input-group">
														...
														<input type="text" class="form-control spl-time-mask" name="waktu_0" value="<?php echo $l['Jam_Mulai_Lembur']; ?>" <?= $status ?> required>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="col-sm-5">
												<div class="bootstrap-timepicker">
													<div class="input-group">
														...
														?>
														<input type="text" class="form-control pull-right spl-date" name="tanggal_1" value="<?= $tanggal2 ?>" <?= $status ?> required>
													</div>
												</div>
											</div>
											<div class="col-sm-5">
										...
										<div class="form-group">
											...
											<div class="col-sm-2">
												<label style="margin-left:2%; top:+3;">
													<input type="radio" name="break" value="1" style="transform: scale(1.5); vertical-align:top;" <?= ($l['Break'] == "Y") ? "checked" : '' ?> <?= $status ?>>
													Ya
												</label>
											</div>
											<div class="col-sm-8">
												<label style="margin-left:5%; vertical-align:bottom;">
													<input type="radio" name="break" value="2" style="transform: scale(1.5); vertical-align:top;" <?= ($l['Break'] == "N") ? 'checked' : '' ?> <?= $status ?>>
													Tidak
												</label>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-2">
												<label style="margin-left:2%; top:+3;">
													<input type="radio" name="istirahat" value="1" style="transform: scale(1.5); vertical-align:top;" <?= ($l['Istirahat'] == "Y") ? 'checked' : '' ?> <?= $status ?>>
													Ya
												</label>
											</div>
											<div class="col-sm-8">
												<label style="margin-left:5%; vertical-align:bottom;">
													<input type="radio" name="istirahat" value="2" style="transform: scale(1.5); vertical-align:top;" <?= ($l['Istirahat'] == "N") ? "checked" : '' ?> <?= $status ?>>
													Tidak
												</label>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<div style="border: 1px solid grey; border-radius: 2px; padding: 5px; width: 6em;">
												...
												<table id="example11" class="table table-bordered table-striped text-center">
													...
													<tbody>
														...
														<tr class="multiinput">
															...
															<td>
																<input type="<?= $target_type ?>" class="form-control" name="target[]" value="<?= $target_val ?>" <?php echo $status ?> <?= $target_disabled ?>>
															</td>
															<td>
															...
															<td>
																<input type="<?= $realisasi_type ?>" class="form-control" name="realisasi[]" value="<?= $realisasi_val; ?>" <?php echo $status ?> <?= $realisasi_disabled ?>>
															</td>
															<td>
