								...
								<div class="col-lg-6">
									...
									<div class="form-group">
										<div class="col-sm-12">
											...
											<button type="button" class="btn btn-primary" style="margin-left: 1em;" data-toggle="modal" data-target="#ProsesDialog" id="btn-ProsesSPL"><i class="fa fa-save"></i> Proses</button>
