						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<a href="finspot:FingerspotVer;<?php echo base64_encode(base_url().'ALA/Approve/fp_proces?userid='.$this->session->userid.'&stat=35&data=&ket='); ?>" type="submit" id="spl_proses_reject" class="btn btn-danger"><i class="fa fa-exclamation-circle"></i> Reject</a>
									<a href="finspot:FingerspotVer;<?php echo base64_encode(base_url().'ALA/Approve/fp_proces?userid='.$this->session->userid.'&stat=25&data=&ket='); ?>" type="submit" id="spl_proses_approve" class="btn btn-success"><i class="fa fa-check-square"></i> Approve</a>
								</div>
							</div>
						</div>							
					</div>
