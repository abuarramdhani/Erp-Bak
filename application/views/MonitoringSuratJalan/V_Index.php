	...
	<div class="inner" style="background: url('<?php echo base_url('assets/img/3.jpg');?>');background-size: cover;" >
			...
			<section class="content-header">
					<div class="row">
						<div class="col-lg-12">
							<br />
							<h2 style="text-align: center;"><b >Monitoring Surat Jalan</b></h2>
			...
			<div class="row">
				<div class="col-lg-12">
						<div class="col-lg-6 text-left reup">
							<h4><small>Welcome <?php echo $this->session->employee ?></small></h4>
						</div>
				    <div class="col-lg-6 text-right reup">
