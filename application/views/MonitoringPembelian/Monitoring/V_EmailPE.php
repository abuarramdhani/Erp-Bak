				...
				<div class="row">
					<div class="col-lg-12">
						<div class="box box-primary box-solid">
							...
							<div class="box-body">
							<div class="row">
								<form action="<?= base_url(); ?>MonitoringPembelian/MonitoringPE/SaveEmailPE" method="post">
										...
										<tbody>
											...
											?> 		
													<tr>
														...
														<td>
															<center>
															<a class="btn btn-danger" title="Delete Email" href="<?php echo base_url(); ?>MonitoringPembelian/MonitoringPE/<?php echo 'DeleteEmailPE/'.$encrypted_string ?>" onclick="return confirm('Are you sure to delete this Email ?')">
								...
								<div class="col-md-12"><center><a class="btn btn-lg btn-success" href="<?= base_url(); ?>MonitoringPembelian/MonitoringPE"><span class="icon icon-check"></span> Done</a></center></div>
							</div>
