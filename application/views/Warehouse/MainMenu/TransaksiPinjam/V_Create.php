						...
						<div class="box-body">
							<div class="panel-body">
									...
									<label for="norm" class="control-label col-md-1 text-center">Shift</label>
											...
											<div class="col-md-4">
												<input type="text" name="txtBarcode" id="txtBarcode" style="text-transform:uppercase;" class="form-control" onChange="AddItemWh('create')" placeholder="[Barcode]" autofocus></input>
											</div>
											<div class="col-md-1">
								...
								<br>
									...
									<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" name="txtTanggalUsableKu" id="txtTanggalUsableKu" placeholder="[TANGGAL]" class="form-control"></input>
											</div>
										</div>
							</div>
							<div class="panel-footer">
								<div class="row text-right">
									...
									&nbsp;&nbsp;
									<a id="btnExecuteSaveWh" class="btn btn-primary btn-lg btn-rect">Save</a>
								</div>
							</div>
						</div>
						</div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
			<select name="slcModalBarcode" id="slcModalBarcode" onChange="copyItemWh()" class="form-control select-item-wh" style="width:100%;">
				<option value=""></option>
			</select>
        </div>
      </div>
