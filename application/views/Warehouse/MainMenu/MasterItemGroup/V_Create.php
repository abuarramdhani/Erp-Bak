<section class="content">
	<div class="inner" >
		<div class="row">
			<form method="post" action="<?php echo site_url('Warehouse/MasterItem/saveCreateUsableItemGroup')?>" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="box-body">
							<div class="panel-body">
								<div class="row col-lg-12">
									<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" placeholder="Group Toolkit" name="txtGroupName" id="txtGroupName" class="form-control" required/>
											</div>
									</div>
									<div class="form-group">
							...
							<div class="panel-footer">
								<div class="row text-right">
									<a href="<?php echo site_url('Warehouse/MasterItem/UsableGroup') ?>" class="btn btn-primary btn-lg btn-rect">Close</a>
									&nbsp;&nbsp;
