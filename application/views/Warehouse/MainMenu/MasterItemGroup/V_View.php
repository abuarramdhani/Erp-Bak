									...
									<table class="table table-striped table-bordered table-hover text-left table-item-usable" id="table-item-usable" style="font-size:12px;">
										...
										<tbody>
											...
											?>
													<tr>
														<td align="center">
															<a class="btn btn-xs bg-blue" href="<?php echo base_url('Warehouse/MasterItem/UpdateItemUsable/')."/".$encrypted_string ?>"><span title="Update <?php echo $AllUsableItem_item['item_name'] ?>" class="fa fa-edit"></span></a>
