							...
							<div class="box-body">
								<div class="panel-body">
									<div class="row col-lg-12">
										<div class="form-group">
											<label for="norm" class="control-label col-md-1 text-center">No Induk</label>

											<div class="col-md-3">
												<input type="text" name="txtNoInduk" id="txtNoInduk" class="form-control"  onChange='searchPekerja()' placeholder="[No Induk]" maxlength="5" autofocus></input>
											</div>
											<?php 
                                ...
                                if(in_array($no_ind, $admin)){
                                    ?>
											...
											<div class="col-md-3">
												<input type="text" name="txtBarcode" id="txtBarcode" class="form-control" onChange="openTanggal()" placeholder="[Barcode]" autofocus readonly=""></input>
												<input type="text" onChange="AddPengembalianItemWh()" placeholder="[QTY]" class="form-control" name="txtQtyKembali" id="txtQtyKembali" disabled="">
											</div>
											<div class="col-md-1">
									...
									<div class="form-group">
												...
												<div class="col-md-3">
												<input type="text" onChange="openInputQtyKembali()" name="txtTanggalPengembalian" id="txtTanggalPengembalian" placeholder="[TANGGAL]" disabled="" class="form-control"></input>
												</div>
											</div>
								</div>
								<?php } ?>
								<table class="table table-striped table-bordered table-hover text-left table-create-pengembalian-today" id="table-create-pengembalian-today" style="font-size:12px;">
									<thead>
										<tr class="bg-primary">
											...
											<!-- <th width="10%"><center>Qty Sisa Pinjam</center></th> -->
