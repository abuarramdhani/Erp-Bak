		...
		<div class="row">
			<div class="col-lg-12">
				<div class="row">
					<div class="col-lg-12">
						<div class="text-left ">
							<span><b><i class="fa fa-clock-o"></i> List Shipment History</b></span>
						</div>
						<div class="col-lg-12">
					...
					<div class="col-lg-12">
						<div class="box box-primary">
					  		<div class="box-header with-border">
								...
								<div class="box-body">
									<table style="width: 100%" id="unitpunya" class="table table-striped table-bordered table-hover table-history text-center">
	<thead>
										<tr class="bg-primary">
