									...
									<tbody>
										...
										<tr>
											...
											<td data-id="<?= $u['INVOICE_ID'] ?>" batch_number="<?= $u['BATCH_NUMBER'] ?>" class="ganti_<?= $u['INVOICE_ID'] ?>">
												<a title="Detail..." target="_blank" href="<?php echo base_url('AccountPayables/MonitoringInvoice/Unprocess/DetailInvBermasalah/'.$u['INVOICE_ID']);?>" class="btn btn-info"><i class="fa fa-file-text-o"></i>
												</a>
											</td>
											...
											<td><b>Invoice sudah terlaporkan ke Kasie Purchasing</b></td>
