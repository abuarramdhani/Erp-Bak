...
<table class="datatable table-bordered table-hover table-striped text-center tbl-lph-2021" style="width:1900px">
  <thead class="bg-primary">
    <tr>
      ...
      <td rowspan="2" style="width:180px">Shift</td>
    </tr>
    <tr>
  ...
  <tbody>
    <?php foreach ($get as $key => $value): ?>
      <tr>
        ...
        <td><?php echo $value['shift_description'] ?></td>
      </tr>
    <?php endforeach; ?>
  </tbody>
</table>
