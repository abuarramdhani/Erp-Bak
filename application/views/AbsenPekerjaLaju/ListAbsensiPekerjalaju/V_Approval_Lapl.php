...
<div id="cover-spin">
	...
	<div class="inner" >
		...
		<div class="panel box-footer" style="padding-left: 50px;">
			...
			<a id="btnCetak" class="btn btn-info" style="width: 200px;" href="<?php echo base_url('AbsenAtasan/List/cetakApproval/'.$dataEmployee[0]['absen_id']); ?>" ><i class="fa fa-print"></i>   Cetak</a>
			</div>
		</div>
