                        ...
                        <tbody>
                            <?php foreach ($waiting_list as $key => $list) { ?>
                                <tr>
                                    ...
                                    <td><?= $list['TIPE'];?></td>
                                    <td> 
                                        <button type="button" class="btn btn-danger btnRejectDSP" title="reject" value="<?= $list['REQUEST_NUMBER'];?>"><i class="fa fa-remove"></i> Reject</button>
                                        <button type="button" class="btn btn-success btnApproveDSP" title="reject" value="<?= $list['REQUEST_NUMBER'];?>"><i class="fa fa-check"></i>Approve</button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
