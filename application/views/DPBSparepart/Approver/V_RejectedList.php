        ...
        <div class="col-lg-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Rejected List DPB</h3>
                </div>
                <div class="box-body">
                    <table class="table table-striped table-hover table-bordered" id="tblRejectedListApproverDSP" width="100%">
                        <thead>
                            <tr class="bg-primary">
                        ...
                        <tbody>
                            <?php foreach ($rejected_list as $key => $list) { ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><?= $list['TIPE']; ?></td>
                                    <td>
                                        <button type="button" data-id="<?= $list['REQUEST_NUMBER']; ?>" class="btn btn-success btnResubmit">Re Submit</button>
                                    </td>
                                </tr>
                            <?php } ?>
