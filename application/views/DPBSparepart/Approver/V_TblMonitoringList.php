<table class="table table-striped table-hover table-bordered tblMonitoringDSP" id="" width="100%">
    <thead>
        <tr class="bg-primary">
            ...
            <th style="vertical-align:middle;" rowspan="2">Tanggal Dibuat</th>
