    ...
    <div class="box-body">
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs pull-right">
          <li class="pull-left header"><i class="fa fa-pencil"></i> <b>Create Move Order OPM</b></li>
        </ul>
          ...
          <div class="row">
              ...
              <div class="form-group shiftForm">
               ...
               <div class="form-group">
                <div class="col-md-12" style="padding-top: 5px">
                  <button class="btn btn-success" onclick="getRequirementOPM(1)" ><i class="fa fa-search"></i> Sudah Picklist </button>
                  <button class="btn btn-primary" onclick="getRequirementOPM(0)" ><i class="fa fa-search"></i> Belum Picklist </button>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-5">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <div class="col-md-12" style="padding-top: 5px">
                  <button class="btn btn-primary" onclick="getRequirementOPM2()" ><i class="fa fa-search"></i> Search </button>
                </div>
              </div>
            </div>
          </div>
