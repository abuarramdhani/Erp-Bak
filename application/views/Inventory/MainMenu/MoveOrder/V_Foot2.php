...
<table class="table table-head" style="font-size: 12px;">
	<tr>
		<td width="35%" style="font-size: 10px;padding-top: 5px;height: 65px;"><?=$dataall['line'][0]['PRODUK_DESC'];?><br>(<?=$dataall['line'][0]['JOB_NO'];?>)<br><br><textarea width="33%" rows="3" style="font-size: 9px;font-family: Arial, Helvetica, sans-serif">Apabila ada kerusakan/ kekurangan bahan, segera laporkan maksimal 2 x 24 jam dari hari pengambilan, setelah itu tidak akan dilayani/ menjadi tanggung jawab pengambil</textarea></td>
