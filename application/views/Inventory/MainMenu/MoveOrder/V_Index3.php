    ...
    <table style="width:100%;border: 0px solid black; padding: 0px;height:16mm">
        ...
        <table style="width: 100%; border-left: 0px solid black;border-right: 0px solid black; padding: 0px;">
            ...
            <tr>
                ...
                <td style="text-align: center;font-size: 12px;height: 18mm;border-right: 0px solid black" rowspan="2">SUB INVENTORY</td>
                ...
                <td style="text-align: center;font-size: 11px;height: 9mm;border-bottom: 0px solid black;" rowspan="1"><b>REQUEST NUMBER</b></td>
            </tr>
            <tr>
                <td style="height: 9mm; text-align: center; " colspan="2">
                <span style="font-size: 12px;"><!-- PsP/ no PO : --></span>
                <span style="padding-left: 20px; font-size: 12px">PO</span>
                <br>
                <span style="font-size: 12px"><!-- Tanggal : --></span>
                <span style="padding-left: 20px; font-size: 12px">REQUIRED</span>  
        ...
        <table style="width: 100%; border-left: 0px solid black;border-right: 0px solid black;border-top: 0px solid black;border-bottom: 0px solid black; padding: 0px;">
            ...
            <tr>
                <td style="border-bottom: 0px solid black;border-right: 0px solid black;font-size: 12px; text-align: center;">N0</td>
                <td style="border-bottom: 0px solid black;border-right: 0px solid black;font-size: 12px; text-align: center;">QTY</td>
                <td style="border-bottom: 0px solid black;border-right: 0px solid black;font-size: 12px;text-align: center;">......</td>
                <td style="border-bottom: 0px solid black;border-right: 0px solid black;font-size: 12px;text-align: center;">PCS
                </td>
                <td style="border-bottom: 0px solid black;border-right: 0px solid black;font-size: 12px;text-align: center;">KODE KOMPONEN</td>
                <td style="border-bottom: 0px solid black;border-right: 0px solid black;font-size: 12px">NAM KOMPONEN</td>
                <td style="border-bottom: 0px solid black;font-size: 12px">LOKASI SIMPAN</td>
            </tr>
           
                    <tr><td style="border:0px solid black;padding:"></td></tr>
        ...
        <tr>
            <td style="height: 15px;text-align: center;font-size: 11px;border-right: 0px solid black">TERIMA</td>
            <td style="height: 15px;text-align: center;font-size: 11px;border-right: 0px solid black">PENGELUARAN</td>
            <td style="height: 15px;text-align: center;font-size: 11px;border-right: 0px solid black">GUDANG</td>
            <td style="height: 15px;text-align: center;font-size: 11px;border-right: 0px solid black">SETUJU</td>
            <td style="height: 15px;text-align: center;font-size: 11px;">FAJAR UTOMO</td>
        </tr>
    </table>
