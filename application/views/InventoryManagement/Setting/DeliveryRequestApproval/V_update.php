<section class="content">
	<div class="inner" >
		<div class="row">
			<form method="post" id="frmDeliveryRequestApproval" action="<?php echo site_url('InventoryManagement/DeliveryRequestApproval/Update/'.$id)?>" class="form-horizontal">
						...
						<div class="box-body">
							<div class="panel-body">
								<?php	//print_r($Approver);
										foreach($Approver as $Approver_item){
								?>
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="col-lg-4">
												<select name="slcApprover" id="slcApprover" class="form-control jsOracleEmployee"  >
													<option value="<?= $Approver_item['EMPLOYEE_ID']?>"><?= $Approver_item['EMPLOYEE_NUMBER']." (".$Approver_item['EMPLOYEE_NAME'].")"?></option>
												</select>
											</div>
										</div>
									</div><!--
										...
										<div class="form-group">
											...
											<div class="col-lg-2">
												<select name="slcActive" id="slcActive" class="form-control select4"  >
													<option value=""></option>
													<option value="Y" <?php echo ($Approver_item['ACTIVE_FLAG']==="Y")?"selected":""; ?>>Yes</option>
													<option value="N" <?php echo ($Approver_item['ACTIVE_FLAG']==="N")?"selected":""; ?>>No</option>
												</select>
											</div>
										</div>
									</div>
