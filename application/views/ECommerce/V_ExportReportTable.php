                                    ...
                                    <table id="filter">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input size="30" type="text" class="form-control" name="dateBegin" id="dateBegin" value="<?php echo $dateFrom; ?>" autocomplete="off">
                                            ...
                                            <td>
                                                <!-- <div class="input-group date"> -->
                                                <input size="30" type="text" class="form-control" name="dateEnd" id="dateEnd" value="<?php echo $dateTo; ?>" autocomplete="off">
                                                <!-- <div class="input-group-addon">
                                                        <span class="glyphicon glyphicon-calendar"></span>
                                                    </div> -->
                                                <!-- </div>
                                            ...
                                            <td>
                                                <div class="col-lg-12">
                                                    <?php
                                                        if ($tableExcelDate == '1') {
                                                        ?>
                                                    <button formaction="<?php echo base_url('ECommerce/ExportPelanggan/getItemByDateExport'); ?>" class="btn btn-md btn-success pull-right" style="margin-left:10px; margin-right:40px;" type="submit" disabled><i class="glyphicon glyphicon-export"></i>EXPORT</button>
                                                    <?php
                                                    } else {
                                                    ?>
                                                    <button formaction="<?php echo base_url('ECommerce/ExportPelanggan/getItemByDateExport'); ?>" class="btn btn-md btn-success pull-right" style="margin-left:10px; margin-right:40px;" type="submit"><i class="glyphicon glyphicon-export"></i>EXPORT</button>
                                                    <?php
                                                    }?>
