                                ...
                                <form name="Orderform" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validasi();window.location.reload();" method="post">
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-8" style="text-align: left;">
                                            <select class="form-control select2" id="kodekompp" name="kodekompp" data-placeholder="Select">
                                                <option></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-8" style="text-align: left;">
                                            <select class="form-control select2 status_komp" id="status_komp" name="status_komp" data-placeholder="Select">
                                                <option></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-8" style="text-align: left;">
                                            <select class="form-control select2 produkk" id="produkk" name="produkk" data-placeholder="Select">
                                                <option></option>
                                            </select></div>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-8" style="text-align: left;">
                                            <select class="form-control select2 saranahand" id="saranahand" name="saranahand" data-placeholder="Select">
                                                <option></option>
                                            </select></div>
                                    </div>
