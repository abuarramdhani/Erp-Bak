            ...
            <div class="col-lg-12">
                        <div class="box box-primary box-solid">
                            ...
                            <div class="box-body">
                                <div class="table" style="margin-bottom: 12px;  width: 100%;">
									<div>
										<table class="datatable table table-striped table-bordered table-hover text-left" id="tblDataStock" style="width: 100%;font-size: 13px; ">
											<thead class="bg-primary">
												<tr>
											...
											<?php
												...
												?>
                                                        ...
                                                        <td class="text-center">
                                                            <a data-toggle="modal" data-target="#Modalku<?php echo $no; ?>" class="btn btn-success fa fa-pencil-square-o"></a>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="qty">Qty</label>
                            <input class="form-control" id="qty" name="qty" type="number" id="number">
                    </div>
                    <div class="form-group">
