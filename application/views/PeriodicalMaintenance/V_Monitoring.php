                    ...
                    <div class="col-md-12">
                        <div class="box box-primary box-solid">
                            ...
                            <div class="box-body">
                                ...
                                <div class="panel-body">
                                    <div class="col-md-6">
                                        <button  type="button" onclick="getPMEMon(this)" class="btn btn-success" id="btnfind" title="search"><i class="fa fa-search"></i> Find</button>
                                    </div>
                                    <div class="col-md-6">
                                        <button class="btn btn-danger" id="btncetak" title="cetak" target="_blank" style="float: right;"><i class="fa fa-print"></i> Cetak</button>
                                    </div>
                                </div>
                            </div>
                        </div>
