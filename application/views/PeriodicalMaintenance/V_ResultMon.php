                    ...
                    <tbody>
                        ...
                        foreach ($value as $k => $row) { ?>
                            <tr class="text-center">
                                ...
                                <td><span class="btn btn-warning" onclick="getDetailPMEMon(this, <?= $no ?>)">Detail</span></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td colspan="4">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align:left"><input type="hidden" name="periode[]" value="<?= $v['PERIODE_CHECK'] ?>" /><?= $v['PERIODE_CHECK'] ?></td>
                                                        <td style="text-align:left"><input type="hidden" name="durasi[]" value="<?= $v['DURASI'] ?>" /><?= $v['DURASI'] ?></td>
                                                        <td style="text-align:left"><input type="hidden" name="kondisi[]" value="<?= $v['KONDISI'] ?>" /><?= $v['KONDISI'] ?></td>
                                                        <td style="text-align:left"><input type="hidden" name="catatan[]" value="<?= $v['CATATAN'] ?>" /><?= $v['CATATAN'] ?></td>
                                                        <td class="text-center">
                                                            <button type="button" class="btn btn-primary btn-sm" onclick="editRowPMEMon('<?= $v['SUB_HEADER'] ?>')"> Edit </button> 
