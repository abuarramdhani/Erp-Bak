    ...
    <div class="modal-dialog" role="document">
        ...
        <form method="post" action="<?= base_url('civil-maintenance-order/setting/add_jns_pkj') ?>">
                ...
                <div class="modal-body text-center">
                    ...
                    <input oninput="this.value = this.value.toUpperCase()" placeholder="Masukan Jenis Pekerjaan" class="form-control" name="pekerjaan" required="">
                     <label style="margin-top: 20px;">Keterangan</label>
                    <input oninput="this.value = this.value.toUpperCase()" placeholder="Masukan Keterangan Pekerjaan" class="form-control" name="ket" required="">
                </div>
...
<div class="modal fade" id="cmoupjenisorder" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form method="post" action="<?= base_url('civil-maintenance-order/setting/up_jns_pkj') ?>">
                ...
                <div class="modal-body text-center">
                    <label>Jenis Pekerjaan</label>
                    <input oninput="this.value = this.value.toUpperCase()" placeholder="Masukan Jenis Pekerjaan" class="form-control" name="upjenisOrder" required="">
                    <label style="margin-top: 20px;">Keterangan</label>
                    <input oninput="this.value = this.value.toUpperCase()" placeholder="Masukan Keterangan Pekerjaan" class="form-control" name="upKet" required="">
