...
<table style="width: 100%" id="tblSMSGudang" class="table table-striped table-bordered table-hover text-center">
	<thead class="toscahead">
										<tr class="bg-primary">
											...
											<th style="width: 8%;" class="text-center">No DO</th>
											<th style="width: 8%;" class="text-center">No SPB</th>
