						...
						<div class="box itsfun1">
					  		...
					  		<div id="tableHolder">
								<div class="box-body">
									...
									<table id="tb_sms" style="min-width: 130%;" class="tb_sms tb_responsive_sms table table-striped table-bordered table-hover text-center">
									<thead class="toscahead">
										<tr class="bg-primary">
											...
											<th class="text-center" style="width: 15%;">Muatan</th>
											<th class="text-center" style="width: 2%;">Full</th>
											<th class="text-center" style="width: 2%;">Percentage (%)</th>
