						...
						<div class="box-body">
							<div class="panel-body">
								...
								<div class="row col-lg-12">
									<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" name="txtNoind" id="txtNoind" class="form-control" placeholder="[Noind Pekerja]" autofocus></input>
											</div>
											<div class="col-md-1">
							...
							<div class="panel-footer">
								<div class="row text-right">
									...
									&nbsp;&nbsp;
									<a id="btnUser" class="btn btn-primary btn-lg btn-rect">Save</a>
								</div>
							</div>
						</div>
						</div>
