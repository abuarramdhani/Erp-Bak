<section class="content">
	<div class="inner" >
		<div class="row">
			<form method="post" action="<?php echo site_url('Toolroom/MasterItem/importCreateUsableItem')?>" enctype="multipart/form-data" class="form-horizontal">
					...
					<div class="col-lg-12">
						<div class="box box-primary box-solid">
							<div class="box-header with-border">
								Header 
								<a href="<?php echo site_url('Toolroom/MasterItem/CreateUsableItem') ?>" style="float:right;margin-right:1%;margin-top:-0.5%;" alt="Add New" title="View Example Document" >
