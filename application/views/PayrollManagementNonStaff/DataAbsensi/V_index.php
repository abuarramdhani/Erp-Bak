                                    ...
                                    <div class="col-lg-12">
                                        <form class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <select class="select2" id="slcPeriodeDataAbsensi" style="width: 100%">
                                                        <option></option>
                                                        <?php 
                                                        ...
                                                        foreach ($data as $key) { 
                                                            ...
                                                            ?>
                                                            <option value="<?php echo $key['bln_gaji']."-".$key['thn_gaji']."-".$key['ket'] ?>"><?php echo $bulan[$key['bln_gaji']].' '.$key['thn_gaji']." ".$key['ket'] ?></option>
                                                        <?php }
                                                        ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-8 text-right">
                                                    <button class="btn btn-primary" id="btnShowListDataAbsensi" type="button">Proses</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
