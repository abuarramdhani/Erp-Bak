                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box box-primary box-solid">
                            ...
                            <div class="box-body">
                                <form id="ImportDataKondite" class="form-horizontal" method="post" action="<?php echo site_url('PayrollManagementNonStaff/ProsesGaji/Kondite/doImport');?>" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="button" id="btnImportDataKondite" class="btn btn-primary btn-block" style="float: right;">Import</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
