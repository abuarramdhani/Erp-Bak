                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box box-primary box-solid">
                            ...
                            <div class="box-body">
                                <form id="clearData" class="form-horizontal" method="post" action="<?php echo site_url('PayrollManagementNonStaff/ProsesGaji/Kondite/doClearData');?>">
                                            ...
                                            <div class="modal fade" id="clear-alert">
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        Apakah Anda yakin ingin menghapus data Absensi pada periode tersebut?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                            <button type="button" id="btnClearData" class="btn btn-danger">Kosongkan Data</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
