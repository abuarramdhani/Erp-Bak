                        ...
                        <div class="box box-primary box-solid">
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table class="datatable table table-striped table-bordered table-hover text-left" id="tblTambahan" style="font-size:12px;min-width: 100%">
                                        <thead class="bg-primary">
                                            <tr>
												...
												<th class="text-center" width="100px">Kurang Bayar</th>
												<th class="text-center" width="100px">Lain Lain</th>
											</tr>
                                        </thead>
                                    </table>
                                </div>
