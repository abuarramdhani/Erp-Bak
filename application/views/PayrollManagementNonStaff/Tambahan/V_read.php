                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header with-border">Read Tambahan</div>
                                <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="table-responsive">
                                                    ...
                                                    <?php foreach ($Tambahan as $headerRow): ?>
														<tr>
														...
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Kurang Bayar</strong></td>
                                                            <td style="border: 0">: <?php echo $headerRow['kurang_bayar']; ?></td>
                                                        </tr>
														<tr>
                                                            <td class="col-lg-2" style="border: 0"><strong>Lain Lain</strong></td>
                                                            <td style="border: 0">: <?php echo $headerRow['lain_lain']; ?></td>
                                                        </tr>
													<?php endforeach; ?>
                                                    </table>
                                                </div>
