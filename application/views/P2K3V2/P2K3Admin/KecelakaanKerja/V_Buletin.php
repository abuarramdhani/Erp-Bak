	...
	<table style="width: 100%;" class="br-bottom">
		<tr>
			...
			<td style="width: 12%;" class="center br-left">
				...
				<br><br><br><br>
				<p style="font-weight: bold;">( Oktavian TS )</p>
			...
			<td style="width: 12%;" class="center">
				...
				<br><br><br><br>
				<p style="font-weight: bold;">( Tengku Dian S.R )</p>
							...
							<table style="width: 100%">
								<tr>
									<td style="padding-bottom: 5px; padding-top: 5px;text-align: center;">
										...
										<label>2019 = <?= $perbandingan1['tahunlalu'] ?></label>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="kotak" style="background-color: blue; color: blue;">aa</span>
										<label>2020 = <?= $perbandingan1['tahunini'] ?></label>
									</td>
								</tr>
								<tr>
									<td>
							...
							<table class="tbl-pad" border="1">
								...
								<?php for ($i=0; $i < 12; $i++) {
									...
									<tr>
										...
										<td><?= $laka['jmlp'][$i] ?></td>
										<td><?= $laka['lakap'][$i] ?></td>
										<td><?= round($laka['lakap'][$i]/$laka['jmlp'][$i]*100,1) ?> %</td>
										<td><?=$laka['jmlt'][$i]?></td>
										<td><?=$laka['lakat'][$i]?></td>
										<td><?= round($laka['lakat'][$i]/$laka['jmlt'][$i]*100,1) ?> %</td>
									</tr>
									<?php } ?>
								</table>
							</td>
