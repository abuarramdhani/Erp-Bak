                            ...
                            <div class="box-body">
                                <div class="panel-body">
                                 <div class="row">
                                     <div class="col-md-12">
                                         <?php if (empty($email)): ?>
                                         <button style="float: right;" class="btn btn-success et_add_email_seksi">Add Email</button>
                                        <?php endif ?>
                                     </div>
                                     ...
                                     <table class="table table-striped table-bordered table-hover text-center et_jenis_penilaian">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-info btn-sm et_edit_email_seksi" data-toggle="tooltip" data-placement="top" title="Edit">
