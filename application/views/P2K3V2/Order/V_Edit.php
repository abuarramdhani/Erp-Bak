<section class="content">
    <div class="inner" >
        <div class="row">
            <form method="post" action="<?php echo site_url('P2K3_V2/Order/update_data/'.$edit[0]['id_kebutuhan_detail'].'/'.$edit[0]['kodesie']);?>" class="form-horizontal">
                <div class="col-lg-12">
                    <div class="col-lg-11">
                    ...
                    <div class="col-lg-1">
                        <div class="text-right hidden-md hidden-sm hidden-xs">
                            <a class="btn btn-default btn-lg" href="<?php echo site_url('P2K3_V2/Order/edit');?>">
