<?php $i=1;foreach($kumpulandata as $data){ ?>
<div class="row" style="margin-top:200px;">
	<table style="width: 100%; margin-top: 40px; border:1px solid black; border-bottom :0px; " >
		<tr>
			...
			<td rowspan="4" style="width: 40%; border-bottom: 1px solid black; padding-left: 10px;">
				<p style="font-size: 11px;"><strong>CV. KARYA HIDUP SENTOSA</strong></p>
				<p style="font-size: 9px;">Jl. Magelang No. 144 YOGYAKARTA</p>
				<br/>
				<p style="font-size: 16px;"><strong>BUKTI PERMINTAAN & PEMAKAIAN BARANG GUDANG (BPPBG)</strong></p>

			</td>
			<td rowspan="4" style="width: 5%; border-right: 1px solid black; border-bottom: 1px solid black; text-align: center;">
		...
		<tr>
			<td colspan="3" style="border-right: 1px solid black; font-size: 11px; height: 30px;">
	...
	<table style="width: 100%;border:1px solid black; border-top: 0px" >
		<thead>
			<tr>
...
?>
			<tr>
				...
				<td style="font-size: 10px; border-bottom: 1px solid black">&nbsp;<?php echo $data_body['nama'].' '.$data_body['produk'];
				?></td>
...
?>
	...
	<table style="width: 100%; margin-bottom: 10px ;border:1px solid black; border-top: 0px; text-align: center;vertical-align: text-top; font-size: 11px" >
		<tr>
