                    ...
                    <div class="col-lg-12">
                        <div class="box box-primary box-solid">
                            <div class="box-header with-border" style="height: 60px;">
                                <a href="<?php echo site_url('P2K3_V2/Order/input')?>">
                            ...
                            <div class="box-body">
                                <div hidden class="row" style="margin-right: 3px;"> <!-- ini kalau mau documnet approval -->
                                    <div class="col-lg-6">
                                         <form class="form-horizontal" method="POST" style="border:1px solid #3c8dbc;border-radius: 3px;padding-top: 10px" enctype="multipart/form-data" action="<?php echo base_url('P2K3_V2/Order/UploadApproval'); ?>">
                                            <div class="form-group">
                                    ...
                                    <div hidden class="col-lg-6 text-right"> <!-- ini kalau mau documnet approval -->
                                        <div class="row">
                                            <a target="_blank" href="<?php echo site_url('P2K3_V2/Order/approval')?>" class="btn btn-danger ">
                                                Document Approval &nbsp<span class="fa fa-file-pdf-o"></span>
                                            </a>
                                            <a class="btn btn-primary" id="bt_export" href="<?php echo site_url('P2K3_V2/Order/export')?>">
                                ...
                                <br>
                                    <div class="table-responsive">
                                        <table id="tb_p2k3" class="datatable table table-striped table-bordered table-hover" style="font-size:12px; overflow-x: scroll;">
                                            <thead class="bg-primary">
                                                <tr>
                                                    <th width="5%" style="text-align: center; vertical-align: middle;">NO</th>
                                                    <th width="15%" style="text-align: center; vertical-align: middle;">APD</th>
                                                    <th style="text-align: center; vertical-align: middle;">KODE ITEM</th>
                                                    <?php
                                                    ...
                                                    ?>
                                                        ...
                                                        <th width="10%" style="text-align:center; vertical-align: middle;">Jumlah Pekerja (<?php echo $pekerjaan['pekerjaan'];?>)</th>
                                                     <?php
                                                         }
                                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <!-- <td style="text-align: center;" align="center">
                                                        <a data-toggle="tooltip" data-placement="left" title="Edit" href="<?php echo site_url('P2K3_V2/Order/edit'.'/'.$id_kebutuhan_detail) ?>">
                                                            <button type="button" class="btn btn-info btn-xs">
                                                                <span class="glyphicon glyphicon-edit"></span>
                                                            </button>
                                                        </a>
                                                        <a data-toggle="tooltip" data-placement="left" title="Delete" href="<?php echo site_url('P2K3_V2/Order/delete_apd'.'/'.$id_kebutuhan_detail) ?>">
                                                        ...
                                                        ?>
                                                         ...
                                                         <a href="<?php echo site_url('P2K3_V2/Order/approve'.'/'.$row['id_kebutuhan'].'/'.$row['id_kebutuhan_detail']);?>">
                                                            <button type="button" class="btn btn-success" style="margin: 10px 0 10px 0; padding: 5px 10px" >
                                                                <span class="glyphicon glyphicon-ok"></span>Approve
                                                            </button>
                                                        </a> 
                                                        <a href="<?php echo site_url('P2K3_V2/Order/reject'.'/'.$row['id_kebutuhan_detail']);?>">
