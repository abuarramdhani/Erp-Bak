                    ...
                    <div class="col-lg-12">
                        <div class="box box-primary box-solid">
                            <div class="box-header with-border" style="height: 60px;">
                                <a hidden href="<?php echo site_url('P2K3_V2/Order/input')?>">
                            ...
                            <div class="box-body">
                                <div hidden class="row text-right" style="margin-right: 3px;">
                                    <a hidden class="btn btn-primary" id="bt_export" href="<?php echo site_url('P2K3_V2/Order/export')?>">Export &nbsp<span class="glyphicon glyphicon-arrow-up"></a>
                                </div>
                                <br>
                                        ...
                                        <table id="tb_p2k3" class="datatable table table-striped table-bordered table-hover text-left" style="font-size:12px;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;" align="center">
                                                        <a hidden data-toggle="tooltip" data-placement="left" title="Edit" href="<?php echo site_url('P2K3_V2/Order/edit'.'/'.$id_kebutuhan_detail) ?>">
                                                            <button type="button" class="btn btn-info btn-xs">
                                                                <span class="glyphicon glyphicon-edit"></span>
                                                            </button>
                                                        </a>
                                                        <a hidden data-toggle="tooltip" data-placement="left" title="Delete" href="<?php echo site_url('P2K3_V2/Order/delete_apd'.'/'.$id_kebutuhan_detail) ?>">
...
//        window.location.replace("<?php echo site_url('P2K3_V2/Order/approve');?>"+approve);
//     } else {
//       return false;
//     }
//     return false;
