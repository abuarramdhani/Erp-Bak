...
<body>
	...
	<table border="1" style="border-collapse: collapse; text-align: center; font-size: 10px; width: 100%" class="table table-bordered table-hover text-center tb_et_bulanan">
		<caption align="center" style="color: black;font-weight: bold; font-size: 14px; text-align: center;">Data TIMS Pekerja Staf Baru<br><?php echo $nama ?></caption>
			<thead>
				<tr>
					<th>No</th>
					<th>No Induk</th>
		...
		<table border="0">
			...
			<tr>
				<td width="40%" style="padding: 10px;" colspan="2" valign="top">
					<ul>
						<li>Standar kelolosan frekuensi TIMS OJT staf selama 6 bulan*):</li>
					</ul>
				</td>
