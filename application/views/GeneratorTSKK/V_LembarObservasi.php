								...
								<div class="row">
											<div class="col-lg-12" >
												<div class="panel panel-default">
													...
													<label style="margin-left:3%;" for="norm">Takt Time : </label>
									...
									<!--1-->					<td><input type="number" onchange="minMaxId(this)" name="waktu1[]" class="form-control waktuObs inputWaktuKolom1" placeholder="Detik"></td>
									<!--2-->					<td><input type="number" onchange="minMaxId(this)" name="waktu2[]" class="form-control waktuObs inputWaktuKolom2" placeholder="Detik"></td>
									<!--3-->					<td><input type="number" onchange="minMaxId(this)" name="waktu3[]" class="form-control waktuObs inputWaktuKolom3" placeholder="Detik"></td>
									<!--4-->					<td><input type="number" onchange="minMaxId(this)" name="waktu4[]" class="form-control waktuObs inputWaktuKolom4" placeholder="Detik"></td>
									<!--5-->					<td><input type="number" onchange="minMaxId(this)" name="waktu5[]" class="form-control waktuObs inputWaktuKolom5" placeholder="Detik"></td>
									<!--6-->					<td><input type="number" onchange="minMaxId(this)" name="waktu6[]" class="form-control waktuObs inputWaktuKolom6" placeholder="Detik"></td>
									<!--7-->					<td><input type="number" onchange="minMaxId(this)" name="waktu7[]" class="form-control waktuObs inputWaktuKolom7" placeholder="Detik"></td>
									<!--8-->					<td><input type="number" onchange="minMaxId(this)" name="waktu8[]" class="form-control waktuObs inputWaktuKolom8" placeholder="Detik"></td>
									<!--9-->					<td><input type="number" onchange="minMaxId(this)" name="waktu9[]" class="form-control waktuObs inputWaktuKolom9" placeholder="Detik"></td>
                                ...
                                <tbody id="tbodyIrregularJob">
									...
									<div class="col-lg-12" style="padding-top: 8px;">
										<div style="text-align:center;">
											...
											<button type="button" onclick="checkNilaiDistribusiObservasi(this)" style="float: center; margin-right: 3%; margin-top: -0.5%;" class="btn btn-primary btn-md" id="btnSaveObservation"><i class="fa fa-floppy-o "></i>  SIMPAN LEMBAR OBSERVASI</button>
										</div>
									</div>
									<br>
								</div>
