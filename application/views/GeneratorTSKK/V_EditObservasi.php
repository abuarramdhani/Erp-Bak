			...
			<div class="col-lg-12">
								...
								<div class="box box-primary box-solid col-lg-12" style="padding-right: 7px;padding-left: 7px; padding-top: 5px; padding-bottom: 11px;">
									...
									<!--2-->
										...
										<div class="row equipmenTdkTerdaftar" style="<?php if ($jenisInputElement != "TidakTerdaftar") { echo "display:none";}?>">
												<label for="norm" class="control-label col-lg-4">Alat Bantu :</label>
												<div class="col-lg-8">
													<input type="text" value="<?php if ($jenisInputElement == "TidakTerdaftar") { echo $alat_bantu; } ?>" placeholder="Input Alat Bantu" name="txtAlatBantuT" value="" id="txtAlatBantu" class="form-control txtAlatBantu" required/>
												</div>
										</div>
										<br>
										<div class="row equipmenTerdaftar" style="<?php if ($jenisInputElement != "Terdaftar") { echo "display:none";}?>">
                ...
                <div class="panel-body tskk_delik_cek" <?php echo $takt_time == '99999' ? 'style="display:none"' : ''?>>
								...
								?>
									<div class="col-lg-6">
										<div class="row">
												...
												<div class="col-lg-6">
													<input type="number" style="margin-left:-35px;" value="<?php echo $waktu_satu_shift;?>" placeholder="Input Waktu Satu Shift" oninput="countTaktTime()" name="txtWaktu1Shift"  id="txtWaktu1Shift" class="form-control waktu1Shift"/>
												</div>
										</div>
										<br>
										<div class="row">
								...
								<div class="row">
												...
												<div class="panel panel-default">
													<div class="panel-heading">
														...
														<label for="norm" style="margin-left:2%;">Posisi Elemen Tambahan : </label>
															<input type="number" style="width:27%; height:34px;  margin-left:2%; margin-right:2%;" placeholder="Input Posisi untuk Menyisipkan Elemen" name="inputInsert" id="inputInsertPosiition" class="lockscreen-credentials"/>
															<button type="button" class=" btn btn-primary btn-md" style="height:34px;" onclick="attachRowObservation(this)" id="btnInsert">Add</button>
													</div>
													<div class="panel-body">
									...
									<!--1-->					<td><input type="number" value="<?php echo $waktu_1; ?>" onchange="minMaxId(this)"  name="waktu1[]" class="form-control waktuObs inputWaktuKolom1" placeholder="Detik"></td>
									<!--2-->					<td><input type="number" value="<?php echo $waktu_2; ?>" onchange="minMaxId(this)"  name="waktu2[]" class="form-control waktuObs inputWaktuKolom2" placeholder="Detik"></td>
									<!--3-->					<td><input type="number" value="<?php echo $waktu_3; ?>" onchange="minMaxId(this)"  name="waktu3[]" class="form-control waktuObs inputWaktuKolom3" placeholder="Detik"></td>
									<!--4-->					<td><input type="number" value="<?php echo $waktu_4; ?>" onchange="minMaxId(this)"  name="waktu4[]" class="form-control waktuObs inputWaktuKolom4" placeholder="Detik"></td>
									<!--5-->					<td><input type="number" value="<?php echo $waktu_5; ?>" onchange="minMaxId(this)"  name="waktu5[]" class="form-control waktuObs inputWaktuKolom5" placeholder="Detik"></td>
									<!--6-->					<td><input type="number" value="<?php echo $waktu_6; ?>" onchange="minMaxId(this)"  name="waktu6[]" class="form-control waktuObs inputWaktuKolom6" placeholder="Detik"></td>
									<!--7-->					<td><input type="number" value="<?php echo $waktu_7; ?>" onchange="minMaxId(this)"  name="waktu7[]" class="form-control waktuObs inputWaktuKolom7" placeholder="Detik"></td>
									<!--8-->					<td><input type="number" value="<?php echo $waktu_8; ?>" onchange="minMaxId(this)"  name="waktu8[]" class="form-control waktuObs inputWaktuKolom8" placeholder="Detik"></td>
									<!--9-->					<td><input type="number" value="<?php echo $waktu_9; ?>" onchange="minMaxId(this)"  name="waktu9[]" class="form-control waktuObs inputWaktuKolom9" placeholder="Detik"></td>
									<!--10-->					<td><input type="number" value="<?php echo $waktu_10; ?>" onchange="minMaxId(this)" name="waktu10[]" class="form-control waktuObs inputWaktuKolom10" placeholder="Detik"></td>
									...
									<!--W DISTRIBUSI-->			<!--<td><input type="number" value="<?php echo $wktDistribusi ?>" onchange="minMaxId(this)" id="wDistribusi" name="wDistribusi[]" class="form-control wDistribusi" placeholder="Detik"></td>-->
									<!--W DISTRIBUSI-->			<td><input type="number" value="<?php echo $wktDistribusi ?>" onchange="minMaxId(this)" onclick="checkDistributionTime(this)" id="wDistribusi" name="wDistribusi[]" class="form-control wDistribusi" placeholder="Detik"></td>
									<!--W DISTRIBUSI AUTO-->	<td><input type="number" onchange="minMaxId(this)" onclick="checkDistributionTime(this)" id="wDistribusiAuto" name="wDistribusiAuto[]" class="form-control wDistribusiAuto" placeholder="Detik" readonly></td>
									...
									<!--KETERANGAN-->			<td><input type="text" id="keterangan" value="<?php echo $keterangan; ?>" name="keterangan[]" class="form-control keterangan" placeholder="Input Keterangan"></td>
									<!--HAPUS-->				<td>
                              ...
                              <table class="datatable table table-striped table-bordered table-hover tabel_irregular_job" style="width: 100%">
								...
								?>
                                    <tr class="nmbr_1">
                                      ...
                                      <td style="text-align: center;"> <input type="number" value="<?php echo $ratio_irregular;?>" onchange="countIrregularJobs(this)" style="text-align: center;" class="form-control ratio" name="txtRatioIrregular[]" id="ratio"></td>
                                      <td style="text-align: center;"> <input type="number" value="<?php echo $waktu_irregular;?>" onchange="countIrregularJobs(this)" style="text-align: center;" class="form-control waktu" name="txtWaktuIrregular[]" id="waktu"></td>
