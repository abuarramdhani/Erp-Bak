...
<section class="content">
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              ...
                              <input type="number" style="width:45%; height:34px; margin-right:8%;  margin-left:3% ;" value="<?php echo $takt_time; ?>" placeholder="Input Takt Time" name="taktTime" id="inputInsert"
                                ...
                                <table class="table table-striped table-bordered table-hover text-center tblObservasi" style="width:2400px; padding-bottom: 0;" name="tblObservasi" id="tblObservasi">
                                  ...
                                  <tbody id="tbodyLembarObservasi">
                                    ...
                                    <tr class="nomor_" .$no>
                                      ...
                                      <!--1-->
                                      <td><input type="number" value="<?php echo $waktu_1; ?>" onchange="minMaxId(this)" name="fanny[]" class="form-control waktuObs inputWaktuKolom1" placeholder="Detik" readonly></td>
                                      <!--2-->
                                      <td><input type="number" value="<?php echo $waktu_2; ?>" onchange="minMaxId(this)" name="waktu2[]" class="form-control waktuObs inputWaktuKolom2" placeholder="Detik" readonly></td>
                                      <!--3-->
                                      <td><input type="number" value="<?php echo $waktu_3; ?>" onchange="minMaxId(this)" name="waktu3[]" class="form-control waktuObs inputWaktuKolom3" placeholder="Detik" readonly></td>
                                      <!--4-->
                                      <td><input type="number" value="<?php echo $waktu_4; ?>" onchange="minMaxId(this)" name="waktu4[]" class="form-control waktuObs inputWaktuKolom4" placeholder="Detik" readonly></td>
                                      <!--5-->
                                      <td><input type="number" value="<?php echo $waktu_5; ?>" onchange="minMaxId(this)" name="waktu5[]" class="form-control waktuObs inputWaktuKolom5" placeholder="Detik" readonly></td>
                                      <!--6-->
                                      <td><input type="number" value="<?php echo $waktu_6; ?>" onchange="minMaxId(this)" name="waktu6[]" class="form-control waktuObs inputWaktuKolom6" placeholder="Detik" readonly></td>
                                      <!--7-->
                                      <td><input type="number" value="<?php echo $waktu_7; ?>" onchange="minMaxId(this)" name="waktu7[]" class="form-control waktuObs inputWaktuKolom7" placeholder="Detik" readonly></td>
                                      <!--8-->
                                      <td><input type="number" value="<?php echo $waktu_8; ?>" onchange="minMaxId(this)" name="waktu8[]" class="form-control waktuObs inputWaktuKolom8" placeholder="Detik" readonly></td>
                                      <!--9-->
                                      <td><input type="number" value="<?php echo $waktu_9; ?>" onchange="minMaxId(this)" name="waktu9[]" class="form-control waktuObs inputWaktuKolom9" placeholder="Detik" readonly></td>
                                      <!--10-->
                                      <td><input type="number" value="<?php echo $waktu_10; ?>" onchange="minMaxId(this)" name="waktu10[]" class="form-control waktuObs inputWaktuKolom10" placeholder="Detik" readonly></td>
                                      <!--X MIN-->
                                      ...
                                      <!--W DISTRIBUSI-->
                                      <td><input type="number" value="<?php echo $wktDistribusi ?>" onchange="minMaxId(this)" id="wDistribusi" name="wDistribusi[]" class="form-control wDistribusi" placeholder="Detik" readonly></td>
                                      <!--W KERJA-->
                                      <td><input type="number" value="<?php echo $waktu; ?>" id="wKerja" name="wKerja[]" class="form-control wKerja" placeholder="Detik" readonly></td>
                                      <!--KETERANGAN-->
                                      <td><input type="text" id="keterangan" value="<?php echo $keterangan; ?>" name="keterangan[]" class="form-control keterangan" placeholder="Input Keterangan" readonly></td>
                                      <!--HAPUS-->
                                      <td>
      ...
      <tbody id="tbodyGeneratorTSKK">
        ...
        <tr class='<?php echo "number_".$no ?>'>
          ...
          <td class="<?php if ( $tipe_urutan == 'PARALEL') { echo "wrapper"; }; ?>">
            <input type="text" style="<?php if ( $tipe_urutan == 'PARALEL') { echo "background-color: #d55d71;color:white;"; }; ?>;" value="<?php echo $jenis_proses; ?>" id="jenisProses" name="jenisProsesElemen[]" class="form-control jnsProses"
              placeholder="Jenis Proses" readonly></td>
          </td>
          <td class="<?php if ( $tipe_urutan == 'PARALEL') { echo "wrapper"; }; ?>">
          ...
          <td class="<?php if ( $tipe_urutan == 'PARALEL') { echo "wrapper"; }; ?>">
            <input type="text" style="<?php if ( $tipe_urutan == 'PARALEL') { echo "background-color: #d55d71;color:white;"; }; ?>;" value="<?php echo $tipe_urutan; ?>" id="urutanProses" name="tipeUrutanElemen[]" class="form-control"
              placeholder="Tipe Urutan Proses" readonly></td>
          </td>
          <td class="<?php if ( $tipe_urutan == 'PARALEL') { echo "wrapper"; }; ?>"><input type="number" style="<?php if ( $tipe_urutan == 'PARALEL') { echo "background-color: #d55d71;color:white;"; }; ?>;" value="<?php echo $waktu; ?>" id="waktu"
              name="waktuKerja[]" class="form-control waktu" placeholder="Detik" readonly></td>
          <td class="<?php if ( $tipe_urutan == 'PARALEL') { echo "wrapper"; }; ?>"><input type="number" style="<?php if ( $tipe_urutan == 'PARALEL') { echo "background-color: #006bb3;color:white;"; }; ?>;" value="<?php echo $start; ?>"
              onchange="finishTableElement(this)" name="mulai[]" class="form-control mulai" placeholder="Detik" <?php if ( $tipe_urutan == 'SERIAL') { echo "readonly"; }; ?>></td>
          <td class="<?php if ( $tipe_urutan == 'PARALEL') { echo "wrapper"; }; ?>"><input type="number" style="<?php if ( $tipe_urutan == 'PARALEL') { echo "background-color: #d55d71;color:white;"; }; ?>;" value="<?php echo $finish; ?>"
              name="finish[]" class="form-control finish" placeholder="Detik" <?php if ( $tipe_urutan == 'SERIAL') { echo "readonly"; }; ?> readonly></td>
        </tr>
  ...
  <button onclick="addRowObservationAfterNext($(this))" id="myBtn" class="fa fa-plus fa-lg"
