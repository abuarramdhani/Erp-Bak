                        ...
                        <div class="col-lg-1 ">
                            <div class="text-right hidden-md hidden-sm hidden-xs">
                                <a class="btn btn-default btn-lg"
                                    href="<?php echo site_url('MonitoringPicklistPPIC/SudahApprove/');?>">
                            ...
                            <div class="box-body">
                                ...
                                <div class="panel-body bg-gray">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-1">
                                                <button type="button" class="btn btn-info" onclick="sudahapprovePPIC(this)"><i class="fa fa-search"></i> Find</button>
                                        </div>
                                    </div>
                                </div>
                                
                                <div class="panel-body">
                                    <div class="table-responsive" id="tb_sdhapproveppic">
