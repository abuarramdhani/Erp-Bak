<div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover text-left tb-setting_kalibrasi_inactive" style="font-size:14px;width:100%">
                            <thead>
                            <tr class="bg-primary">
                            ...
                            <tbody>
                            <?php $no=1; foreach ($getKalibrasiInactive as $key => $value): ?>
                            <?php 
                               $A = date('Y-m-d');
                            ...
                            <tr style="<?php echo $giveBg?>">
                                ...
                                <td style="text-align:center">
                                <a class="btn btn-primary" href="#" title="Update" data-toggle="modal" data-target="#updateKalibrasiInactive" style="width:37px;margin-right:4px" onclick="updateKalibrasiInactive('<?php echo $value['id']?>' ,'<?php echo $value['no_alat_ukur'] ?>', '<?php echo $value['jenis_alat_ukur'] ?>', '<?php echo $value['last_calibration'] ?>', '<?php echo $value['next_calibration'] ?>', '<?php echo $value['lead_time'] ?>', '<?php echo $value['status'] ?>')">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a class="btn btn-danger" title="Delete" data-id="<?php echo $value['id']?>" onclick="deleteKalibrasiInactive(<?php echo $value['id']?>)">
...
<!--Modal Update-->             
<div class="modal fade" id="updateKalibrasiInactive" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content" style="borde-radius:12px">
      ...
      <div class="modal-body">        
            ...
            <tr>
                <td hidden><input type="text" name="upd_id_inactive" value=""></td>
                <td hidden><input type="text" id="no_alat_ukur_first_inactive" value=""></td>
                <td style="width:23%;padding-top:15px"><b>No.Alat Ukur</b></td>
                <td style="width:3%;padding-top:15px"><b>:</b></td>
                <td style="width:74%;padding-top:15px"><input type="text" id="upd_no_alat_ukur_inactive" class="form-control" required value=""></td>
            </tr>
            <tr>
                <td style="width:23%;padding-top:15px"><b>Jenis Alat Ukur</b></td>
                <td style="width:3%;padding-top:15px"><b>:</b></td>
                <td style="width:74%;padding-top:15px"><input type="text" id="upd_jenis_alat_ukur_inactive" class="form-control" value=""></td>
            </tr>
            <tr>
                <td style="width:23%;padding-top:15px"><b>Last Calibration</b></td>
                <td style="width:3%;padding-top:15px"><b>:</b></td>
                <td style="width:74%;padding-top:15px"><input type="date" id="upd_last_calibration_inactive" class="form-control" value=""></td>
            </tr>
            <tr>
                <td style="width:23%;padding-top:15px"><b>Next Calibration</b></td>
                <td style="width:3%;padding-top:15px"><b>:</b></td>
                <td style="width:74%;padding-top:15px"><input type="date" id="upd_next_calibration_inactive" class="form-control" value=""></td>
            </tr>
            <tr>
                <td style="width:23%;padding-top:15px"><b>Lead Time</b></td>
                <td style="width:3%;padding-top:15px"><b>:</b></td>
                <td style="width:74%;padding-top:15px"><input type="number" id="upd_lead_time_inactive" class="form-control" value=""></td>
            </tr>
            <tr>
                <td style="width:23%;padding-top:15px"><b>Status</b></td>
                <td style="width:3%;padding-top:15px"><b>:</b></td>
                <td style="width:74%;padding-top:15px">
                <select class="form-control select-2-status" name="upd_status_inactive">
        ...
        <div class="modal-footer" style="margin-bottom:-15px">
          <button type="button" class="btn btn-success" onclick="kirimUpdateInactive()" style="margin-left:-15px"><i class="fa fa-save"></i> Save</button>
...
$('.tb-setting_kalibrasi_inactive').dataTable({});
