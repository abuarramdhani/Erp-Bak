...
class M_assetcabangakuntansi extends CI_Model
{
  var $oracle;
  function __construct()
  {
    ...
    public function updateAkuntansi($id,$batch_number,$status,$user)
    {
        $db = $this->load->database();
        $sql = "update ac.ac_proposal_asset set status = '$status' where id_proposal = '$id'";
        $runQuery = $this->db->query($sql);
