...
class M_masterparamptkp extends CI_Model
{

    public $table = 'pr.pr_master_param_ptkp';
	public $table_riwayat = 'pr.pr_riwayat_param_ptkp';
...
/* End of file M_masterparamptkp.php */
/* Location: ./application/models/PayrollManagement/SetTarifPTKP/M_masterparamptkp.php */
