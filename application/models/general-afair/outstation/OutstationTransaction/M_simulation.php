...
where nama.simulation_id = nominal.simulation_id";
	...
	public function new_simulation($employee_id,$area_id,$city_type_id,$depart,$return){
		$sql="insert into ga.ga_outstation_simulation (employee_id, area_id, city_type_id, depart_time, return_time) values ('$employee_id','$area_id','$city_type_id','$depart','$return')";
		$query = $this->db->query($sql);
		return;
	}
	...
	public function update_simulation($simulation_id,$employee_id,$area_id,$city_type_id,$depart,$return){
		$sql="update ga.ga_outstation_simulation set employee_id = '$employee_id', area_id='$area_id', city_type_id='$city_type_id', depart_time='$depart', return_time='$return' where simulation_id='$simulation_id'";
		$query = $this->db->query($sql);
		return;
	}
