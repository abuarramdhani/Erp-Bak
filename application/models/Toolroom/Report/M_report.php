...
class M_report extends CI_Model {
		...
		public function SearchTransaction($shift,$str_dt,$str_end){
			$sql = "select ttl.transaction_id,ttl.item_id,sum(ttl.item_qty) qty_dipakai,tmi.item_name,(ttl.item_awl) item_qty,tmi.item_qty_min,tmi.item_desc,tt.shift,tt.noind,tt.created_by,tt.creation_date,tmi.item_desc,tt.name,tt.toolman
