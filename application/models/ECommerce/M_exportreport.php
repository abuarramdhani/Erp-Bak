...
and tqp.post_status != 'wc-cancelled'
-- LIMIT 5
-- and tu.display_name like 'ari%' -- parameter berdasarkan nama
-- and cat.name like 'Spa%' -- parameter berdasarkan category_item
-- and tqw.order_item_name like 'O-Ring%' -- parameter berdasarkan nama_item
    ";
        $query = $tokoquick->query($sql1);
        // echo $sql1;
        // exit();
