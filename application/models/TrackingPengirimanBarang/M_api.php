...
class M_api extends CI_Model {
	...
	// function readAllBarang() {
	// 	$query = $this->db->order_by('id')->get('tb_api');
	// 	return $query->result_array();
	// }

	// function updateBarang($id, $nama, $deskripsi) {
	// 	$data = array(
	// 		'nama' => $nama,
	// 		'deskripsi' => $deskripsi
	// 	);
	// 	return $this->db->where('id', $id)->update('tb_api', $data) == true;
	// }

	// function deleteBarang($id) {
	// 	return $this->db->where('id', $id)->delete('tb_api') == true;
	// }
}
