...
class M_tanterkesorientasikerja extends CI_Model {
  ...
  public function getData()
  {
    ...
    FROM kk.kk_cetak_kesepakatan_orientasi_kerja
  ...
  public function insert($data) {
    $this->db->insert('kk.kk_cetak_kesepakatan_orientasi_kerja', $data);
  }
  ...
  public function updateCetak() {
    ...
    $this->db->update('kk.kk_cetak_kesepakatan_orientasi_kerja');
  }
  ...
  public function deleteById($id = null) {
    $this->db->where('id', $id);
    $this->db->delete('kk.kk_cetak_kesepakatan_orientasi_kerja');
  }
