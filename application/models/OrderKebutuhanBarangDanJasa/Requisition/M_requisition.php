...
class M_requisition extends CI_Model
{
    ...
    public function getItem($string)
    {
        ...
        TO_CHAR((CASE WHEN (mcb.CATEGORY_ID IN (67009, 67010) AND EXTRACT(DAY FROM SYSDATE)<10) THEN ADD_MONTHS(LAST_DAY(SYSDATE),-1)+ 10 
        WHEN (mcb.CATEGORY_ID IN (67009, 67010) AND EXTRACT(DAY FROM SYSDATE)>= 10 AND EXTRACT(DAY FROM SYSDATE)<25) THEN ADD_MONTHS(LAST_DAY(SYSDATE),-1)+ 25
        WHEN (mcb.CATEGORY_ID IN (67009, 67010) AND EXTRACT(DAY FROM SYSDATE)>= 25) THEN LAST_DAY(SYSDATE)+ 10
        WHEN (mcb.CATEGORY_ID IN (67007, 67008) AND EXTRACT(DAY FROM SYSDATE)<10) THEN ADD_MONTHS(LAST_DAY(SYSDATE),-1)+ 10 
        WHEN (mcb.CATEGORY_ID IN (67007, 67008) AND EXTRACT(DAY FROM SYSDATE)>= 10) THEN LAST_DAY(SYSDATE)+ 10
        END), 'DD-Mon-YYYY') CUTOFF_TERDEKAT
