...
$(document).ready(function() {  
 ...
 //        hourFormat: 12 });
  ...
  var lok = $('.sm-pilihlokasi').val();
  $('.sm-pilihlokasi').change(function(){
  		$('.sm-pilihSeksi').each(function () { //added a each loop here
  			$(this).select2('val', '');
  		});
  		lok  = $('.sm-pilihlokasi').val();
  	});
  ...
  $('.sm-pilihlokasi').select2(
  {
  	...
  	ajax: 
  	{
  		url: baseurl+'SiteManagement/Order/allLokasi',
  		dataType: 'json',
  		delay: 500,
  		type: "GET",
  		data: function (params){
