$(function () {
				...
				return {
					results: $.map(data, function (cabang) {
						return {
							...
							text: cabang.kode_mitra+' - '+cabang.kota+' - '+cabang.keterangan
						};
					})
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        document.getElementById('modal-editTahap2').href = baseurl+"MasterPekerja/KecelakaanKerja/editTahap2/"+NextId;
