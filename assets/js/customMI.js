    ...
    .then((result) => {
      if (result.value) {
        $.ajax({
          ...
          url:
            baseurl +
            "AccountPayables/MonitoringInvoice/InvoiceBermasalahAkt/resetInvoice",
          data: {
...
function bukaHasilConf(th) {
  ...
  $("h5.modal-title-footer").html(
    "<i>(*)Dokumen Ditolak Purchasing = Dokumen tidak tersedia/Dokumen tidak diturunkan (kecuali kondisi Without Document)</i>"
  );
  $("modal-body").html(
    "<center><img id='loading12' style='width:200px ;margin-top: 2%;' src='" +
      baseurl +
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahAkt/getHasilKonfirmasi",
    data: {
      invoice_id: invoice_id,
    },
    success: function (response) {
...
function returnedConfirmation(th) {
  ...
  $("h5.modal-title").html(
    "MASUKKAN FEEDBACK INVOICE RETURNED UNTUK AKUNTANSI"
  );
  $(".modal-body").html(
    "<center><img id='loading12' style='width:200px ;margin-top: 2%;' src='" +
      baseurl +
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahKasiePurc/showReturnedfromAkuntansi",
    data: {
      invoice_id: invoice_id,
    },
    success: function (response) {
      ...
      $(".modal-body").html(response);
      $(".modal-footer").html(
        '<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" class="btn btn-primary" onclick="submitReturned(' +
          th +
          ')" id="btnForward"><i class="fa fa-paper-plane"></i> Send</button>'
      );
    },
  });
}
...
function returnedConfirmationBuyer(th) {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahBuyer/List/showModalReturnBuyer",
    data: {
      invoice_id: invoice_id,
    },
    success: function (response) {
      ...
      $(".modal-body").html(response);
      $(".modal-footer").html(
        '<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" class="btn btn-primary" onclick="submitReturnedBuyer(' +
          th +
          ')" id="btnForward"><i class="fa fa-paper-plane"></i> Send</button>'
      );
    },
...
function submitReturned(th) {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahKasiePurc/returnToAkuntansi",
    data: {
      invoice_id: invoice_id,
...
function submitReturnedBuyer(th) {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahBuyer/List/returnToAkuntansiBuyer",
    data: {
      invoice_id: invoice_id,
...
function kategoriBermasalah(th) {
  ...
  if (param !== null) {
    ...
    if (param2 == true && cek == "") {
      $(".customDiv").html(
        '<input type="text" class="form-control" placeholder="Masukkan Keterangan" style="width: 320px;" name="txtLainLain" id="inputLain">'
      );
...
function kelengkapanDokumen(th) {
  ...
  if (param !== null) {
    ...
    if (param2 == true && cek == "") {
      $(".customDoc").html(
        '<input type="text" class="form-control" placeholder="Masukkan Keterangan" style="width: 320px;" name="txtDokumenLain" id="dokumenLain">'
      );
    } else if (param2 == false) {
      $(".customDoc").html("");
    }
...
function updatePO(th) {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/Unprocess/updatePONumberBermasalah",
    data: {
      invoice_id: invoice_id,
      nomor_po: nomor_po,
      vendor_id: vendor_id,
    ...
    success: function (response) {
      ...
      window.location.replace(
        baseurl + "AccountPayables/MonitoringInvoice/InvoiceBermasalahAkt"
      );
    },
  });
}
    ...
    .then((result) => {
      if (result.value) {
        $.ajax({
          type: "POST",
          url:
            baseurl + "AccountPayables/MonitoringInvoice/Invoice/deleteInvoice",
          dataType: "JSON",
          data: {
            invoice_id: arry,
          },
  ...
  if ($(".submit_checking_all_rejected").iCheck("update")[0].checked) {
    $(".chckInvoice_rejected").each(function () {
      var a = $(this)
        ...
        .parent()
        .closest("tr")
        .find('input[class~="chckInvoice_rejected"]');
      if (a) {
        $(this).iCheck("check");
      }
    });
...
function btnApproveBerkas(th) {
  ...
  div.html(
    '<span class="label label-success"><i class="fa fa-check"></i> Diterima<br></span>'
  );
...
function btnRejectBerkas(th) {
  ...
  div.html(
    '<span class="label label-danger label-sm"><i class="fa fa-times"></i> Ditolak<br></span>'
  );
  date.val(tanggal).trigger("change");
  div_date.html("<span>" + tanggal + "</span>");
}
  ...
  if (feedback == "") {
    ...
    $("#mdlYesAkt").click(function () {
      $.ajax({
        ...
        url:
          baseurl +
          "AccountPayables/MonitoringInvoice/InvoiceBermasalahKasiePurc/List/saveInvBermasalah",
        data: {
          invoice_id: invoice_id,
          txaFbPurc: feedback,
          status_berkas: arry,
        ...
        success: function (response) {
          Swal.fire("Saved!", "Data sudah dikonfirmasi", "success");
          $("#mdlNotifikasiKasie").modal("hide");
          window.location.replace(
            baseurl +
              "AccountPayables/MonitoringInvoice/InvoiceBermasalahKasiePurc/List"
          );
        },
      });
    });
...
function openMdlPurcConf(th) {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahKasiePurc/List/getDataDokumen",
    data: {
      invoice_id: invoice_id,
    },
    success: function (response) {
      ...
      $(".modal-body").html(response);
      $(".modal-footer").html(
        '<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" class="btn btn-success" onclick="saveBerkas(' +
          th +
          ')" id="btnSave"><i class="fa fa-check"></i> Save</button>'
      );
    },
  });
}
...
function konfirmasiKembaliPurc(th) {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahKasiePurc/List/getDataReKonfirmasi",
    data: {
      invoice_id: invoice_id,
    },
    success: function (response) {
      ...
      $(".modal-body").html(response);
      $(".modal-footer").html(
        '<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" class="btn btn-success" onclick="saveBerkasRePurc(' +
          th +
          ')" id="btnSave"><i class="fa fa-check"></i> Save</button>'
      );
    },
...
function konfirmasiKembaliAkt(th) {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahAkt/getDataReKonfirmasi",
    data: {
      invoice_id: invoice_id,
    },
    success: function (response) {
      ...
      $(".modal-body").html(response);
      $(".modal-footer").html(
        '<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" class="btn btn-success" onclick="saveBerkasReAkt(' +
          th +
          ')" id="btnSave"><i class="fa fa-check"></i> Save</button>'
      );
    },
...
function saveBerkasReAkt(th) {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahAkt/saveReconfirmInvBermasalah",
    data: {
      invoice_id: invoice_id,
      // txaFbPurc:feedback,
      status_berkas: arry2,
    ...
    success: function (response) {
      Swal.fire("Saved!", "Data konfirmasi tersimpan", "success");
...
function saveBerkasRePurc(th) {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahKasiePurc/List/saveReconfirmInvBermasalah",
    data: {
      invoice_id: invoice_id,
      // txaFbPurc:feedback,
      status_berkas: arry2,
...
function KonfirmasiBuyer(th) {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahBuyer/List/KonfirmasiBuyer",
    data: {
      invoice_id: invoice_id,
    },
    success: function (response) {
      ...
      $(".modal-body").html(response);
      $(".modal-footer").html(
        '<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" class="btn btn-success" onclick="saveKonfirmasiBuyer(' +
          th +
          ')" id="btnForward"><i class="fa fa-check"></i> Save</button>'
      );
    },
  });
}
...
function saveKonfirmasiBuyer(th) {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahBuyer/List/saveInvBermasalahBuyer",
    data: {
      invoice_id: invoice_id,
      status_berkas: arry2,
      waktu_berkas: arry3,
...
function FeedbackBuyer(th) {
  ...
  $("#MdlBuyer").modal("show");
  $("h5.modal-title").html(
    "MASUKKAN FEEDBACK INVOICE BERMASALAH UNTUK PURCHASING"
  );
  $(".modal-body").html(
    "<center><img id='loading12' style='width:200px ;margin-top: 2%;' src='" +
      baseurl +
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahBuyer/List/InputFeedbackBuyer",
    data: {
      invoice_id: invoice_id,
    },
    success: function (response) {
      ...
      $(".modal-body").html(response);
      $(".modal-footer").html(
        '<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" class="btn btn-primary" onclick="sendFeedbackBuyer(' +
          th +
          ')" id="btnForward"><i class="fa fa-paper-plane"></i> Send</button>'
      );
    },
...
function selesaikanInvoice(th) {
  ...
  swalWithBootstrapButtons
    .fire({
      ...
      text:
        "Yakin ingin menngakhiri Invoice ID." +
        invoice_id +
        " dari status Bermasalah?",
      type: "warning",
      showCancelButton: true,
    ...
    .then((result) => {
      if (result.value) {
        $.ajax({
          ...
          url:
            baseurl +
            "AccountPayables/MonitoringInvoice/InvoiceBermasalahAkt/EndStatus",
          data: {
            invoice_id: invoice_id,
          },
          success: function (response) {
...
function openReturnedInv(th) {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahAkt/openModalReturned",
    data: {
      invoice_id: invoice_id,
    },
    success: function (response) {
      ...
      $(".modal-footer").html(
        '<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" class="btn btn-primary" onclick="returnedInvoice(' +
          th +
          ')" id="btnForward"><i class="fa fa-paper-plane"></i> Send</button>'
      );
    },
...
function returnedInvoice(th) {
  ...
  swalWithBootstrapButtons
    .fire({
      ...
      text:
        "Yakin ingin mengembalikan Invoice ID." +
        invoice_id +
        " ke Purchasing?",
      type: "warning",
      showCancelButton: true,
    ...
    .then((result) => {
      if (result.value) {
        $.ajax({
          ...
          url:
            baseurl +
            "AccountPayables/MonitoringInvoice/InvoiceBermasalahAkt/Returning",
          data: {
            invoice_id: invoice_id,
          ...
          success: function (response) {
            swalWithBootstrapButtons.fire(
              ...
              "Invoice ID." +
                invoice_id +
                " berhasil dikembalikan, pantau invoice di menu Returned Invoice!",
              "success"
            );
            window.location.replace(
              baseurl + "AccountPayables/MonitoringInvoice/ReturnedInvoice"
            );
          },
        });
      } else if (result.dismiss === Swal.DismissReason.cancel) {
...
function submitToBuyer(th) {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahKasiePurc/List/getDataBuyer",
    data: {
      invoice_id: invoice_id,
    },
    success: function (response) {
      ...
      $(".modal-body").html(response);
      $(".modal-footer").html(
        '<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" class="btn btn-primary" onclick="forwardAkt(' +
          th +
          ')" id="btnForward"><i class="fa fa-paper-plane"></i> Forward</button>'
      );
    },
  });
}
...
function feedbackAkt(th) {
  ...
  $("#MdlPurchasing").modal("show");
  $("h5.modal-title").html(
    "MASUKKAN FEEDBACK INVOICE BERMASALAH UNTUK AKUNTANSI"
  );
  $(".modal-body").html(
    "<center><img id='loading12' style='width:200px ;margin-top: 2%;' src='" +
      baseurl +
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceBermasalahKasiePurc/List/InputFeedback",
    data: {
      invoice_id: invoice_id,
    },
    success: function (response) {
      ...
      $(".modal-body").html(response);
      $(".modal-footer").html(
        '<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" class="btn btn-primary" onclick="sendFeedback(' +
          th +
          ')" id="btnForward"><i class="fa fa-paper-plane"></i> Send</button>'
      );
    },
  ...
  if (param !== " ") {
    if (param == "") {
      ...
      $.ajax({
        ...
        url:
          baseurl +
          "AccountPayables/MonitoringInvoice/InvoiceBermasalahKasiePurc/List/submitFeedback",
        data: {
          invoice_id: invoice_id,
          feedback: feedback,
        },
        success: function (response) {
          Swal.fire("Sent!", "Data sudah diberi feedback", "success");
          $("#MdlPurchasing").modal("hide");
          window.location.reload();
        },
      });
  ...
  if (param !== " ") {
    if (param == "") {
      ...
      $.ajax({
        ...
        url:
          baseurl +
          "AccountPayables/MonitoringInvoice/InvoiceBermasalahBuyer/List/submitFeedbackBuyer",
        data: {
          invoice_id: invoice_id,
          feedback: feedback,
        },
    ...
    if (param == "") {
      ...
      swalWithBootstrapButtons
        .fire({
          ...
          text:
            "Yakin ingin memforward Invoice ID." +
            invoice_id +
            " ke " +
            no_induk_buyer +
            "?",
        ...
        .then((result) => {
          if (result.value) {
            $.ajax({
              ...
              url:
                baseurl +
                "AccountPayables/MonitoringInvoice/InvoiceBermasalahKasiePurc/List/submitKeBuyer",
              data: {
                invoice_id: invoice_id,
...
function cariInvoicebyId() {
  ...
  $.ajax({
    ...
    success: function (response) {
      window.location.replace(
        baseurl +
          "AccountPayables/MonitoringInvoice/Unprocess/invBermasalah/" +
          invoice_id
      );
    },
  });
...
$("#btnCariTop").click(function () {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/NewInvoice/cariVendorandTerm",
    dataType: "JSON",
    data: {
      nomor_po: nomor_po,
    },
...
$(document).ready(function () {
  ...
  function onClickBermasalah(th) {
    ...
    $.ajax({
      ...
      url:
        baseurl +
        "AccountPayables/MonitoringInvoice/Unprocess/saveInvBermasalah",
      data: {
        invoice_id: invoice_id,
  ...
  function openDetailAkt(th) {
    ...
    $(".modal-tabel").html(
      "<center><img id='loading12' style='margin-top: 2%;' src='" +
        baseurl +
        "assets/img/gif/loading99.gif'/><br /></center><br />"
    );
    $.ajax({
      type: "POST",
      url:
        baseurl +
        "AccountPayables/MonitoringInvoice/FinishInvoiceAkt/bukaModalAkutansi",
      data: {
      ...
      .then((result) => {
        if (result.value) {
          $.ajax({
            ...
            url:
              baseurl +
              "AccountPayables/MonitoringInvoice/InvoiceBermasalahAkt/LaporInvoice",
            data: {
            ...
            success: function (response) {
              ...
              window.location.replace(
                baseurl +
                  "AccountPayables/MonitoringInvoice/InvoiceBermasalahAkt"
              );
            },
          });
        } else if (result.dismiss === Swal.DismissReason.cancel) {
  ...
  $('span[class~="statusInvoice"]').each(function () {
    ...
    if (status == 3) {
      ...
      $(this)
        ...
        .parent()
        .closest("tr")
        .find('button[name="checkbtndisable[]"]')
  ...
  $(document).on(
    "input click",
    '.qty_invoice, .del_row, input[id="invoice_amounttttt"]',
    function () {
      var total = 0;
      ...
      if (total == invAmount) {
        $("#invoice_amounttttt, #AmountOtomatis").css(
          "background-color",
          "white"
        );
      } else {
  ...
  $("#btnSearchPoNumber").click(function () {
    $("#tablePoLines").html(
      "<center><img id='loading12' style='margin-top: 2%;' src='" +
        baseurl +
        "assets/img/gif/loading12.gif'/><br /><p style='color:#575555;'>Searching Data</p></center><br />"
    );
    ...
    $.ajax({
      ...
      url:
        baseurl +
        "AccountPayables/MonitoringInvoice/Invoice/getPoNumber/" +
        po_no,
        ...
        $("#btnAddPoNumber").on("click", function () {
          ...
          $(".addMonitoringInvoice").each(function () {
            ...
            if (this.checked) {
              ...
              html +=
                '<td><input style="width: 100%" type="text" onchange="PresTab(this)" name="qty_invoice[]" class="form-control qty_invoice" row-num="' +
                num +
                '"></td>';
              html +=
                '<td><button type="button"class="del_row btn btn-danger"><i class="glyphicon glyphicon-trash"></i></button></td>';
              html += "</tr>";
  ...
  $(
    "table#tbListInvoice tbody tr, #tabel_detail_purchasing tbody tr, #finishInvoice tbody tr, #tabel_invoice tbody tr, #unprocessTabel tbody tr, #rejectinvoice tbody tr"
  ).each(function () {
  ...
  $(
    "table#tbInvoiceEdit tbody tr, #editlinespo tbody tr, #tbInvoiceKasie tbody tr, #invoiceKasiePembelian tbody tr, #filInvoice tbody tr, #detailUnprocessed tbody tr, #processedinvoice tbody tr"
  ).each(function () {
  ...
  $("#btnGenerate").click(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        baseurl + "AccountPayables/MonitoringInvoice/Invoice/GenerateInvoice/",
      data: {
  ...
  $(".saveTaxInvoice").click(function () {
    ...
    $.ajax({
      ...
      url:
        baseurl +
        "AccountPayables/MonitoringInvoice/Invoice/tax_invoice_number/",
      data: {
  ...
  $("#btnToFinance").click(function () {
    ...
    if (status == 1 > 0) {
      ...
      $.ajax({
        url:
          baseurl +
          "AccountPayables/MonitoringInvoice/InvoiceKasie/submittofinance",
        data: {
          invoice_id: invoice_id,
        ...
        success: function (response) {
          ...
          window.location.replace(
            baseurl +
              "AccountPayables/MonitoringInvoice/InvoiceKasie/finishBatch"
          );
        },
      });
    }
  ...
  $("#invoice_category").on("change", function () {
    var jasa = $(this).val();
    if (
      jasa == "JASA NON EKSPEDISI TRAKTOR" ||
      jasa == "JASA EKSPEDISI TRAKTOR"
    ) {
      $("#jenis_jasa").show();
    }
  });
...
function prosesInvMI(th) {
  ...
  if (proses == 2) {
    prnt.html(
      '<span class="btn btn-success" style="cursor: none;font-size: 10pt;" >Diterima<input type="hidden" name="hdnTerima[]" class="hdnProses" value="' +
        invoice_id +
        '"></span><a class="btn btn-sm btn-primary" onclick="reloadTerimaInnvoice(' +
        invoice_id +
        ');"><i class="fa fa-refresh"></i></a>'
    );
  } else {
    prnt.html(
      '<span class="btn btn-danger" style="font-size: 8pt ;cursor: none;">Ditolak (Isikan Alasan)<input type="hidden" name="hdnTolak[]" class="hdnProses" value="' +
        invoice_id +
        '"></span><a class="btn btn-sm btn-primary" onclick="reloadTolakInnvoice(' +
        invoice_id +
        ');"><i class="fa fa-refresh"></i></a>'
    );
    td.html(
      '<input type="text" class="reason_finance_class' +
        invoice_id +
        '" name="reason_finance[]">'
    );
...
function deleteLinePO(th) {
  ...
  $.ajax({
    url:
      baseurl + "AccountPayables/MonitoringInvoice/Invoice/deletePOLine/" + id,
    data: {
      invoice_po_id: id,
    },
    type: "POST",
...
function bukaMOdal(elm) {
  ...
  $.ajax({
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceKasie/modal_approve_reject_invoice/" +
      id,
    data: {
      invoice_id: id,
    },
...
function submitUlangKasieGudang(th) {
  ...
  $.ajax({
    ...
    url:
      baseurl +
      "AccountPayables/MonitoringInvoice/InvoiceKasie/submitUlangKasieGudang",
    data: {
      batch_number: batch_number,
    },
    success: function (response) {
      window.location.href =
        baseurl + "AccountPayables/MonitoringInvoice/InvoiceKasie";
    },
  });
}
function approveInvoice(th) {
  ...
  $.ajax({
    type: "POST",
    url:
      baseurl + "AccountPayables/MonitoringInvoice/InvoiceKasie/approveInvoice",
    data: {
      invoice_id: invoice_id,
      status: status,
      invoice_number: invoice_number,
    ...
    success: function (response) {
      ...
      window.location.href =
        baseurl +
        "AccountPayables/MonitoringInvoice/InvoiceKasie/batchDetailPembelian/" +
        batch_number;
    },
  });
}
function btnApproveNew(th) {
  ...
  if (isChecked == "Approve") {
    ...
    $.ajax({
      ...
      url:
        baseurl +
        "AccountPayables/MonitoringInvoice/InvoiceKasie/approveInvoice2",
      data: {
        invoice_id: invoice_id,
        status: status,
      },
...
function btn_cari(th) {
  ...
  var win = window.open(
    baseurl + "Monitoring/TrackingInvoice/DetailInvoice/" + id
  );
}
...
$(document).ready(function () {
  ...
  $("#tbListSubmit_filter").prepend(
    '<button id="btnOrclReportMI" class="btn btn-sm btn-success" data-toggle="modal" data-target="#mdlOrclReportMI" style="margin-right: 10px" type="button">Monitoring Receipt PO</button>'
  );
...
$(document).ready(function () {
  $("#submit_checking_all").removeAttr("required");
});
