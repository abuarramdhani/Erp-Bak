                ...
                options: {
                    ...
                    animation: {
                        onComplete: function(animation) {
                                var sourceCanvas = newMBKChart.chart.canvas
                                var copyWidth = newMBKChart.scales['y-axis-0'].width - 10
                                var copyHeight = newMBKChart.scales['y-axis-0'].height + newMBKChart.scales['y-axis-0'].top + 10
                                var targetCtx = $('.cnvMBKChartAxis')[0].getContext('2d')
