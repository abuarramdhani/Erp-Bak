...
addRow = () => { //function for button add in home
		var lastRow = $('table.main-table tr:last').attr("no");
		var newRow = (Number(lastRow) + 1);
		if (newRow != 15) {
			$('.main-table tbody').append(row(newRow));

		} else {
			msgError('Maksimal baris adalah 14!')
		}
	}


function addRowMpm2(){
	var numb = Number($('.findtabel tr:last td.editnum').text())
	console.log(numb);
	var unit = "";
    var jumlah = "";
    ...
    $.ajax({
		...
		// kolom 1 
		var html = '<tr class="number'+(numb+1)+'"><td class="editnum">'+(numb+1)+'</td>';
		// kolom 2
		html += '<td><input type="number" class="form-control" style="width: 100%" type="text" id="jumlah" name="jumlah"></td>';
		// kolom 3
		html += '<td><select id="tipe" name="tipe" class="form-control selectUnitMPM" style="width:100%;" onFocus="onBakso()">';
        ...
        html += "</select></td>";
        // kolom 6
		html += '<td><button type="button" onClick="myFunction('+(numb+1)+')" class="btnDeleteRowUnit btn btn-danger"><i class="glyphicon glyphicon-trash"></i></button></td>';
		html += "</tr>";
	numb++;
...
var numsp = Number($('#tabelAddmpmsp tr:last td#nomor_sp').text())
	console.log(numsp);
    var unit = "";
    var jumlah = "";
    ...
    $.ajax({
		...
		console.log("num atas", num);
		// kolom 1 
		var html = '<tr class="number'+(numsp+1)+'"><td id="nomor_sp">'+(numsp+1)+'</td>';
		// kolom 2
		html += '<td><input type="number" class="form-control" style="width: 100%" type="text" id="jumlah" name="jumlah"></td>';
		// kolom 3
		html += '<td><select id="tipe" name="tipe" class="form-control selectUnitMPM" style="width:100%;" onFocus="onBakso()">';
        ...
        html += "</select></td>";
        // kolom 6
		html += '<td><button type="button" onClick="deleteEditsp('+(numsp+1)+')" class="btnDeleteRowsp btn btn-danger"><i class="glyphicon glyphicon-trash"></i></button></td>';
		html += "</tr>";
	numsp++;
