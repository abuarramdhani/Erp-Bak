...
$(document).ready(function(){
	...
	function editPromDate(promiseddate,promisedtime,line,nopo) {
	// console.log(promiseddate)
	// console.log(line)
	// console.log(nopo)
	$(".editPromisedDate").val(promiseddate);
	$(".editPromisedTime").val(promisedtime);
	$(".editLine").val(line);
	$(".editnoPo").val(nopo);
	// $("#editNamaSeksi").val(nama);
	$(".btnSubmitPrmdate").attr("onclick", "updprmdate()");
	$("#mdlPromdate").modal("show");
	}
	
	function editStatusPBD(line,nopo){
		$(".editLine").val(line);
		$(".editnoPo").val(nopo);
		$.ajax({
			method: "POST",
			url: baseurl + "PerkiraanBarangDatang/Monitoring/updstatuspbd",
			dataType: "json",
			data: {
			line: line,
			nopo: nopo
  ...
  function updprmdate() {
	...
	var nopo = $("#editnoPo").val();
	var prmdate = $("#editPromisedDate").val();
	var prmtime = $("#editPromisedTime").val();
	$.ajax({
	  method: "POST",
	  url: baseurl + "PerkiraanBarangDatang/Monitoring/updprmdate",
	  dataType: "json",
	  data: {
		line: line,
		nopo: nopo,
