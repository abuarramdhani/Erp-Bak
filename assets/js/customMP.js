...
$("#tblDataresikoPribadiMP").DataTable({
	dom: "Bfrtip",
	buttons: [{ extend: "excel", title: "Data Resiko Pribadi " + d + "-" + m + "-" + y }],
	scrollY: "370px",
	scrollX: true,
	scrollCollapse: true,
	fixedColumns: {
...
$("#tblRekapKondisiKesehatanMP").DataTable({
	dom: "Bfrtip",
	buttons: [{ extend: "excel", title: "Rekap Kondisi Kesehatan " + d + "-" + m + "-" + y }],
	scrollY: "370px",
	scrollX: true,
	scrollCollapse: true,
	fixedColumns: {
...
function MP_simpan_lelayu() {
	...
	if (pekerja == 0 || ket == 0) {
		Swal.fire("Peringatan!", "Data Harap di isi dengan Lengkap!", "warning");
	} else {
		Swal.fire({
