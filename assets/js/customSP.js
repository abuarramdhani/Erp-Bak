...
$(document).ready(function () {
    ...
    $(".input_Pekerja_SP").on("ifChecked", function () {
      ...
      if (!kode) {
        swal
          ...
          .then((result) => {
            $("#slc_pkj_SP").val() == "1"
              ? $("#kelas_pkj_SP").attr("hidden", false)
              : $("#kelas_pkj_SP").attr("hidden", true);
            $(".input_Pekerja_SP").iCheck("uncheck");
          });
        Hidekelas;
      } else {
  ...
  $(".txtNPWP_SP").mask("00.000.000.0-000.000", {
  ...
  $("#slc_pkj_SP").on("change", function (event) {
    ...
    if (elaa != "") {
      $("#inp_tgl_angkat_SP").datepicker(
        "setDate",
        $.datepicker.parseDate("yy-mm-dd", elaa)
      );
    }
    if (try_hubker.val()) {
      if ($("#tgl_ik_hubker").attr("hidden", false)) {
        ...
        if (isi[1]) {
          let DateFresh = moment($("#txt_tgl_SP").val())
            .add(Number(3) + Number(isi[0]), "month")
            .add("15", "days")
            .format("YYYY-MM-DD");
          $("#txt_IK_hubker").datepicker(
            "setDate",
            $.datepicker.parseDate("yy-mm-dd", DateFresh)
          );
        } else {
          let DateFresh = moment($("#txt_tgl_SP").val())
            .add(Number(3) + Number(isi[0]), "month")
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        for (var i = 0; i < data.butuh.length; i++) {
          kodesie_butuh +=
            `<option value="` +
            data.butuh[i]["kodesie"] +
            `">[` +
            data.butuh[i]["kodesie"] +
            `] - ` +
            data.butuh[i]["seksi"] +
            ` - ` +
            data.butuh[i]["pekerjaan"] +
            `</option>`;
        }
  ...
  $("#txt_try_seleksi").on("keyup", function () {
    ...
    if (isi == 0 || !isi) {
      ...
      if (isi[1]) {
        let newEla = moment($("#txt_tgl_SP").val())
          .add(isi[0], "month")
          .add("15", "days")
          .format("YYYY-MM-DD");
  ...
  $("#txt_try_hubker").on("keyup", function () {
    ...
    if (a == "12" || a == "9" || a == "14") {
      ...
      let isi = $(this).val().split(/[,.]/),
        DateFresh = moment($("#txt_tgl_SP").val())
          .add(Number(3) + Number(isi[0]), "month")
          .add(15, "days")
          .format("YYYY-MM-DD");
  ...
  $("#btn_Plus_Pekerja_SP").on("click", function () {
    ...
    if (jenis == 1) {
      ...
      $(".ganti_hide")
        .attr({ disabled: false, hidden: false })
        .iCheck("check")
        .closest("form");
    }
      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          let cekHide = result.jenis == 1 ? "hidden" : "",
            ...
            no_keb =
              result.jenis == 1
                ? result.pkj[0]["kodekebutuhan"]
                : result.pkj[0]["nokeb"],
            kelahiran =
              result.jenis == 1
                ? result.pkj[0]["tmplahir"]
                : result.pkj[0]["templahir"],
            kodepos =
              result.jenis == 1
                ? result.pkj[0]["kodepos"]
                : result.pkj[0]["kodepos"],
            no_kk =
              result.jenis == 1
                ? result.pkj[0]["no_kk"]
            ...
            status_nikah =
              result.jenis == 1
                ? result.pkj[0]["status_nikah"]
                : result.pkj[0]["statnikah"],
            agama = [
              "ISLAM",
              "KATHOLIK",
              "KRISTEN",
          ...
          let ana = result.pkj[0]["tgllahir"].split("/"),
            ...
            gantiSekolah = `<select class="select select2 form-control txtSkul_SP forSelectSekulah2" name="txtSkul_SP" style="width: 100% !important; text-transform: uppercase !important" value="${
              result.pkj[0]["sekolah"]
            }" required>
                                            <option>${
                                              result.pkj[0]["sekolah"]
                                            }</option>
                            ...
                            <div class="col-lg-6">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="text" name="input_noind_baru_SP" class="form-control text-left input_noind_baru_SP" value="${
                                              result.noind
                                            }" readonly>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="inp_stat_jbtn" class="form-control text-left inp_stat_jbtn" value="${
                                              kode == "C"
                                                ? ""
                                                : result.stat_jab[0]["status"]
                                            }" readonly>
                                            <input type="text" name="inp_kd_jbtn" class="form-control text-left inp_kd_jbtn hide" value="${
                                              kode == "C"
                                                ? ""
                                                : result.stat_jab[0][
                                                    "kd_hubker"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="txt_Lamaran_SP" class="form-control txt_Lamaran_SP" value="${
                                      result.pkj[0]["kodelamaran"]
                                    }" readonly>
                                        </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control def_Nama_pkj" style="text-transform: uppercase !important" name="def_Nama_pkj" value="${
                                          result.pkj[0]["nama"]
                                        }">
                                            </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <select class="select select2 form-control inp_Agama_SP" name="inp_jenkel_SP" value="${
                                              result.pkj[0]["agama"]
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="number" max="9999999999999999" name="txtNIK_SP" class="form-control txtNIK_SP" value="${
                                                      result.pkj[0]["nik"]
                                                    }" required>
                                            </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <input type="text" name="txt_alamat_SP" class="form-control txt_alamat_SP" style="text-transform: uppercase !important" value="${
                                                                  result.pkj[0][
                                                                    "alamat"
                                                                  ]
                                                                }" required>
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-8">
                                                                        <input type="text" name="txt_noHP_SP" class="form-control txt_noHP_SP" value="${
                                                                          result
                                                                            .pkj[0][
                                                                            "nohp"
                                                                          ]
          ...
          $(".Provinsi_SP")
            .select2({
              ...
              ajax: {
                url:
                  baseurl + "MasterPekerja/DataPekerjaKeluar/provinsiPekerja",
                dataType: "json",
                type: "GET",
                data: function (params) {
                  return { term: params.term };
              ...
              if (!empty) {
                swal
                  .fire({
                    title: "Warning",
                    html:
                      "<p>Data Belum Lengkap !</p><p>Apakah anda yakin ingin menyimpan data ?</p>",
                    type: "warning",
                  ...
                  .then((result) => {
                    if (result.value) {
                      $.ajax({
                        ...
                        url:
                          baseurl +
                          "AdmSeleksi/SuratPenyerahan/saveDataPenyerahan",
                        beforeSend: function () {
                          swal.fire({
                            html: '<img src="' + loading + '">',
                            allowOutsideClick: false,
  ...
  $("#btn_Cetak_SP").on("click", function () {
    ...
    if (!kepada) {
      swal.fire({
        title: "Peringatan !",
        text:
          "Kepada siapa surat ini akan ditujukan ? Harap isikan tujuan surat",
        type: "warning",
        allowOutsideClick: false,
      });
    } else {
      swal
        ...
        .then((result) => {
          if (result.value) {
            window.open(
              baseurl +
                `AdmSeleksi/SuratPenyerahan/previewPDF?approve=${app}&&kepada=${kepada}&&petugas=${ptgs1}&&petugas2=${ptgs2}&&pekerja=${pekerja}&&tgl_cetak=${tgl_cetak}&&tgl_serah=${tgl_serah}&&kodesie=${kodesie}&&jenis=${jenis}`
            );
          }
        });
    }
      ...
      $("#tabelDaftarPekerjaSP").DataTable({
        ...
        columns: [
          ...
          },
          {
            ...
            render(data) {
              return `<a href="${
                baseurl + "AdmSeleksi/SuratPenyerahan/EditData?kode=" + data
              }" type="button" class="btn btn-primary" target="_blank"><i class="fa fa-pencil-square"></i></a>`;
            },
          },
        ],
      });
  ...
  $.ajax({
    ...
    success: (res) => {
      ...
      for (let i = 0; i < res.length; i++) {
        if (
          res[i].jabatan.includes(seksi) === true &&
          parseInt(res[i].kd_jabatan) === Math.max(parseInt(kd_jabatan))
        ) {
          selek = "selected";
        } else {
          if (
            res[i].jabatan.includes(seksi) === true &&
            parseInt(res[i].kd_jabatan) === Math.max(parseInt(kd_jabatan)) - i
          ) {
            selek = "selected";
          } else if (
            parseInt(res[i].kd_jabatan) ===
            Math.max(parseInt(kd_jabatan)) - i
          ) {
            selek = "selected";
        ...
        isi += `<option ${selek} value = "${
          res[i].kodesie + "|" + res[i].kd_jabatan
        }" > ${res[i].kodesie + "|" + res[i].jabatan}</option > `;
      }
