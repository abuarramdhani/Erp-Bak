...
function addRowSms(){ //APPEND DI NEW SHIPMENT
    ...
    $.ajax({
		...
		html += '<td><button type="button" onClick="onClickBakso4('+num+')" class="btnDeleteRowUnit btn btn-danger"><i class="glyphicon glyphicon-trash"></i></button></td>';
		html += "</tr>";
	num++;
...
const onClickBakso4 = (th) => { //FUNCTION DELETE SHIPMENT LINE DAN DELETE TOTAL PERSENTASE VOLUME
