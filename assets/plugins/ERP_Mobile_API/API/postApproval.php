...
$nama	= $_POST['nama'];
if(!empty($noinduk) || !empty($longitude) || !empty($latitude) || !empty($lokasi)|| !empty($tanggal)|| !empty($waktu)|| !empty($jenis_absen_id)|| !empty($gambar)  || !empty($status) || !empty($tanggal_status)){
