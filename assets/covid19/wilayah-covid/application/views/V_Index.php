...
<head>
	...
	<style type="text/css">
		...
		.mark-green {
			background-color: #1eb351;
			color: white;
		}

		.mark-yellow {
			background-color: #e4da23;
			color: black;
		}
			...
			<div class="col-lg-12">
				<div class="panel">
					...
					<div class="panel-body" style="border: 1px solid #81ecec">
						<div class="row">
							<div class="col-lg-4">
								<div class="rounded" style="height: 180px;background-color:#3ae374; padding: 1em; border-radius: 8px; margin-bottom: 1em;">
									<span style="font-size: 1.5rem; font-weight: bold;">Boleh Dikunjungi & Menginap :</span>
									<ul>
										<li>Nama Wilayah masuk dalam list KDU yang diperbolehkan asalkan tidak menjadi zona <span class="mark mark-red">merah</span> atau sudah 7 hari sejak turun menjadi zona <span class="mark mark-red">Merah</span>.</li>
										<li>Zona <span class="mark mark-green">Hijau</span>, atau sudah 7 hari sejak turun status menjadi Zona <span class="mark mark-green">Hijau</span> dari Zona <span class="mark mark-yellow">Kuning</span> / <span class="mark mark-orange">Orange</span> / <span class="mark mark-red">Merah</span>.</li>
									</ul>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="rounded" style="height: 180px;background-color:#fff200; padding: 1em; border-radius: 8px; margin-bottom: 1em;">
									<span style="font-size: 1.5rem; font-weight: bold;">Boleh dikunjungi tapi tidak menginap (PP) :</span>
									<ul>
										<li>Zona <span class="mark mark-yellow">Kuning</span>. atau </li>
										<li>Sudah 7 Hari turun menjadi Zona <span class="mark mark-yellow">Kuning</span> dari Zona <span class="mark mark-orange">Orange</span> / <span class="mark mark-red">merah</span>.</li>
										<li>Belum 7 Hari turun menjadi Zona <span class="mark mark-green">Hijau</span> dari Zona <span class="mark mark-yellow">Kuning</span></li>
									</ul>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="rounded" style="height: 180px;background-color:#ff3838; padding: 1em; border-radius: 8px; margin-bottom: 1em;">
									<span style="font-size: 1.5rem; font-weight: bold;">Tidak boleh dikunjungi :</span>
									<ul>
										<li>Zona <span class="mark mark-orange">Orange</span> dan <span class="mark mark-red">merah</span>.</li>
										<li>Belum 7 hari sejak perubahan status Zona <span class="mark mark-green">Hijau</span> / <span class="mark mark-yellow">Kuning</span> dari zona <span class="mark mark-orange">Orange</span> / <span class="mark mark-red">Merah</span>.</li>
									</ul>
								</div>
							</div>
						</div>
