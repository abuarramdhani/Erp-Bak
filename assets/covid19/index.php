  ...
  <!-- AIzaSyCw0IlgLwNcUk4v1Zl0HkB9NCY70jEy6uw -->
    ...
    <script>
      ...
      function initMap() {
          ...
          // map.data.loadGeoJson('http://192.168.8.66/khs-erp-map2/assets/covid19/jawa.json?time=' + Date.now());
          map.data.loadGeoJson('http://erp.quick.com/assets/covid19/jawa.json?time=' + Date.now());
      ...
      function toggleChange(){
        ...
        map.data.loadGeoJson(
            // 'http://192.168.8.66/khs-erp-map2/assets/covid19/jawa.json?time=' + Date.now()
            'http://erp.quick.com/assets/covid19/jawa.json?time=' + Date.now()
        );
        setStyle();
      }
